...
func (c *AccountsGetNotificationSettingCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "mybusinessnotifications.accounts.getNotificationSetting", "request", internallog.HTTPRequest(req, nil))
...
func (c *AccountsGetNotificationSettingCall) Do(opts ...googleapi.CallOption) (*NotificationSetting, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "mybusinessnotifications.accounts.getNotificationSetting", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *AccountsUpdateNotificationSettingCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.notificationsetting)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "mybusinessnotifications.accounts.updateNotificationSetting", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *AccountsUpdateNotificationSettingCall) Do(opts ...googleapi.CallOption) (*NotificationSetting, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "mybusinessnotifications.accounts.updateNotificationSetting", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
