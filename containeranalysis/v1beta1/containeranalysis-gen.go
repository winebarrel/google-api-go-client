...
type ArtifactRule struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ArtifactRule") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// authenticity of an attestation can be verified using the attached signature.
// If the verifier trusts the public key of the signer, then verifying the
...
// look-up (how to find this attestation if you already know the authority and
// artifact to be verified) and intent (which authority was this attestation
...
type Attestation struct {
	...
	// ForceSendFields is a list of field names (e.g. "GenericSignedAttestation")
	// to unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GenericSignedAttestation") to
...
type BatchCreateNotesRequest struct {
	// Notes: Required. The notes to create, the key is expected to be the note ID.
...
// Build: Note holding the version of the provider's builder and the signature
...
type Build struct {
	...
	// Signature: Signature of the build in occurrences pointing to this build note
...
type BuildSignature struct {
	...
	// key stored in `public_key` (such as the ID or fingerprint for a PGP key, or
	// the CN for a cert), or a reference to an external key (such as a reference
	// to a key in Cloud Key Management Service).
	KeyId string `json:"keyId,omitempty"`
	// KeyType: The type of the key, either stored in `public_key` or referenced in
	// `key_id`.
	//
	// Possible values:
	...
	// references an external key. For Cloud Build based signatures, this is a PEM
	// encoded public key. To verify the Cloud Build signature, place the contents
...
// ByProducts: Defines an object for the byproducts field in in-toto links. The
...
type ByProducts struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CustomValues") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// CVSSv3: Deprecated. Common Vulnerability Scoring System version 3. For
...
// Detail: Identifies all appearances of this vulnerability in the package for
// a specific distro/location. For example: glibc in
// cpe:/o:debian:debian_linux:8 for versions 2.1 - 2.2
type Detail struct {
	// CpeUri: Required. The CPE URI in cpe format
	// (https://cpe.mitre.org/specification/) in which the vulnerability manifests.
...
// Discovered: Provides information about the analysis status of a discovered
// resource.
...
// DocumentNote: DocumentNote represents an SPDX Document Creation Information
// section: https://spdx.github.io/spdx-spec/2-document-creation-information/
type DocumentNote struct {
	// DataLicence: Compliance with the SPDX specification includes populating the
	// SPDX fields therein with data related to such fields ("SPDX-Metadata")
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DataLicence") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type DocumentOccurrence struct {
	// CreateTime: Identify when the SPDX file was originally created. The date is
	// to be specified according to combined date and time in UTC format as
	// specified in ISO 8601 standard
	CreateTime string `json:"createTime,omitempty"`
	// CreatorComment: A field for creators of the SPDX file to provide general
	// comments about the creation of the SPDX file or any other relevant comment
	...
	// ExternalDocumentRefs: Identify any external SPDX documents referenced within
	// this SPDX document
	...
	// Namespace: Provide an SPDX document specific namespace as a unique absolute
...
type ExportSBOMResponse struct {
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "DiscoveryOccurrenceId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type FileNote struct {
	// Checksum: Provide a unique identifier to match analysis information on each
...
type FileOccurrence struct {
	...
	// Comment: This field provides a place for the SPDX file creator to record any
	...
	// FilesLicenseInfo: This field contains the license information actually found
	// in the file, if any
	...
	Id string `json:"id,omitempty"`
	// LicenseConcluded: This field contains the license the SPDX file creator has
	// concluded as governing the file or alternative values if the governing
...
// request body for the GeneratePackagesSummary API method. It just takes a
...
// `Signature` message. This attestation must define the `serialized_payload`
// that the `signatures` verify and any metadata necessary to interpret that
// plaintext. The signatures should always be over the `serialized_payload`
// bytestring.
type GenericSignedAttestation struct {
	...
	// `signatures`. The encoding and semantic meaning of this payload must match
	// what is set in `content_type`.
...
type GrafeasV1beta1DiscoveryDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Discovered") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GrafeasV1beta1ImageDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DerivedImage") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GrafeasV1beta1IntotoArtifact struct {
	...
	ResourceUri string          `json:"resourceUri,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Hashes") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
// GrafeasV1beta1IntotoDetails: This corresponds to a signed in-toto link - it
// is made up of one or more signatures and the in-toto link itself. This is
// used for occurrences of a Grafeas in-toto note.
type GrafeasV1beta1IntotoDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Signatures") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GrafeasV1beta1IntotoSignature: A signature object consists of the KeyID used
...
type GrafeasV1beta1VulnerabilityDetails struct {
	...
	// it is available, and note provider assigned severity when distro has not yet
	...
	// provided by the language ecosystem for a language pack. For this reason, it
	// is advised to use the effective severity on the PackageIssue level. In the
	// case where multiple PackageIssues have differing effective severities, this
...
// software supply chain step in an in-toto layout. This information goes into
// a Grafeas note.
type InToto struct {
	...
	// identifying the artifacts that enter this supply chain step, and exit the
	// supply chain step, i.e. materials and products of the step.
	...
	// SigningKeys: This field contains the public keys that can be used to verify
	...
	// Threshold: This field contains a value that indicates the minimum number of
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExpectedCommand") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LicensesSummary struct {
	// Count: The number of fixable vulnerabilities associated with this resource.
	Count int64 `json:"count,omitempty,string"`
	// License: The license of the package. Note that the format of this value is
	// not guaranteed. It may be nil, an empty string, a boolean value (A | B), a
...
type Link struct {
	// Byproducts: ByProducts are data generated as part of a software supply chain
	...
	// can also be empty if links are generated for operations that aren't directly
	...
	// the environment. It is suggested for this field to contain information that
	...
	// and are used for the operation performed. The key of the map is the path of
	// the artifact and the structure contains the recorded hash information. An
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Byproducts") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type PackageInfoNote struct {
	...
	// unique identification of a specific package that correlates to the data in
	// this SPDX file
	Checksum string `json:"checksum,omitempty"`
	...
	// FilesLicenseInfo: Contain the license the SPDX file creator has concluded as
	// governing the This field is to contain a list of all licenses found in the
	// package. The relationship between licenses (i.e., conjunctive, disjunctive)
	// is not specified in this field – it is simply a listing of all licenses
	// found
	FilesLicenseInfo []string `json:"filesLicenseInfo,omitempty"`
	// HomePage: Provide a place for the SPDX file creator to record a web site
	// that serves as the package's home page
	HomePage string `json:"homePage,omitempty"`
	// LicenseDeclared: List the licenses that have been declared by the authors of
	// the package
	...
	// Supplier: Identify the actual distribution source for the package/directory
	...
	// files (except the SPDX file itself, if it is included in the package) that
	// make up each package and that correlates to the data in this SPDX file
...
// Information section: https://spdx.github.io/spdx-spec/3-package-information/
type PackageInfoOccurrence struct {
	...
	// HomePage: Output only. Provide a place for the SPDX file creator to record a
	...
	// etc.
	PackageType string `json:"packageType,omitempty"`
	// SourceInfo: Provide a place for the SPDX file creator to record any relevant
...
type PackageIssue struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AffectedLocation") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// PackagesSummaryResponse: A summary of the packages found within the given
// resource.
type PackagesSummaryResponse struct {
	// LicensesSummary: A listing by license name of each of the licenses and their
	// counts.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LicensesSummary") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// signature. This message only supports `ATTACHED` signatures, where the
// payload that is signed is included alongside the signature itself in the
// same file.
type PgpSignedAttestation struct {
	...
	// signature, as output by, e.g. `gpg --list-keys`. This should be the version
	// 4, full 160-bit fingerprint, expressed as a 40 character hexadecimal string.
	// See https://tools.ietf.org/html/rfc4880#section-12.2 for details.
	...
	// signature format supported is dependent on the verification implementation,
	// currently only ASCII-armored (`--armor` to gpg), non-clearsigned (`--sign`
	// rather than `--clearsign` to gpg) are supported. Concretely, `gpg --sign
	// --armor --output=signature.gpg payload.json` will create the signature
	// content expected in this field in `signature.gpg` for the `payload.json`
	// attestation payload.
	Signature string `json:"signature,omitempty"`
	// ForceSendFields is a list of field names (e.g. "ContentType") to
	// unconditionally include in API requests. By default, fields with empty or
...
type Resource struct {
	...
	// Name: Deprecated, do not use. Use uri instead. The name of the resource. For
...
// SigningKey: This defines the format used to record keys used in the software
// supply chain. An in-toto link is attested using one or more keys defined in
// the in-toto layout. An example of this is: { "key_id":
...
type VulnerabilityLocation struct {
	// CpeUri: Required. The CPE URI in cpe format
	// (https://cpe.mitre.org/specification/) format. Examples include distro or
...
type WindowsDetail struct {
	...
	// multiple KBs) that mitigate a given vulnerability. Currently any listed kb's
...
// ExportSBOM: Generates an SBOM and other dependency information for the given
// resource.
//
...
type ProjectsLocationsResourcesGeneratePackagesSummaryCall struct {
	s                              *Service
	name                           string
...
// GeneratePackagesSummary: Gets a summary of the packages within a given
// resource.
//
//   - name: The name of the resource to get a packages summary for in the form
//     of `projects/[PROJECT_ID]/resources/[RESOURCE_URL]`.
func (r *ProjectsLocationsResourcesService) GeneratePackagesSummary(name string, generatepackagessummaryrequest *GeneratePackagesSummaryRequest) *ProjectsLocationsResourcesGeneratePackagesSummaryCall {
	c := &ProjectsLocationsResourcesGeneratePackagesSummaryCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *ProjectsLocationsResourcesGeneratePackagesSummaryCall) Fields(s ...googleapi.Field) *ProjectsLocationsResourcesGeneratePackagesSummaryCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *ProjectsLocationsResourcesGeneratePackagesSummaryCall) Context(ctx context.Context) *ProjectsLocationsResourcesGeneratePackagesSummaryCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *ProjectsLocationsResourcesGeneratePackagesSummaryCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsResourcesGeneratePackagesSummaryCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.generatepackagessummaryrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "containeranalysis.projects.locations.resources.generatePackagesSummary", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ProjectsLocationsResourcesGeneratePackagesSummaryCall) Do(opts ...googleapi.CallOption) (*PackagesSummaryResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "containeranalysis.projects.locations.resources.generatePackagesSummary", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsResourcesGeneratePackagesSummaryCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "containeranalysis.projects.resources.generatePackagesSummary", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsResourcesGeneratePackagesSummaryCall) Do(opts ...googleapi.CallOption) (*PackagesSummaryResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "containeranalysis.projects.resources.generatePackagesSummary", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
