...
type DetectLanguageRequest struct {
	...
	// ForceSendFields is a list of field names (e.g. "Q") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Q") to include in API requests
...
type DetectionsListResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Detections") to include in API
...
type DetectionsResourceItem struct {
	...
	// IsReliable: A boolean to indicate is the language detection result reliable.
...
// GetSupportedLanguagesRequest: The request message for discovering supported
// languages.
...
type LanguagesListResponse struct {
	// Languages: List of source/target languages supported by the translation API.
	// If target parameter is unspecified, the list is sorted by the ASCII code
	// point order of the language code. If target parameter is specified, the list
	// is sorted by the collation order of the language name in the target
	// language.
...
type LanguagesResource struct {
	...
	Language string `json:"language,omitempty"`
	// Name: Human readable name of the language localized to the target language.
...
type TranslateTextRequest struct {
	...
	Q []string `json:"q,omitempty"`
	// Source: The language of the source text, set to one of the language codes
	// listed in
	...
	// Target: The language to use for translation of the input text, set to one of
	// the
...
type TranslationsListResponse struct {
	// Translations: Translations contains list of translation results of given
	// text
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Translations") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type TranslationsResource struct {
	// DetectedSourceLanguage: The source language of the initial request, detected
	// automatically, if
	// no source language was passed within the initial request. If the
	// source language was passed, auto-detection of the language will not
	// occur and this field will be empty.
	DetectedSourceLanguage string `json:"detectedSourceLanguage,omitempty"`
	// Model: The `model` type used for this translation. Valid values are
	...
	// ForceSendFields is a list of field names (e.g. "DetectedSourceLanguage") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DetectedSourceLanguage") to
...
// *DetectionsListResponse.ServerResponse.Header or (if a response was returned
...
// Target sets the optional parameter "target": The language to use to return
...
//
// operations on multiple text inputs.
//   - target: The language to use for translation of the input text, set to one
//     of the
//
// language codes listed in Language Support.
...
// Format sets the optional parameter "format": The format of the source text,
// in either HTML (default) or plain-text. A
// value of "html" indicates HTML and a value of "text" indicates plain-text.
//
// Possible values:
//
...
// Model sets the optional parameter "model": The `model` type requested for
// this translation. Valid values are
// listed in public documentation.
...
// Source sets the optional parameter "source": The language of the source
// text, set to one of the language codes listed in
// Language Support. If the source language is not specified, the API
// will
// attempt to identify the source language automatically and return it
// within
