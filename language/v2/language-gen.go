...
type AnalyzeEntitiesResponse struct {
	...
	// still return a response when the language is not supported, but it is on a
	// best effort basis.
...
// can perform multiple analysis types in one call.
...
// true will enable that specific analysis for the input.
type AnnotateTextRequestFeatures struct {
	...
	// ModerateText: Optional. Moderate the document for harmful and sensitive
	// categories.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ClassifyText") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type AnnotateTextResponse struct {
	...
	// requested features. The API may still return a response when the language is
...
type Document struct {
	...
	// LanguageCode: Optional. The language of the document (if not specified, the
	// language is automatically detected). Both ISO and BCP-47 language codes are
	// accepted. Language Support
	// (https://cloud.google.com/natural-language/docs/languages) lists currently
	// supported languages for each API method. If the language (either specified
	// by the caller or automatically detected) is not supported by the called API
...
type Entity struct {
	...
	// Metadata: Metadata associated with the entity. For the metadata associated
...
type EntityMention struct {
	// Probability: Probability score associated with the entity. The score shows
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Probability") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// nouns) in the text along with entity types, probability, mentions for each
