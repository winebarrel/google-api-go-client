...
func (s GoogleAppsDriveLabelsV2betaLabelEnabledAppSettings) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleAppsDriveLabelsV2betaLabelEnabledAppSettings
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
func (s GoogleAppsDriveLabelsV2betaLabelEnabledAppSettingsEnabledApp) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleAppsDriveLabelsV2betaLabelEnabledAppSettingsEnabledApp
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
func (s GoogleAppsDriveLabelsV2betaUpdateLabelEnabledAppSettingsRequest) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleAppsDriveLabelsV2betaUpdateLabelEnabledAppSettingsRequest
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
func (c *LabelsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betalabel)
	if err != nil {
		return nil, err
	}
...
func (c *LabelsDeltaCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betadeltaupdatelabelrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *LabelsDisableCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betadisablelabelrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *LabelsEnableCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betaenablelabelrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *LabelsPublishCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betapublishlabelrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *LabelsUpdateLabelCopyModeCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betaupdatelabelcopymoderequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
type LabelsUpdateLabelEnabledAppSettingsCall struct {
	s                                                               *Service
	name                                                            string
	googleappsdrivelabelsv2betaupdatelabelenabledappsettingsrequest *GoogleAppsDriveLabelsV2betaUpdateLabelEnabledAppSettingsRequest
	urlParams_                                                      gensupport.URLParams
	ctx_                                                            context.Context
	header_                                                         http.Header
}
...
func (r *LabelsService) UpdateLabelEnabledAppSettings(name string, googleappsdrivelabelsv2betaupdatelabelenabledappsettingsrequest *GoogleAppsDriveLabelsV2betaUpdateLabelEnabledAppSettingsRequest) *LabelsUpdateLabelEnabledAppSettingsCall {
	...
	c.name = name
	c.googleappsdrivelabelsv2betaupdatelabelenabledappsettingsrequest = googleappsdrivelabelsv2betaupdatelabelenabledappsettingsrequest
	return c
}
...
func (c *LabelsUpdateLabelEnabledAppSettingsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betaupdatelabelenabledappsettingsrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v2beta/{+name}:updateLabelEnabledAppSettings")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *LabelsUpdateLabelEnabledAppSettingsCall) Do(opts ...googleapi.CallOption) (*GoogleAppsDriveLabelsV2betaLabel, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
func (c *LabelsUpdatePermissionsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betalabelpermission)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *LabelsPermissionsBatchDeleteCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betabatchdeletelabelpermissionsrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *LabelsPermissionsBatchUpdateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleappsdrivelabelsv2betabatchupdatelabelpermissionsrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
