...
const basePathTemplate = "https://indexing.UNIVERSE_DOMAIN/"
...
func (c *UrlNotificationsGetMetadataCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "indexing.urlNotifications.getMetadata", "request", internallog.HTTPRequest(req, nil))
...
func (c *UrlNotificationsGetMetadataCall) Do(opts ...googleapi.CallOption) (*UrlNotificationMetadata, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "indexing.urlNotifications.getMetadata", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *UrlNotificationsPublishCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.urlnotification)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "indexing.urlNotifications.publish", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *UrlNotificationsPublishCall) Do(opts ...googleapi.CallOption) (*PublishUrlNotificationResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "indexing.urlNotifications.publish", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
