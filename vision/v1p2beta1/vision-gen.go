...
// GoogleCloudVisionV1p2beta1AnnotateFileRequest: A request to annotate one
...
// GoogleCloudVisionV1p2beta1AnnotateImageRequest: Request for performing
...
// GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest: Multiple async
...
// GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest: Request for async
...
// GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest: A list of requests to
...
// GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse: Response to a batch
...
// GoogleCloudVisionV1p2beta1Feature: The type of Google Cloud Vision API
...
// GoogleCloudVisionV1p2beta1Image: Client image to perform Google Cloud Vision
// API tasks over.
...
// GoogleCloudVisionV1p2beta1ImageSource: External image source (Google Cloud
...
// GoogleCloudVisionV1p2beta1LatLongRect: Rectangle determined by min and max
// `LatLng` pairs.
...
// GoogleCloudVisionV1p2beta1ProductSearchParams: Parameters for a product
// search request.
...
// GoogleCloudVisionV1p2beta1TextDetectionParams: Parameters for text
...
func (s GoogleCloudVisionV1p2beta1TextDetectionParams) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudVisionV1p2beta1TextDetectionParams
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudVisionV1p2beta1WebDetectionParams: Parameters for web detection
// request.
...
func (c *FilesAnnotateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudvisionv1p2beta1batchannotatefilesrequest)
	if err != nil {
		return nil, err
	}
...
// *GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse.ServerResponse.Header
...
func (c *FilesAsyncBatchAnnotateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudvisionv1p2beta1asyncbatchannotatefilesrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *ImagesAnnotateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudvisionv1p2beta1batchannotateimagesrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
func (c *ImagesAsyncBatchAnnotateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudvisionv1p2beta1asyncbatchannotateimagesrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
