...
type Groups struct {
	...
	// AllowGoogleCommunication: Deprecated. Allows Google to contact administrator
	// of the group.
	...
	// ArchiveOnly: Allows the group to be archived only. Possible values are:
	...
	// CustomFooterText: Set the content of custom footer text. The maximum number
	// of characters is 1,000.
	CustomFooterText string `json:"customFooterText,omitempty"`
	// CustomReplyTo: An email address used when replying to a message if the
	// replyTo property is set to REPLY_TO_CUSTOM. This address is defined by an
	...
	// CustomRolesEnabledForSettingsToBeMerged: Specifies whether the group has a
	// custom role that's included in one of the settings being merged. This field
	// is read-only and update/patch requests to it are ignored. Possible values
	// are:
	// - true
	// - false
	CustomRolesEnabledForSettingsToBeMerged string `json:"customRolesEnabledForSettingsToBeMerged,omitempty"`
	// DefaultMessageDenyNotificationText: When a message is rejected, this is text
	// for the rejection notification sent to the message's author. By default,
	// this property is empty and has no value in the API's response body. The
	// maximum notification text size is 10,000 characters. Note: Requires
	// sendMessageDenyNotification property to be true.
	DefaultMessageDenyNotificationText string `json:"defaultMessageDenyNotificationText,omitempty"`
	// DefaultSender: Default sender for members who can post messages as the
	// group. Possible values are: - `DEFAULT_SELF`: By default messages will be
	// sent from the user - `GROUP`: By default messages will be sent from the
	// group
	...
	// string if no group description has been entered. If entered, the maximum
	// group description is no more than 300 characters.
	Description string `json:"description,omitempty"`
	// Email: The group's email address. This property can be updated using the
	// Directory API. Note: Only a group owner can change a group's email address.
	// A group manager can't do this.
	...
	// EnableCollaborativeInbox: Specifies whether a collaborative inbox will
	// remain turned on for the group. Possible values are:
	// - true
	// - false
	EnableCollaborativeInbox string `json:"enableCollaborativeInbox,omitempty"`
	// FavoriteRepliesOnTop: Indicates if favorite replies should be displayed
	// above other replies.
	...
	// IncludeCustomFooter: Whether to include custom footer. Possible values are:
	//
	// - true
	// - false
	IncludeCustomFooter string `json:"includeCustomFooter,omitempty"`
	// IncludeInGlobalAddressList: Enables the group to be included in the Global
	// Address List. For more information, see the help center. Possible values
	// are:
	...
	// IsArchived: Allows the Group contents to be archived. Possible values are:
	//
	...
	// MembersCanPostAsTheGroup: Enables members to post messages as the group.
	// Possible values are:
	...
	// MessageDisplayFont: Deprecated. The default message display font always has
	// a value of "DEFAULT_FONT".
	MessageDisplayFont string `json:"messageDisplayFont,omitempty"`
	// MessageModerationLevel: Moderation level of incoming messages. Possible
	// values are:
	...
	// PrimaryLanguage: The primary language for group. For a group's primary
	// language use the language tags from the G Suite languages found at G Suite
	// Email Settings API Email Language Tags.
	PrimaryLanguage string `json:"primaryLanguage,omitempty"`
	// ReplyTo: Specifies who receives the default reply. Possible values are:
	...
	// SendMessageDenyNotification: Allows a member to be notified if the member's
	// message to the group is denied by the group owner. Possible values are:
	...
	// whoCanDiscoverGroup setting. Allows the group to be visible in the Groups
	...
	// SpamModerationLevel: Specifies moderation levels for messages detected as
	// spam. Possible values are:
	...
	// WhoCanAdd: Deprecated. This is merged into the new whoCanModerateMembers
	...
	// WhoCanAddReferences: Deprecated. This functionality is no longer supported
	// in the Google Groups UI. The value is always "NONE".
	WhoCanAddReferences string `json:"whoCanAddReferences,omitempty"`
	// WhoCanApproveMembers: Specifies who can approve members who ask to join
	// groups. This permission will be deprecated once it is merged into the new
	...
	// whoCanModerateContent setting. Specifies who can approve pending messages in
	// the moderation queue. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	// - NONE
	...
	// whoCanAssistContent setting. Permission to assign topics in a forum to
	// another user. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - MANAGERS_ONLY
	// - OWNERS_ONLY
	...
	// WhoCanAssistContent: Specifies who can moderate metadata. Possible values
	// are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - MANAGERS_ONLY
	...
	// WhoCanBanUsers: Specifies who can deny membership to users. This permission
	...
	// WhoCanContactOwner: Permission to contact owner of the group via web UI.
	// Possible values are:
	...
	// whoCanModerateContent setting. Specifies who can delete replies to topics.
	...
	// whoCanModerateContent setting. Specifies who can delete topics. Possible
	// values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	...
	// WhoCanDiscoverGroup: Specifies the set of users for whom this group is
	// discoverable. Possible values are:
	// - ANYONE_CAN_DISCOVER
	...
	// whoCanAssistContent setting. Permission to enter free form tags for topics
	// in a forum. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - MANAGERS_ONLY
	// - OWNERS_ONLY
	...
	// whoCanModerateContent setting. Specifies who can hide posts by reporting
	...
	// WhoCanInvite: Deprecated. This is merged into the new whoCanModerateMembers
	...
	// whoCanModerateContent setting. Specifies who can prevent users from posting
	...
	// whoCanModerateContent setting. Specifies who can make topics appear at the
	// top of the topic list. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	// - NONE
	...
	// whoCanAssistContent setting. Permission to mark a topic as a duplicate of
	...
	// WhoCanMarkFavoriteReplyOnAnyTopic: Deprecated. This is merged into the new
	// whoCanAssistContent setting. Permission to mark any other user's post as a
	...
	// WhoCanMarkFavoriteReplyOnOwnTopic: Deprecated. This is merged into the new
	// whoCanAssistContent setting. Permission to mark a post for a topic they
	// started as a favorite reply. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - MANAGERS_ONLY
	// - OWNERS_ONLY
	...
	// whoCanAssistContent setting. Permission to mark a topic as not needing a
	...
	// WhoCanModerateContent: Specifies who can moderate content. Possible values
	// are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	...
	// WhoCanModerateMembers: Specifies who can manage members. Possible values
	// are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	...
	// whoCanModerateMembers setting. Specifies who can change group members'
	// roles. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	// - NONE
	WhoCanModifyMembers string `json:"whoCanModifyMembers,omitempty"`
	// WhoCanModifyTagsAndCategories: Deprecated. This is merged into the new
	// whoCanAssistContent setting. Permission to change tags and categories.
	// Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - MANAGERS_ONLY
	...
	// whoCanModerateContent setting. Specifies who can move topics into the group
	// or forum. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	// - NONE
	...
	// whoCanModerateContent setting. Specifies who can move topics out of the
	...
	// whoCanModerateContent setting. Specifies who can post announcements, a
	// special topic type. Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - OWNERS_ONLY
	// - NONE
	...
	// whoCanAssistContent setting. Permission to take topics in a forum. Possible
	// values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - MANAGERS_ONLY
	...
	// whoCanAssistContent setting. Permission to unassign any topic in a forum.
	// Possible values are:
	// - ALL_MEMBERS
	// - OWNERS_AND_MANAGERS
	// - MANAGERS_ONLY
	...
	// WhoCanUnmarkFavoriteReplyOnAnyTopic: Deprecated. This is merged into the new
	// whoCanAssistContent setting. Permission to unmark any post from a favorite
	...
	// WhoCanViewGroup: Permissions to view group messages. Possible values are:
	//
	...
	// WhoCanViewMembership: Permissions to view membership. Possible values are:
	//
	...
	// ForceSendFields is a list of field names (e.g. "AllowExternalMembers") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AllowExternalMembers") to include
...
func (c *GroupsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "groupsSettings.groups.get", "request", internallog.HTTPRequest(req, nil))
...
func (c *GroupsGetCall) Do(opts ...googleapi.CallOption) (*Groups, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "groupsSettings.groups.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *GroupsPatchCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.groups)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "groupsSettings.groups.patch", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *GroupsPatchCall) Do(opts ...googleapi.CallOption) (*Groups, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "groupsSettings.groups.patch", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *GroupsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "groupsSettings.groups.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *GroupsUpdateCall) Do(opts ...googleapi.CallOption) (*Groups, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "groupsSettings.groups.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
