...
// GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest: Video annotation
// request.
...
// GoogleCloudVideointelligenceV1beta2ExplicitContentDetectionConfig: Config
...
// GoogleCloudVideointelligenceV1beta2ShotChangeDetectionConfig: Config for
...
// GoogleCloudVideointelligenceV1beta2SpeechContext: Provides "hints" to the
...
// GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig: Config for
...
func (c *VideosAnnotateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudvideointelligencev1beta2Annotatevideorequest)
	if err != nil {
		return nil, err
	}
