...
// Usage example:
//
//	import "google.golang.org/api/bigqueryconnection/v1"
//	...
...
package bigqueryconnection // import "google.golang.org/api/bigqueryconnection/v1"
...
const apiId = "bigqueryconnection:v1"
...
// Google owned Google service account to assume into customer's AWS IAM Role.
type AwsAccessRole struct {
	// IamRoleId: The user’s AWS IAM Role that trusts the Google-owned AWS IAM
	// user Connection.
	IamRoleId string `json:"iamRoleId,omitempty"`
	// Identity: A unique Google-owned and Google-generated identity for the
	// Connection. This identity will be used to access the user's AWS IAM Role.
	Identity string `json:"identity,omitempty"`
	// ForceSendFields is a list of field names (e.g. "IamRoleId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IamRoleId") to include in API
...
type AzureProperties struct {
	// Application: Output only. The name of the Azure Active Directory
	// Application.
	...
	// Directory Application used for a federated connection.
	FederatedApplicationClientId string `json:"federatedApplicationClientId,omitempty"`
	// Identity: Output only. A unique Google-owned and Google-generated identity
	// for the Connection. This identity will be used to access the user's Azure
	// Active Directory Application.
	Identity string `json:"identity,omitempty"`
	// ObjectId: Output only. The object id of the Azure Active Directory
	// Application.
	ObjectId string `json:"objectId,omitempty"`
	// RedirectUri: The URL user will be redirected to after granting consent
...
// of access to GCP resources.
type CloudResourceProperties struct {
	// ServiceAccountId: Output only. The account ID of the service created for the
	// purpose of this connection. The service account does not have any
	// permissions associated with it when it is created. After creation, customers
	// delegate permissions to the service account. When the connection is used in
	// the context of an operation in BigQuery, the service account will be used to
	// connect to the desired resources in GCP. The account ID is in the form of:
	// @gcp-sa-bigquery-cloudresource.iam.gserviceaccount.com
	ServiceAccountId string `json:"serviceAccountId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "ServiceAccountId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ServiceAccountId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CloudSpannerProperties struct {
	...
	// DatabaseRole: Optional. Cloud Spanner database role for fine-grained access
	// control. The Cloud Spanner admin should have provisioned the database role
	// with appropriate permissions, such as `SELECT` and `INSERT`. Other users
	// should only use roles provided by their Cloud Spanner admins. For more
	// details, see [About fine-grained access control]
	...
	// MaxParallelism: Allows setting max parallelism per query when executing on
	// Spanner independent compute resources. If unspecified, default values of
	...
	// UseDataBoost: If set, the request will be executed via Spanner independent
	// compute resources. REQUIRES: `use_parallelism` must be set.
	UseDataBoost bool `json:"useDataBoost,omitempty"`
	// UseParallelism: If parallelism should be used when reading from Cloud
	// Spanner
	UseParallelism bool `json:"useParallelism,omitempty"`
	// UseServerlessAnalytics: Deprecated: prefer use_data_boost instead. If the
	// serverless analytics service should be used to read data from Cloud Spanner.
...
type Connection struct {
	...
	// Name: Output only. The resource name of the connection in the form of:
	// `projects/{project_id}/locations/{location_id}/connections/{connection_id}`
	Name string `json:"name,omitempty"`
	// SalesforceDataCloud: Optional. Salesforce DataCloud properties. This field
	// is intended for use only by Salesforce partner projects. This field contains
...
type ConnectorConfiguration struct {
	...
	// ConnectorId: Required. Immutable. The ID of the Connector these parameters
	// are configured for.
...
type ConnectorConfigurationNetwork struct {
	// PrivateServiceConnect: Private Service Connect networking configuration.
	PrivateServiceConnect *ConnectorConfigurationPrivateServiceConnect `json:"privateServiceConnect,omitempty"`
	// ForceSendFields is a list of field names (e.g. "PrivateServiceConnect") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type ConnectorConfigurationSecret struct {
	...
	// SecretType: Output only. Indicates type of secret. Can be used to check type
	// of stored secret value even if it's `INPUT_ONLY`.
	//
	// Possible values:
...
type SparkHistoryServerConfig struct {
	...
	// act as a Spark History Server for the connection. Example: *
...
type SparkProperties struct {
	// MetastoreServiceConfig: Optional. Dataproc Metastore Service configuration
	// for the connection.
	...
	// permissions associated with it when it is created. After creation, customers
	// delegate permissions to the service account. When the connection is used in
	// the context of a stored procedure for Apache Spark in BigQuery, the service
	// account is used to connect to the desired resources in Google Cloud. The
	// account ID is in the form of:
	// bqcx--@gcp-sa-bigquery-consp.iam.gserviceaccount.com
	ServiceAccountId string `json:"serviceAccountId,omitempty"`
	// SparkHistoryServerConfig: Optional. Spark History Server configuration for
	// the connection.
	SparkHistoryServerConfig *SparkHistoryServerConfig `json:"sparkHistoryServerConfig,omitempty"`
	// ForceSendFields is a list of field names (e.g. "MetastoreServiceConfig") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MetastoreServiceConfig") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
