...
type Address struct {
	...
	// ForceSendFields is a list of field names (e.g. "Pipe") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Pipe") to include in API requests
...
type ClientConfig struct {
	...
	// ForceSendFields is a list of field names (e.g. "Node") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Node") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ClientStatusRequest struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "NodeMatchers") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Node struct {
	// BuildVersion: This is motivated by informing a management server during
	// canary which version of Envoy is being tested in a heterogeneous fleet. This
	// will be set by Envoy in management server RPCs. This field is deprecated in
	// favor of the user_agent_name and user_agent_version values.
...
type StringMatcher struct {
	...
	// IgnoreCase: If true, indicates the exact/prefix/suffix matching should be
	// case insensitive. This has no effect for the safe_regex match. For example,
	// the matcher *data* will match both input string *Data* and *data* if set to
	// true.
	...
	// Regex: The input string must match the regular expression specified here.
	...
	// attention:: This field has been deprecated in favor of `safe_regex` as it is
...
// given value is matched in google.protobuf.Struct. It uses `path` to retrieve
// the value from the struct and then check if it's matched to the specified
// value. For example, for the following Struct: .. code-block:: yaml fields:
// a: struct_value: fields: b: struct_value: fields: c: string_value: pro t:
...
// always not matched. [#next-free-field: 7]
...
func (c *DiscoveryClientStatusCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.clientstatusrequest)
	if err != nil {
		return nil, err
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "trafficdirector.discovery.client_status", "request", internallog.HTTPRequest(req, body.Bytes()))
...
func (c *DiscoveryClientStatusCall) Do(opts ...googleapi.CallOption) (*ClientStatusResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "trafficdirector.discovery.client_status", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
