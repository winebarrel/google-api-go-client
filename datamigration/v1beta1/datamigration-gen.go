...
// GoogleCloudClouddmsV1beta1OperationMetadata: Represents the metadata of the
...
type SqlIpConfig struct {
	...
	// ForceSendFields is a list of field names (e.g. "AuthorizedNetworks") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AuthorizedNetworks") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// from the destination database's public IP. You can retrieve the Cloud SQL
// instance's public IP from the Cloud SQL console or using Cloud SQL APIs. No
...
// then the second request will be ignored. It is recommended to always set
// this value to a UUID. The id must contain only letters (a-z, A-Z), numbers
// (0-9), underscores (_), and hyphens (-). The maximum length is 40
// characters.
...
// List: Retrieve a list of all connection profiles in a given project and
// location.
//
// - parent: The parent, which owns this collection of connection profiles.
...
// used to specify the fields to be overwritten in the connection profile
...
// UpdateMask sets the optional parameter "updateMask": Required. Field mask is
// used to specify the fields to be overwritten in the migration job resource
// by the update.
