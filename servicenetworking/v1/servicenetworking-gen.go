...
// AddDnsRecordSetRequest: Request to add a record set to a private managed DNS
// zone in the shared producer host project.
type AddDnsRecordSetRequest struct {
	// ConsumerNetwork: Required. The network that the consumer is using to connect
	// with services. Must be in the form of
	...
	// Zone: Required. The name of the private DNS zone in the shared producer host
...
// AddDnsZoneRequest: Request to add a private managed DNS zone in the shared
// producer host project and a matching DNS peering zone in the consumer
// project.
type AddDnsZoneRequest struct {
	...
	// host project and the peering zone in the consumer project. Must be unique
	// within both projects. The name must be 1-63 characters long, must begin with
...
// AddRolesRequest: Request for AddRoles to allow Service Producers to add
// roles in the shared VPC host project for them to use.
type AddRolesRequest struct {
	// ConsumerNetwork: Required. The network that the consumer is using to connect
	// with services. Must be in the form of
	// projects/{project}/global/networks/{network} {project} is a project number,
	// as in '12345' {network} is a network name.
	ConsumerNetwork string `json:"consumerNetwork,omitempty"`
...
type AddSubnetworkRequest struct {
	...
	// allowSubnetCidrRoutesOverlap field of the subnet, e.g. Available in alpha
	// and beta according to Compute API documentation
	...
	// range. Use CIDR range notation, such as `29` to provision a subnet with an
	...
	// public IP addresses. Any public IP range may be specified. If this field is
	// provided, we will not use customer reserved ranges for this primary IP
	// range.
	...
	// the VMs in this subnet. For information about the access types that can be
	// set using this field, see subnetwork
	...
	// ranges associated with this private service access connection. If no range
	// names are provided all ranges associated with this connection will be
	// considered. If a CIDR range with the specified IP prefix length is not
	...
	// information about the roles that can be set using this field, see subnetwork
	// (https://cloud.google.com/compute/docs/reference/rest/v1/subnetworks) in the
	// Compute API documentation.
...
type ConsumerProject struct {
	...
	// service instance. It can own the network that is peered with Google or, be a
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ProjectNum") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// connection. The call will fail if there are any managed service instances
...
type DisableVpcServiceControlsRequest struct {
	...
	// with services. Must be in the form of
	// projects/{project}/global/networks/{network} {project} is a project number,
	// as in '12345' {network} is network name.
	ConsumerNetwork string `json:"consumerNetwork,omitempty"`
	// ForceSendFields is a list of field names (e.g. "ConsumerNetwork") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
...
type ListDnsRecordSetsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DnsRecordSets") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ListDnsZonesResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DnsZonePairs") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ListPeeredDnsDomainsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PeeredDnsDomains") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type RangeReservation struct {
	...
	// range notation. For example, '29' to find unused x.x.x.x/29 CIDR range. The
	// goal is to determine if one of the allocated ranges has enough free space
	// for a subnet of the requested size. GCE disallows subnets with prefix_length
	// > 29
	IpPrefixLength int64 `json:"ipPrefixLength,omitempty"`
	// RequestedRanges: Optional. The name of one or more allocated IP address
	// ranges associated with this private service access connection. If no range
	...
	// ranges for the subnet. Use usual CIDR range notation. For example, '29' to
	// find unused x.x.x.x/29 CIDR range. The goal is to determine that the
...
// RemoveDnsRecordSetRequest: Request to remove a record set from a private
// managed DNS zone in the shared producer host project. The name, type, ttl,
// and data values must all exactly match an existing record set in the
// specified zone.
...
// RemoveDnsZoneRequest: Request to remove a private managed DNS zone in the
// shared producer host project and a matching DNS peering zone in the consumer
// project.
...
type SecondaryIpRangeSpec struct {
	...
	// CIDR range notation, such as `30` to provision a secondary IP range with an
	...
	// OutsideAllocationPublicIpRange: Optional. Enable outside allocation using
	// public IP addresses. Any public IP range may be specified. If this field is
	// provided, we will not use customer reserved ranges for this secondary IP
	// range.
	OutsideAllocationPublicIpRange string `json:"outsideAllocationPublicIpRange,omitempty"`
	...
	// RequestedAddress: Optional. The starting address of a range. The address
	// must be a valid IPv4 address in the x.x.x.x format. This value combined with
	// the IP prefix range is the CIDR range for the secondary IP range. The range
...
// service networking connection including the import/export of custom routes
// and subnetwork routes with public IP.
type UpdateConsumerConfigRequest struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConsumerConfig") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// UpdateDnsRecordSetRequest: Request to update a record set from a private
// managed DNS zone in the shared producer host project. The name, type, ttl,
// and data values of the existing record set must all exactly match an
// existing record set in the specified zone.
type UpdateDnsRecordSetRequest struct {
	...
	// NewDnsRecordSet: Required. The new values that the DNS record set should be
	// updated to hold.
...
type ValidateConsumerConfigRequest struct {
	...
	// NETWORK_NOT_IN_CONSUMERS_HOST_PROJECT, and HOST_PROJECT_NOT_FOUND are done
	...
	// the ValidationError enum. The first failure will return. If a validation is
	...
	// NETWORK_DISCONNECTED checks are done for requests that have validate_network
	// set to true.
	ValidateNetwork bool `json:"validateNetwork,omitempty"`
	// ForceSendFields is a list of field names (e.g.
	// "CheckServiceNetworkingUsePermission") to unconditionally include in API
	...
	// "CheckServiceNetworkingUsePermission") to include in API requests with the
...
type ValidateConsumerConfigResponse struct {
	// ExistingSubnetworkCandidates: List of subnetwork candidates from the request
	// which exist with the `ip_cidr_range`, `secondary_ip_cider_ranges`, and
	...
	// service project, and network is a shared VPC, but the network is not in the
	...
	//   "SN_SERVICE_AGENT_PERMISSION_DENIED_ON_CONSUMER_PROJECT" - The SN service
	// agent {service-@service-networking.iam.gserviceaccount.com} does not have
	// the SN service agent role on the consumer project.
	ValidationError string `json:"validationError,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g.
	// "ExistingSubnetworkCandidates") to unconditionally include in API requests.
	// By default, fields with empty or default values are omitted from API
	// requests. See https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields
	// for more details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExistingSubnetworkCandidates") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (c *OperationsCancelCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.operations.cancel", "request", internallog.HTTPRequest(req, body.Bytes()))
...
func (c *OperationsCancelCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.operations.cancel", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *OperationsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.operations.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *OperationsDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.operations.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *OperationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.operations.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *OperationsListCall) Do(opts ...googleapi.CallOption) (*ListOperationsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.operations.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// DisableVpcServiceControls: Disables VPC service controls for a connection.
//
...
func (c *ServicesDisableVpcServiceControlsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.disablevpcservicecontrolsrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.disableVpcServiceControls", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesDisableVpcServiceControlsCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.disableVpcServiceControls", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// EnableVpcServiceControls: Enables VPC service controls for a connection.
//
//   - parent: The service that is managing peering connectivity for a service
//     producer's organization. For Google services that support this
//     functionality, this value is `services/servicenetworking.googleapis.com`.
...
func (c *ServicesEnableVpcServiceControlsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.enablevpcservicecontrolsrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.enableVpcServiceControls", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesEnableVpcServiceControlsCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.enableVpcServiceControls", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Validate: Service producers use this method to validate if the consumer
// provided network, project and requested range are valid. This allows them to
// use a fail-fast mechanism for consumer requests, and not have to wait for
// AddSubnetwork operation completion to determine if user request is invalid.
//
//   - parent: This is in a form services/{service} where {service} is the name
...
func (c *ServicesValidateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.validateconsumerconfigrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.validate", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.validate" call.
// Any non-2xx status code is an error. Response headers are in either
// *ValidateConsumerConfigResponse.ServerResponse.Header or (if a response was
...
func (c *ServicesValidateCall) Do(opts ...googleapi.CallOption) (*ValidateConsumerConfigResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.validate", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
//     `services/servicenetworking.googleapis.com/connections/servicenetworking-go
//     ogleapis-com`.
...
func (c *ServicesConnectionsDeleteConnectionCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.deleteconnectionrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.deleteConnection", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesConnectionsDeleteConnectionCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.deleteConnection", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Patch: Updates the allocated ranges that are assigned to a connection.
//
//   - name: The private service connection that connects to a service producer
//     organization. The name includes both the private service name and the VPC
//     network peering name in the format of
...
func (c *ServicesConnectionsPatchCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.patch", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesConnectionsPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.patch", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Add: Service producers can use this method to add DNS record sets to private
...
func (c *ServicesDnsRecordSetsAddCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.adddnsrecordsetrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.add", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesDnsRecordSetsAddCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.add", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Get: Producers can use this method to retrieve information about the DNS
// record set added to the private zone inside the shared tenant host project
...
// ConsumerNetwork sets the optional parameter "consumerNetwork": Required. The
// consumer network containing the record set. Must be in the form of
...
// Domain sets the optional parameter "domain": Required. The domain name of
// the zone containing the recordset.
...
// Zone sets the optional parameter "zone": Required. The name of the zone
// containing the record set.
...
func (c *ServicesDnsRecordSetsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.dnsRecordSets.get" call.
// Any non-2xx status code is an error. Response headers are in either
// *DnsRecordSet.ServerResponse.Header or (if a response was returned at all)
...
func (c *ServicesDnsRecordSetsGetCall) Do(opts ...googleapi.CallOption) (*DnsRecordSet, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// List: Producers can use this method to retrieve a list of available DNS
...
// ConsumerNetwork sets the optional parameter "consumerNetwork": Required. The
// network that the consumer is using to connect with services. Must be in the
// form of projects/{project}/global/networks/{network} {project} is the
...
// Zone sets the optional parameter "zone": Required. The name of the private
// DNS zone in the shared producer host project from which the record set will
// be removed.
...
func (c *ServicesDnsRecordSetsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.dnsRecordSets.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListDnsRecordSetsResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ServicesDnsRecordSetsListCall) Do(opts ...googleapi.CallOption) (*ListDnsRecordSetsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Remove: Service producers can use this method to remove DNS record sets from
...
func (c *ServicesDnsRecordSetsRemoveCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.removednsrecordsetrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.remove", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesDnsRecordSetsRemoveCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.remove", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Update: Service producers can use this method to update DNS record sets from
// private DNS zones in the shared producer host project.
//
//   - parent: The service that is managing peering connectivity for a service
//     producer's organization. For Google services that support this
...
func (c *ServicesDnsRecordSetsUpdateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.updatednsrecordsetrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesDnsRecordSetsUpdateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsRecordSets.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Add: Service producers can use this method to add private DNS zones in the
...
func (c *ServicesDnsZonesAddCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.adddnszonerequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsZones.add", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesDnsZonesAddCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsZones.add", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Remove: Service producers can use this method to remove private DNS zones in
// the shared producer host project and matching peering zones in the consumer
// project.
//
//   - parent: The service that is managing peering connectivity for a service
//     producer's organization. For Google services that support this
...
func (c *ServicesDnsZonesRemoveCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.removednszonerequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsZones.remove", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesDnsZonesRemoveCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.dnsZones.remove", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Get: Service producers use this method to get the configuration of their
...
// IncludeUsedIpRanges sets the optional parameter "includeUsedIpRanges": When
// true, include the used IP ranges as part of the GetConsumerConfig output.
// This includes routes created inside the service networking network, consumer
// network, peers of the consumer network, and reserved ranges inside the
// service networking network. By default, this is false
...
func (c *ServicesProjectsGlobalNetworksGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.projects.global.networks.get" call.
// Any non-2xx status code is an error. Response headers are in either
// *ConsumerConfig.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ServicesProjectsGlobalNetworksGetCall) Do(opts ...googleapi.CallOption) (*ConsumerConfig, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// GetVpcServiceControls: Consumers use this method to find out the state of
// VPC Service Controls. The controls could be enabled or disabled for a
// connection.
//
//   - name: Name of the VPC Service Controls config to retrieve in the format:
//     `services/{service}/projects/{project}/global/networks/{network}`.
//     {service} is the peering service that is managing connectivity for the
//     service producer's organization. For Google services that support this
//     functionality, this value is `servicenetworking.googleapis.com`. {project}
...
func (c *ServicesProjectsGlobalNetworksGetVpcServiceControlsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.getVpcServiceControls", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.projects.global.networks.getVpcServiceControls" call.
// Any non-2xx status code is an error. Response headers are in either
// *VpcServiceControls.ServerResponse.Header or (if a response was returned at
...
func (c *ServicesProjectsGlobalNetworksGetVpcServiceControlsCall) Do(opts ...googleapi.CallOption) (*VpcServiceControls, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.getVpcServiceControls", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// configuration of their connection including the import/export of custom
// routes and subnetwork routes with public IP.
//
//   - parent: Parent resource identifying the connection for which the consumer
...
func (c *ServicesProjectsGlobalNetworksUpdateConsumerConfigCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.updateconsumerconfigrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.updateConsumerConfig", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesProjectsGlobalNetworksUpdateConsumerConfigCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.updateConsumerConfig", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Get: Service producers can use this method to retrieve a DNS zone in the
// shared producer host project and the matching peering zones in consumer
// project
//
...
func (c *ServicesProjectsGlobalNetworksDnsZonesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.dnsZones.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.projects.global.networks.dnsZones.get" call.
// Any non-2xx status code is an error. Response headers are in either
// *GetDnsZoneResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *ServicesProjectsGlobalNetworksDnsZonesGetCall) Do(opts ...googleapi.CallOption) (*GetDnsZoneResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.dnsZones.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// available DNS zones in the shared producer host project and the matching
...
func (c *ServicesProjectsGlobalNetworksDnsZonesListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.dnsZones.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.projects.global.networks.dnsZones.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListDnsZonesResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *ServicesProjectsGlobalNetworksDnsZonesListCall) Do(opts ...googleapi.CallOption) (*ListDnsZonesResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.dnsZones.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Create: Creates a peered DNS domain which sends requests for records in
// given namespace originating in the service producer VPC network to the
// consumer VPC network to be resolved.
//
//   - parent: Parent resource identifying the connection for which the peered
...
func (c *ServicesProjectsGlobalNetworksPeeredDnsDomainsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.peereddnsdomain)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.peeredDnsDomains.create", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesProjectsGlobalNetworksPeeredDnsDomainsCreateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.peeredDnsDomains.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
//     `services/{service}/projects/{project}/global/networks/{network}/peeredDnsD
//     omains/{name}`. {service} is the peering service that is managing
//     connectivity for the service producer's organization. For Google services
//     that support this functionality, this value is
//     `servicenetworking.googleapis.com`. {project} is the number of the project
//     that contains the service consumer's VPC network e.g. `12345`. {network}
//     is the name of the service consumer's VPC network. {name} is the name of
//     the peered DNS domain.
...
func (c *ServicesProjectsGlobalNetworksPeeredDnsDomainsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.peeredDnsDomains.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesProjectsGlobalNetworksPeeredDnsDomainsDeleteCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.peeredDnsDomains.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ServicesProjectsGlobalNetworksPeeredDnsDomainsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.peeredDnsDomains.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "servicenetworking.services.projects.global.networks.peeredDnsDomains.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListPeeredDnsDomainsResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ServicesProjectsGlobalNetworksPeeredDnsDomainsListCall) Do(opts ...googleapi.CallOption) (*ListPeeredDnsDomainsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.projects.global.networks.peeredDnsDomains.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Add: Service producers can use this method to add roles in the shared VPC
// host project. Each role is bound to the provided member. Each role must be
...
func (c *ServicesRolesAddCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.addrolesrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.roles.add", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesRolesAddCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.roles.add", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
