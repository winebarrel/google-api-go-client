...
func (c *SitesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "abusiveexperiencereport.sites.get", "request", internallog.HTTPRequest(req, nil))
...
func (c *SitesGetCall) Do(opts ...googleapi.CallOption) (*SiteSummaryResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "abusiveexperiencereport.sites.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ViolatingSitesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "abusiveexperiencereport.violatingSites.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ViolatingSitesListCall) Do(opts ...googleapi.CallOption) (*ViolatingSitesResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "abusiveexperiencereport.violatingSites.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
