...
type Secret struct {
	...
	// `projects/*/secrets/*`.
	Name string `json:"name,omitempty"`
	// Replication: Required. Immutable. The replication policy of the secret data
...
// contains the sensitive secret data that is associated with a SecretVersion.
...
//
//   - name: The resource name of the SecretVersion in the format
//     `projects/*/secrets/*/versions/*`. `projects/*/secrets/*/versions/latest`
