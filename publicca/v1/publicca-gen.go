...
// Usage example:
//
//	import "google.golang.org/api/publicca/v1"
//	...
...
package publicca // import "google.golang.org/api/publicca/v1"
...
func (c *ProjectsLocationsExternalAccountKeysCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/externalAccountKeys")
