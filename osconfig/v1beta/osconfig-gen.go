...
// AptRepository: Represents a single Apt package repository. This repository
// is added to a repo file that is stored at
// `/etc/apt/sources.list.d/google_osconfig.list`.
type AptRepository struct {
	// ArchiveType: Type of archive files in this repository. The default behavior
	// is DEB.
	//
	// Possible values:
	...
	// keyring at `/etc/apt/trusted.gpg.d/osconfig_agent_managed.gpg` containing
...
// Assignment: An assignment represents the group or groups of VM instances
// that the policy applies to. If an assignment is empty, it applies to all VM
...
type Assignment struct {
	...
	// these prefixes. Like labels, this is another way to group VM instances when
	...
	// by their URI in the form `zones/[ZONE]/instances/[INSTANCE_NAME]`. Instance
	// targeting is uncommon and is supported to facilitate the management of
	// changes by the instance or to target specific VM instances for development
	// and testing. Only supported for project-level policies and must reference
	// instances within this project.
	Instances []string `json:"instances,omitempty"`
	// OsTypes: Targets VM instances matching at least one of the following OS
	// types. VM instances must match all supplied criteria for a given OsType to
	// be included.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GroupLabels") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// identified as having all these labels, for example "env=prod and app=web".
...
// AssignmentOsType: Defines the criteria for selecting VM Instances by OS
// type.
type AssignmentOsType struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "OsArchitecture") to include in
...
type EffectiveGuestPolicy struct {
	...
	// ForceSendFields is a list of field names (e.g. "PackageRepositories") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PackageRepositories") to include
...
// EffectiveGuestPolicySourcedPackage: A guest policy package including its
// source.
...
type EffectiveGuestPolicySourcedPackageRepository struct {
	...
	// Source: Name of the guest policy providing this config.
	Source string `json:"source,omitempty"`
	// ForceSendFields is a list of field names (e.g. "PackageRepository") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PackageRepository") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EffectiveGuestPolicySourcedSoftwareRecipe: A guest policy recipe including
// its source.
type EffectiveGuestPolicySourcedSoftwareRecipe struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "SoftwareRecipe") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GcsObject struct {
	...
	// object. This is used to ensure that the ExecStep specified by this PatchJob
	// does not change.
...
// GooRepository: Represents a Goo package repository. These is added to a repo
// file that is stored at C:/ProgramData/GooGet/repos/google_osconfig.repo.
...
// policy. These policies represent the desired state for VM instance guest
...
type GuestPolicy struct {
	...
	// different parameters such as labels, names, OS, or zones. If left empty, all
	// VM instances underneath this policy are targeted. At the same level in the
	...
	// information, see how the service handles assignment conflicts
	// (/compute/docs/os-config-management/create-guest-policy#handle-conflicts).
	...
	// limited to 1024 characters.
	Description string `json:"description,omitempty"`
	// Etag: The etag for this guest policy. If this is provided on update, it must
	// match the server's etag.
	Etag string `json:"etag,omitempty"`
	// Name: Required. Unique name of the resource in this project using one of the
	// following forms:
	// `projects/{project_number}/guestPolicies/{guest_policy_id}`.
	Name string `json:"name,omitempty"`
	// PackageRepositories: A list of package repositories to configure on the VM
	// instance. This is done before any other configs are applied so they can use
	// these repos. Package repositories are only configured if the corresponding
...
type ListGuestPoliciesResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GuestPolicies") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LookupEffectiveGuestPolicyRequest struct {
	...
	// agent only provides this field for targeting if OS Inventory is enabled for
	// that instance.
	OsArchitecture string `json:"osArchitecture,omitempty"`
	...
	// only provides this field for targeting if OS Inventory is enabled for that
	// VM instance.
	OsVersion string `json:"osVersion,omitempty"`
	// ForceSendFields is a list of field names (e.g. "OsArchitecture") to
	// unconditionally include in API requests. By default, fields with empty or
...
// Package: Package is a reference to the software package to be installed or
...
type Package struct {
	// DesiredState: The desired_state the agent should maintain for this package.
	...
	// If a system does not have the package manager, the package is not installed
	// or removed no error message is returned. By default, or if you specify
	// `ANY`, the agent attempts to install and remove this package using the
	// default package manager. This is useful when creating a policy that applies
	...
	// for conflict validation by checking the package name and the manager(s) that
	// the package targets.
	Name string `json:"name,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DesiredState") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type PatchInstanceFilter struct {
	...
	// GroupLabels: Targets VM instances matching at least one of these label sets.
...
// SoftwareRecipe: A software recipe is a set of instructions for installing
// and configuring a piece of software. It consists of a set of artifacts that
// are downloaded, and a set of steps that install, configure, and/or update
// the software. Recipes support installing and updating software from
// artifacts in the following formats: Zip archive, Tar archive, Windows MSI,
// Debian package, and RPM package. Additionally, recipes support executing a
// script (either defined in a file or directly in this api) in bash, sh, cmd,
// and powershell. Updating a software recipe If a recipe is assigned to an
...
type SoftwareRecipe struct {
	...
	// maintain for this recipe. INSTALLED: The software recipe is installed on the
	// instance but won't be updated to new versions. UPDATED: The software recipe
	// is installed on the instance. The recipe is updated to a higher version, if
	// a higher version of the recipe is assigned to this instance. REMOVE: Remove
	...
	// uninstall it if detected.
	DesiredState string `json:"desiredState,omitempty"`
	// InstallSteps: Actions to be taken for installing this recipe. On failure it
	// stops executing steps and does not attempt another installation. Any steps
	...
	// resources which helps to determine whether guest policies have conflicts.
	// This means that requests to create multiple recipes with the same name and
	// version are rejected since they could potentially have conflicting
	// assignments.
	Name string `json:"name,omitempty"`
	// UpdateSteps: Actions to be taken for updating this recipe. On failure it
	// stops executing steps and does not attempt another update for this recipe.
	// Any steps taken (including partially completed steps) are not rolled back.
	UpdateSteps []*SoftwareRecipeStep `json:"updateSteps,omitempty"`
	// Version: The version of this software recipe. Version can be up to 4 period
...
type SoftwareRecipeArtifact struct {
	...
	// specified, and only protocols with transport-layer security are permitted.
	// GCS: An object generation number must be specified.
	AllowInsecure bool `json:"allowInsecure,omitempty"`
	// Gcs: A Google Cloud Storage artifact.
	Gcs *SoftwareRecipeArtifactGcs `json:"gcs,omitempty"`
	// Id: Required. Id of the artifact, which the installation and update steps of
...
// SoftwareRecipeArtifactGcs: Specifies an artifact available as a Google Cloud
// Storage object.
type SoftwareRecipeArtifactGcs struct {
	// Bucket: Bucket of the Google Cloud Storage object. Given an example URL:
	// `https://storage.googleapis.com/my-bucket/foo/bar#1234567` this value would
	// be `my-bucket`.
	Bucket string `json:"bucket,omitempty"`
	// Generation: Must be provided if allow_insecure is false. Generation number
	// of the Google Cloud Storage object.
	// `https://storage.googleapis.com/my-bucket/foo/bar#1234567` this value would
	// be `1234567`.
	Generation int64 `json:"generation,omitempty,string"`
	// Object: Name of the Google Cloud Storage object. As specified [here]
	// (https://cloud.google.com/storage/docs/naming#objectnames) Given an example
	// URL: `https://storage.googleapis.com/my-bucket/foo/bar#1234567` this value
	// would be `foo/bar`.
	Object string `json:"object,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Bucket") to unconditionally
	// include in API requests. By default, fields with empty or default values are
...
type SoftwareRecipeArtifactRemote struct {
	...
	// in hex format, to compare to the checksum of the artifact. If the checksum
	// is not empty and it doesn't match the artifact then the recipe installation
	// fails before running any of the steps.
	Checksum string `json:"checksum,omitempty"`
	// Uri: URI from which to fetch the object. It should contain both the protocol
...
// SoftwareRecipeStep: An action that can be taken as part of installing or
// updating a recipe.
type SoftwareRecipeStep struct {
	...
	// ForceSendFields is a list of field names (e.g. "ArchiveExtraction") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ArchiveExtraction") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// SoftwareRecipeStepCopyFile: Copies the artifact to the specified path on the
// instance.
...
type SoftwareRecipeStepExecFile struct {
	// AllowedExitCodes: Defaults to [0]. A list of possible return values that the
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AllowedExitCodes") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// SoftwareRecipeStepExtractArchive: Extracts an archive of the type specified
...
type SoftwareRecipeStepInstallMsi struct {
	// AllowedExitCodes: Return codes that indicate that the software installed or
	// updated successfully. Behaviour defaults to [0]
	AllowedExitCodes []int64 `json:"allowedExitCodes,omitempty"`
	// ArtifactId: Required. The id of the relevant artifact in the recipe.
	ArtifactId string `json:"artifactId,omitempty"`
	// Flags: The flags to use when installing the MSI defaults to ["/i"] (i.e. the
	// install flag).
...
type SoftwareRecipeStepRunScript struct {
	...
	AllowedExitCodes []int64 `json:"allowedExitCodes,omitempty"`
	// Interpreter: The script interpreter to use to run the script. If no
	// interpreter is specified the script is executed directly, which likely only
...
// YumRepository: Represents a single Yum package repository. This repository
// is added to a repo file that is stored at
...
//
//   - parent: The resource name of the parent using one of the following forms:
...
// GuestPolicyId sets the optional parameter "guestPolicyId": Required. The
// logical name of the guest policy in the project with the following
...
func (c *ProjectsGuestPoliciesCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.guestpolicy)
	if err != nil {
		return nil, err
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.create", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "osconfig.projects.guestPolicies.create" call.
// Any non-2xx status code is an error. Response headers are in either
// *GuestPolicy.ServerResponse.Header or (if a response was returned at all) in
...
func (c *ProjectsGuestPoliciesCreateCall) Do(opts ...googleapi.CallOption) (*GuestPolicy, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
//
//   - name: The resource name of the guest policy using one of the following
...
func (c *ProjectsGuestPoliciesDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsGuestPoliciesDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsGuestPoliciesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsGuestPoliciesGetCall) Do(opts ...googleapi.CallOption) (*GuestPolicy, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// PageSize sets the optional parameter "pageSize": The maximum number of guest
// policies to return.
...
// returned from a previous call to `ListGuestPolicies` that indicates where
...
func (c *ProjectsGuestPoliciesListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "osconfig.projects.guestPolicies.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListGuestPoliciesResponse.ServerResponse.Header or (if a response was
...
func (c *ProjectsGuestPoliciesListCall) Do(opts ...googleapi.CallOption) (*ListGuestPoliciesResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsGuestPoliciesPatchCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.patch", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsGuestPoliciesPatchCall) Do(opts ...googleapi.CallOption) (*GuestPolicy, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "osconfig.projects.guestPolicies.patch", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// LookupEffectiveGuestPolicy: Lookup the effective guest policy that applies
// to a VM instance. This lookup merges all policies that are assigned to the
// instance ancestry.
//
...
func (c *ProjectsZonesInstancesLookupEffectiveGuestPolicyCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.lookupeffectiveguestpolicyrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "osconfig.projects.zones.instances.lookupEffectiveGuestPolicy", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "osconfig.projects.zones.instances.lookupEffectiveGuestPolicy" call.
// Any non-2xx status code is an error. Response headers are in either
// *EffectiveGuestPolicy.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *ProjectsZonesInstancesLookupEffectiveGuestPolicyCall) Do(opts ...googleapi.CallOption) (*EffectiveGuestPolicy, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "osconfig.projects.zones.instances.lookupEffectiveGuestPolicy", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
