...
type ExportAssetsRequest struct {
	...
	// example: "google.compute.Disk". If specified, only matching assets will be
	// returned. See Introduction to Cloud Asset Inventory
	...
	// timestamp between 2018-10-02 UTC (inclusive) and the current time. If not
...
type GcsDestination struct {
	...
	// format: "gs://bucket_name/object_name_prefix// and only contains assets for
	// that type. starts from 0. For example:
...
// implements the google.longrunning.Operation API allowing you to keep track
// of the export. We recommend intervals of at least 2 seconds with exponential
// retry to poll the export operation result. For regular-size resource parent,
...
func (c *FoldersExportAssetsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.folders.exportAssets", "request", internallog.HTTPRequest(req, body.Bytes()))
...
func (c *FoldersExportAssetsCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.folders.exportAssets", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *FoldersOperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.folders.operations.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *FoldersOperationsGetCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.folders.operations.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// names of the assets. For example:
// `//compute.googleapis.com/projects/my_project_123/zones/zone1/instances/insta
// nce1`. See Resource Names
// (https://cloud.google.com/apis/design/resource_names#full_resource_name) for
...
func (c *OrganizationsBatchGetAssetsHistoryCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.organizations.batchGetAssetsHistory", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *OrganizationsBatchGetAssetsHistoryCall) Do(opts ...googleapi.CallOption) (*BatchGetAssetsHistoryResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.organizations.batchGetAssetsHistory", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *OrganizationsExportAssetsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.organizations.exportAssets", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *OrganizationsExportAssetsCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.organizations.exportAssets", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *OrganizationsOperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.organizations.operations.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *OrganizationsOperationsGetCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.organizations.operations.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsBatchGetAssetsHistoryCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.projects.batchGetAssetsHistory", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsBatchGetAssetsHistoryCall) Do(opts ...googleapi.CallOption) (*BatchGetAssetsHistoryResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.projects.batchGetAssetsHistory", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsExportAssetsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.projects.exportAssets", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsExportAssetsCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.projects.exportAssets", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsOperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudasset.projects.operations.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsOperationsGetCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudasset.projects.operations.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
