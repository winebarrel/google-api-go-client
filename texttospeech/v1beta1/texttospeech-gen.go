...
// response returned by the `SynthesizeLongAudio` method.
...
type SynthesizeSpeechRequest struct {
	...
	//
	// Possible values:
	//   "TIMEPOINT_TYPE_UNSPECIFIED" - Not specified. No timepoint information
	// will be returned.
...
type SynthesizeSpeechResponse struct {
	...
	// Timepoints: A link between a position in the original request input and a
	// corresponding time in the output audio. It's only supported via `` of SSML
	// input.
...
// and a corresponding time in the output audio.
type Timepoint struct {
	// MarkName: Timepoint name as received from the client within `` tag.
	MarkName string `json:"markName,omitempty"`
	// TimeSeconds: Time offset in seconds from the start of the synthesized audio.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MarkName") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
