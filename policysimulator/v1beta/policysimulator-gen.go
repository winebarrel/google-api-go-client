...
// GoogleCloudPolicysimulatorV1betaAccessStateDiff: A summary and comparison of
// the principal's access under the current (baseline) policies and the
...
// GoogleCloudPolicysimulatorV1betaBindingExplanation: Details about how a
...
// GoogleCloudPolicysimulatorV1betaExplainedAccess: Details about how a set of
// policies, listed in ExplainedPolicy, resulted in a certain AccessState when
...
type GoogleCloudPolicysimulatorV1betaExplainedAccess struct {
	...
	// Policies: If the AccessState is `UNKNOWN`, this field contains the policies
	// that led to that result. If the `AccessState` is `GRANTED` or `NOT_GRANTED`,
...
type GoogleCloudPolicysimulatorV1betaExplainedPolicy struct {
	...
	// example,
	// `//compute.googleapis.com/projects/my-project/zones/us-central1-a/instances/m
	// y-instance`. If the user who created the Replay does not have access to the
	// policy, this field is omitted. For examples of full resource names for
	// Google Cloud services, see
	// https://cloud.google.com/iam/help/troubleshooter/full-resource-names.
	FullResourceName string `json:"fullResourceName,omitempty"`
	// Policy: The IAM policy attached to the resource. If the user who created the
...
// GoogleCloudPolicysimulatorV1betaListReplayResultsResponse: Response message
// for Simulator.ListReplayResults.
...
// GoogleCloudPolicysimulatorV1betaListReplaysResponse: Response message for
// Simulator.ListReplays.
...
// GoogleCloudPolicysimulatorV1betaOrgPolicyViolation: OrgPolicyViolation is a
// resource representing a single resource violating a single OrgPolicy
// constraint.
type GoogleCloudPolicysimulatorV1betaOrgPolicyViolation struct {
	...
	// organizations/my-example-org/locations/global/orgPolicyViolationsPreviews/506
	// a5f7f/orgPolicyViolations/38ce`
	Name string `json:"name,omitempty"`
...
// GoogleCloudPolicysimulatorV1betaReplay: A resource describing a `Replay`, or
// simulation.
...
// GoogleCloudPolicysimulatorV1betaReplayConfig: The configuration used for a
// Replay.
...
// GoogleCloudPolicysimulatorV1betaReplayDiff: The difference between the
// results of evaluating an access tuple under the current (baseline) policies
// and under the proposed (simulated) policies. This difference explains how a
// principal's access could change if the proposed policies were applied.
type GoogleCloudPolicysimulatorV1betaReplayDiff struct {
	...
	// single access tuple. The evaluation of the principal's access is reported in
	// the AccessState field.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AccessDiff") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudPolicysimulatorV1betaReplayResult: The result of replaying a
...
type GoogleCloudPolicysimulatorV1betaReplayResult struct {
	...
	// information about the principal, resource, and permission that were involved
	// in the access attempt.
	...
	// Error: The error that caused the access tuple replay to fail. This field is
	...
	// `{projects|folders|organizations}/{resource-id}/locations/global/replays/{rep
	// lay-id}/results/{replay-result-id}`, where `{resource-id}` is the ID of the
	// project, folder, or organization that owns the Replay. Example:
	// `projects/my-example-project/locations/global/replays/506a5f7f-38ce-4d7d-8e03
	// -479ce1833c36/results/1234`
	Name string `json:"name,omitempty"`
...
// GoogleCloudPolicysimulatorV1betaReplayResultsSummary: Summary statistics
...
// GoogleCloudPolicysimulatorV1betaResourceContext: ResourceContext provides
// the context we know about a resource. It is similar in concept to
// google.cloud.asset.v1.Resource, but focuses on the information specifically
// used by Simulator.
type GoogleCloudPolicysimulatorV1betaResourceContext struct {
	...
	// `compute.googleapis.com/Firewall` See Supported asset types
...
func (c *FoldersLocationsReplaysCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudpolicysimulatorv1betareplay)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
// Get: Gets the specified Replay. Each `Replay` is available for at least 7
// days.
//
//   - name: The name of the Replay to retrieve, in the following format:
//     `{projects|folders|organizations}/{resource-id}/locations/global/replays/{r
//     eplay-id}`, where `{resource-id}` is the ID of the project, folder, or
//     organization that owns the `Replay`. Example:
//     `projects/my-example-project/locations/global/replays/506a5f7f-38ce-4d7d-8e
//     03-479ce1833c36`.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudPolicysimulatorV1betaReplay.ServerResponse.Header or (if a
...
// List: Lists each Replay in a project, folder, or organization. Each `Replay`
...
//     Only `Replay` objects that are direct children of the provided parent are
//     listed. In other words, `Replay` objects that are children of a project
...
// Replay objects to return. Defaults to 50. The maximum value is 1000; values
...
// from a previous Simulator.ListReplays call. Provide this to retrieve the
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudPolicysimulatorV1betaListReplaysResponse.ServerResponse.Header
...
//
//   - parent: The Replay whose results are listed, in the following format:
//     `{projects|folders|organizations}/{resource-id}/locations/global/replays/{r
//     eplay-id}` Example:
//     `projects/my-project/locations/global/replays/506a5f7f-38ce-4d7d-8e03-479ce
//     1833c36`.
...
// PageSize sets the optional parameter "pageSize": The maximum number of
// ReplayResult objects to return. Defaults to 5000. The maximum value is 5000;
...
// PageToken sets the optional parameter "pageToken": A page token, received
// from a previous Simulator.ListReplayResults call. Provide this token to
// retrieve the next page of results. When paginating, all other parameters
// provided to [Simulator.ListReplayResults[] must match the call that provided
// the page token.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudPolicysimulatorV1betaListReplayResultsResponse.ServerResponse.Hea
...
//
//   - parent: The organization under which this OrgPolicyViolationsPreview will
//     be created. Example: `organizations/my-example-org/locations/global`.
func (r *OrganizationsLocationsOrgPolicyViolationsPreviewsService) Create(parent string, googlecloudpolicysimulatorv1betaorgpolicyviolationspreview *GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview) *OrganizationsLocationsOrgPolicyViolationsPreviewsCreateCall {
...
// OrgPolicyViolationsPreview. If not provided, a random ID will be generated.
...
func (c *OrganizationsLocationsOrgPolicyViolationsPreviewsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudpolicysimulatorv1betaorgpolicyviolationspreview)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
type OrganizationsLocationsOrgPolicyViolationsPreviewsGenerateCall struct {
	s                                                          *Service
	parent                                                     string
	googlecloudpolicysimulatorv1betaorgpolicyviolationspreview *GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview
	urlParams_                                                 gensupport.URLParams
...
// Generate: GenerateOrgPolicyViolationsPreview generates an
// OrgPolicyViolationsPreview for the proposed changes in the provided
// OrgPolicyViolationsPreview.OrgPolicyOverlay. The changes to OrgPolicy are
// specified by this `OrgPolicyOverlay`. The resources to scan are inferred
// from these specified changes.
...
//   - parent: The organization under which this OrgPolicyViolationsPreview will
//     be created. Example: `organizations/my-example-org/locations/global`.
func (r *OrganizationsLocationsOrgPolicyViolationsPreviewsService) Generate(parent string, googlecloudpolicysimulatorv1betaorgpolicyviolationspreview *GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview) *OrganizationsLocationsOrgPolicyViolationsPreviewsGenerateCall {
	c := &OrganizationsLocationsOrgPolicyViolationsPreviewsGenerateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.googlecloudpolicysimulatorv1betaorgpolicyviolationspreview = googlecloudpolicysimulatorv1betaorgpolicyviolationspreview
	return c
}
...
func (c *OrganizationsLocationsOrgPolicyViolationsPreviewsGenerateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta/{+parent}/orgPolicyViolationsPreviews:generate")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// OrgPolicyViolationsPreview. Each OrgPolicyViolationsPreview is available for
// at least 7 days.
//
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview.ServerResponse.He
...
// List: ListOrgPolicyViolationsPreviews lists each OrgPolicyViolationsPreview
// in an organization. Each OrgPolicyViolationsPreview is available for at
// least 7 days.
//
...
// most 5 items will be returned. The maximum value is 10; values above 10 will
// be coerced to 10.
...
// paginating, all other parameters must match the call that provided the page
// token.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse.Serv
...
// List: ListOrgPolicyViolations lists the OrgPolicyViolations that are present
// in an OrgPolicyViolationsPreview.
//
//   - parent: The OrgPolicyViolationsPreview to get OrgPolicyViolations from.
//     Format:
//     organizations/{organization}/locations/{location}/orgPolicyViolationsPrevie
//     ws/{orgPolicyViolationsPreview}.
...
// PageSize sets the optional parameter "pageSize": The maximum number of items
// to return. The service may return fewer than this value. If unspecified, at
// most 1000 items will be returned. The maximum value is 1000; values above
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse.ServerRespon
