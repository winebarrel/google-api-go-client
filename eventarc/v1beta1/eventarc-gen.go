...
package eventarc // import "github.com/winebarrel/google-api-go-client/eventarc/v1beta1"
...
type CloudRunService struct {
	...
	// be sent to. The value must conform to the definition of URI path segment
...
type Destination struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CloudRunService") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ListTriggersResponse struct {
	// NextPageToken: A page token that can be sent to ListTriggers to request the
...
// MatchingCriteria: Matches events based on exact matches on the CloudEvents
// attributes.
type MatchingCriteria struct {
	// Attribute: Required. The name of a CloudEvents attribute. Currently, only a
	// subset of attributes can be specified. All triggers MUST provide a matching
	// criteria for the 'type' attribute.
...
type Pubsub struct {
	...
	// managed by Eventarc system as a transport for the event delivery. Format:
...
type Trigger struct {
	...
	// value of other fields, and may be sent only on create requests to ensure the
	// client has an up-to-date value before proceeding.
	Etag string `json:"etag,omitempty"`
	// Labels: Optional. User labels attached to the triggers that can be used to
	// group resources.
	Labels map[string]string `json:"labels,omitempty"`
	// MatchingCriteria: Required. Unordered list. The criteria by which events are
	...
	// Transport: Output only. In order to deliver messages, Eventarc may use other
	// Google Cloud products as transport intermediary. This field contains a
	// reference to that transport intermediary. This information can be used for
	// debugging purposes.
...
// ValidateOnly sets the optional parameter "validateOnly": Required. If set,
// validate the request and preview the review, but do not actually post it.
...
// updated; only fields explicitly provided will be updated. If no field mask
// is provided, all provided fields in the request will be updated. To update
