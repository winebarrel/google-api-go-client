...
type ManagedShortLink struct {
	...
	//   "NEVER_SHOWN" - Link created outside of console and should never be shown
	// in console.
...
type NavigationInfo struct {
	// EnableForcedRedirect: If this option is on, FDL click will be forced to
	// redirect rather than show an interstitial page.
	EnableForcedRedirect bool `json:"enableForcedRedirect,omitempty"`
	// ForceSendFields is a list of field names (e.g. "EnableForcedRedirect") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EnableForcedRedirect") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type SocialMetaTagInfo struct {
	...
	// ForceSendFields is a list of field names (e.g. "SocialDescription") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "SocialDescription") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Suffix struct {
	...
	// string of a random generated 96 bit random number, which has a length of 17
	// chars. For example, "nlAR8U4SlKRZw1cb2". It prevents other people from
	// guessing and crawling short Dynamic Links that contain personal identifiable
	// information.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CustomSuffix") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// Create: Creates a managed short Dynamic Link given either a valid long
...
// *CreateManagedShortLinkResponse.ServerResponse.Header or (if a response was
...
// Create: Creates a short Dynamic Link given either a valid long Dynamic Link
...
// Any non-2xx status code is an error. Response headers are in either
// *CreateShortDynamicLinkResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// GetLinkStats: Fetches analytics stats of a short Dynamic Link for a given
// duration. Metrics include number of clicks, redirects, installs, app first
// opens, and app reopens.
//
...
// DurationDays sets the optional parameter "durationDays": The span of time
// requested in days.
...
// SdkVersion sets the optional parameter "sdkVersion": Google SDK version.
...
// Any non-2xx status code is an error. Response headers are in either
// *DynamicLinkStats.ServerResponse.Header or (if a response was returned at
...
// Any non-2xx status code is an error. Response headers are in either
// *GetIosPostInstallAttributionResponse.ServerResponse.Header or (if a
...
// ReopenAttribution: Get iOS reopen attribution for app universal link open
// deeplinking.
...
// Any non-2xx status code is an error. Response headers are in either
// *GetIosReopenAttributionResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
