...
const basePathTemplate = "https://playcustomapp.UNIVERSE_DOMAIN/"
...
func (c *AccountsCustomAppsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.customapp)
	if err != nil {
		return nil, err
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "playcustomapp.accounts.customApps.create", "request", internallog.HTTPRequest(req, body.Bytes()))
...
func (c *AccountsCustomAppsCreateCall) Do(opts ...googleapi.CallOption) (*CustomApp, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "playcustomapp.accounts.customApps.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
