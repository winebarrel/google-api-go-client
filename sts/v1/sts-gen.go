...
type GoogleIdentityStsV1ExchangeTokenRequest struct {
	...
	// ders/` for workload identity pool providers, or
	...
	// the SAML 2.0 spec
	// (https://docs.oasis-open.org/security/saml/Post2.0/sstc-saml-tech-overview-2.0-cd-02.pdf),
...
// *GoogleIdentityStsV1ExchangeTokenResponse.ServerResponse.Header or (if a
