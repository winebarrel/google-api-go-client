...
type Job struct {
	...
	// LegacyAppEngineCron: Immutable. This field is used to manage the legacy App
	// Engine Cron jobs using the Cloud Scheduler API. If the field is set to true,
	// the job will be considered a legacy job. Note that App Engine Cron jobs have
	// fewer features than Cloud Scheduler jobs, e.g., are only limited to App
	// Engine targets.
...
type RunJobRequest struct {
	// LegacyAppEngineCron: This field is used to manage the legacy App Engine Cron
	// jobs using the Cloud Scheduler API. If the field is set to true, the job in
	// the __cron queue with the corresponding name will be forced to run instead.
	LegacyAppEngineCron bool `json:"legacyAppEngineCron,omitempty"`
	// ForceSendFields is a list of field names (e.g. "LegacyAppEngineCron") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LegacyAppEngineCron") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// LegacyAppEngineCron sets the optional parameter "legacyAppEngineCron": This
// field is used to manage the legacy App Engine Cron jobs using the Cloud
...
// a subset of jobs. If `filter` equals `target_config="HttpConfig", then the
// http target jobs are retrieved. If `filter` equals
// `target_config="PubSubConfig", then the Pub/Sub target jobs are retrieved.
// If `filter` equals `labels.foo=value1 labels.foo=value2` then only jobs
...
// LegacyAppEngineCron sets the optional parameter "legacyAppEngineCron": This
// field is used to manage the legacy App Engine Cron jobs using the Cloud
// Scheduler API. If the field is set to true, the jobs in the __cron queue
