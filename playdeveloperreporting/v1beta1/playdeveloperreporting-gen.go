...
// GooglePlayDeveloperReportingV1beta1LmkRateMetricSet: Singleton resource
...
type GooglePlayDeveloperReportingV1beta1LmkRateMetricSet struct {
	// FreshnessInfo: Summary about data freshness in this resource.
	FreshnessInfo *GooglePlayDeveloperReportingV1beta1FreshnessInfo `json:"freshnessInfo,omitempty"`
...
func (s GooglePlayDeveloperReportingV1beta1LmkRateMetricSet) MarshalJSON() ([]byte, error) {
	type NoMethod GooglePlayDeveloperReportingV1beta1LmkRateMetricSet
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest: Request
// message for QueryLmkRateMetricSet.
type GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest struct {
...
func (s GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest) MarshalJSON() ([]byte, error) {
	type NoMethod GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse: Response
// message for QueryLmkRateMetricSet.
type GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse struct {
	// NextPageToken: Continuation token to fetch the next page of data.
	NextPageToken string `json:"nextPageToken,omitempty"`
	// Rows: Returned rows of data.
	Rows []*GooglePlayDeveloperReportingV1beta1MetricsRow `json:"rows,omitempty"`
...
func (s GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// Any non-2xx status code is an error. Response headers are in either
// *GooglePlayDeveloperReportingV1beta1LmkRateMetricSet.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *VitalsLmkrateGetCall) Do(opts ...googleapi.CallOption) (*GooglePlayDeveloperReportingV1beta1LmkRateMetricSet, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &GooglePlayDeveloperReportingV1beta1LmkRateMetricSet{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
type VitalsLmkrateQueryCall struct {
	s                                                               *Service
	name                                                            string
	googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest *GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest
	urlParams_                                                      gensupport.URLParams
	ctx_                                                            context.Context
	header_                                                         http.Header
}
...
//
// - name: The resource name. Format: apps/{app}/lmkRateMetricSet.
func (r *VitalsLmkrateService) Query(name string, googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest *GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest) *VitalsLmkrateQueryCall {
	c := &VitalsLmkrateQueryCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest = googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest
	return c
}
...
func (c *VitalsLmkrateQueryCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
// Any non-2xx status code is an error. Response headers are in either
// *GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse.ServerRespo
// nse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *VitalsLmkrateQueryCall) Do(opts ...googleapi.CallOption) (*GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *VitalsLmkrateQueryCall) Pages(ctx context.Context, f func(*GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse) error) error {
	c.ctx_ = ctx
	defer func(pt string) { c.googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest.PageToken = pt }(c.googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest.PageToken)
	for {
		x, err := c.Do()
		if err != nil {
			return err
		...
		c.googleplaydeveloperreportingv1beta1querylmkratemetricsetrequest.PageToken = x.NextPageToken
	}
}
