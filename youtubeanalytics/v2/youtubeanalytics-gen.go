...
const basePathTemplate = "https://youtubeanalytics.UNIVERSE_DOMAIN/"
...
func (c *GroupItemsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtubeAnalytics.groupItems.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtubeAnalytics.groupItems.delete" call.
// Any non-2xx status code is an error. Response headers are in either
// *EmptyResponse.ServerResponse.Header or (if a response was returned at all)
...
func (c *GroupItemsDeleteCall) Do(opts ...googleapi.CallOption) (*EmptyResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtubeAnalytics.groupItems.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *GroupItemsInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.groupitem)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtubeAnalytics.groupItems.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *GroupItemsInsertCall) Do(opts ...googleapi.CallOption) (*GroupItem, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtubeAnalytics.groupItems.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// GroupId sets the optional parameter "groupId": The `groupId` parameter
// specifies the unique ID of the group for which you want to retrieve group
// items.
...
func (c *GroupItemsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtubeAnalytics.groupItems.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtubeAnalytics.groupItems.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListGroupItemsResponse.ServerResponse.Header or (if a response was returned
...
func (c *GroupItemsListCall) Do(opts ...googleapi.CallOption) (*ListGroupItemsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtubeAnalytics.groupItems.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *GroupsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *GroupsDeleteCall) Do(opts ...googleapi.CallOption) (*EmptyResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *GroupsInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *GroupsInsertCall) Do(opts ...googleapi.CallOption) (*Group, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// being retrieved. Each group must be owned by the authenticated user. In a
// `group` resource, the `id` property specifies the group's YouTube group ID.
...
// Mine sets the optional parameter "mine": This parameter can only be used in
// a properly authorized request. Set this parameter's value to true to
...
func (c *GroupsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *GroupsListCall) Do(opts ...googleapi.CallOption) (*ListGroupsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *GroupsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *GroupsUpdateCall) Do(opts ...googleapi.CallOption) (*Group, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtubeAnalytics.groups.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// of YouTube Analytics dimensions, such as `views` or `ageGroup,gender`. See
// the Available Reports (/youtube/analytics/v2/available_reports) document for
// a list of the reports that you can retrieve and the dimensions used for
// those reports. Also see the Dimensions (/youtube/analytics/v2/dimsmets/dims)
...
// EndDate sets the optional parameter "endDate": The end date for fetching
// YouTube Analytics data. The value should be in `YYYY-MM-DD` format.
...
// (/youtube/analytics/v2/available_reports) document identifies the dimensions
// that can be used to filter each report, and the Dimensions
// (/youtube/analytics/v2/dimsmets/dims) document defines those dimensions. If
// a request uses multiple filters, join them together with a semicolon (`;`),
// and the returned result table will satisfy both filters. For example, a
// filters parameter value of `video==dMH0bHeiRNg;country==IT` restricts the
// result set to include data for the given video in Italy.",
func (c *ReportsQueryCall) Filters(filters string) *ReportsQueryCall {
	c.urlParams_.Set("filters", filters)
	return c
}

// Ids sets the optional parameter "ids": Identifies the YouTube channel or
// content owner for which you are retrieving YouTube Analytics data. - To
// request data for a YouTube user, set the `ids` parameter value to
...
// parameter value to `contentOwner==OWNER_NAME`, where `OWNER_NAME` is the CMS
// name of the content owner. required: true, pattern:
// [a-zA-Z]+==[a-zA-Z0-9_+-]+
...
// "includeHistoricalChannelData": If set to true historical data (i.e. channel
// data from before the linking of the channel to the content owner) will be
// retrieved.",
...
// rows to include in the response.", minValue: 1
func (c *ReportsQueryCall) MaxResults(maxResults int64) *ReportsQueryCall {
	c.urlParams_.Set("maxResults", fmt.Sprint(maxResults))
	return c
}

// Metrics sets the optional parameter "metrics": A comma-separated list of
// YouTube Analytics metrics, such as `views` or `likes,dislikes`. See the
// Available Reports (/youtube/analytics/v2/available_reports) document for a
// list of the reports that you can retrieve and the metrics available in each
// report, and see the Metrics (/youtube/analytics/v2/dimsmets/mets) document
...
// fetching YouTube Analytics data. The value should be in `YYYY-MM-DD` format.
// required: true, pattern: "[0-9]{4}-[0-9]{2}-[0-9]{2}
...
// StartIndex sets the optional parameter "startIndex": An index of the first
