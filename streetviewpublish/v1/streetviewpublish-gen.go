...
type BatchDeletePhotosRequest struct {
	...
	// NullFields is a list of field names (e.g. "PhotoIds") to include in API
...
type BatchDeletePhotosResponse struct {
	// Status: The status for the operation to delete a single Photo in the batch
	// request.
...
type BatchGetPhotosResponse struct {
	// Results: List of results for each individual Photo requested, in the same
	// order as the requests in BatchGetPhotos.
...
type BatchUpdatePhotosRequest struct {
	...
	// ForceSendFields is a list of field names (e.g. "UpdatePhotoRequests") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "UpdatePhotoRequests") to include
...
type BatchUpdatePhotosResponse struct {
	// Results: List of results for each individual Photo updated, in the same
...
type Connection struct {
	// Target: Required. The destination of the connection from the containing
...
// ProcessingFailureReason#GPS_DATA_GAP. If there are multiple GPS data gaps,
// only the one with the largest duration is reported here.
type GpsDataGapFailureDetails struct {
	...
	// GapStartTime: Relative time (from the start of the video stream) when the
	// gap started.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GapDuration") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Imu struct {
	// AccelMpsps: The accelerometer measurements in meters/sec^2 with increasing
	...
	// MagUt: The magnetometer measurements of the magnetic field in microtesla
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AccelMpsps") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// ProcessingFailureReason#IMU_DATA_GAP. If there are multiple IMU data gaps,
// only the one with the largest duration is reported here.
...
type InsufficientGpsFailureDetails struct {
	// GpsPointsFound: The number of GPS points that were found in the video.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GpsPointsFound") to include in
...
type LatLngBounds struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Northeast") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Level struct {
	// Name: Required. A name assigned to this Level, restricted to 3 characters.
	// Consider how the elevator buttons would be labeled for this level if there
	// was an elevator.
	Name string `json:"name,omitempty"`
	// Number: Optional. Floor number, used for ordering. 0 indicates the ground
	// level, 1 indicates the first level above ground level, -1 indicates the
	// first level under ground level. Non-integer values are OK.
...
// ListPhotoSequencesResponse: Response to list all photo sequences that belong
// to a user.
type ListPhotoSequencesResponse struct {
	...
	// PhotoSequences: List of photo sequences via Operation interface. The maximum
	// number of items returned is based on the pageSize field in the request. Each
	// item in the list can have three possible states, * `Operation.done` = false,
	// if the processing of PhotoSequence is not finished yet. * `Operation.done` =
	// true and `Operation.error` is populated, if there was an error in
	// processing. * `Operation.done` = true and `Operation.response` contains a
	// PhotoSequence message, In each sequence, only Id is populated.
...
type ListPhotosResponse struct {
	...
	// are no more results in the list.
	NextPageToken string `json:"nextPageToken,omitempty"`
	// Photos: List of photos. The pageSize field in the request determines the
...
type Measurement3d struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CaptureTime") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type NoOverlapGpsFailureDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GpsEndTime") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// ProcessingFailureReason#NOT_OUTDOORS. If there are multiple indoor frames
// found, the first frame is recorded here.
type NotOutdoorsFailureDetails struct {
	// StartTime: Relative time (from the start of the video stream) when an indoor
	// frame was found.
...
type Photo struct {
	// CaptureTime: Optional. Absolute time when the photo was captured. When the
	// photo has no exif timestamp, this is used to set a timestamp in the photo
	// metadata.
	CaptureTime string `json:"captureTime,omitempty"`
	// Connections: Optional. Connections to other photos. A connection represents
	// the link from this photo to another photo.
	Connections []*Connection `json:"connections,omitempty"`
	// DownloadUrl: Output only. The download URL for the photo bytes. This field
	// is set only when GetPhotoRequest.view is set to
	// PhotoView.INCLUDE_DOWNLOAD_URL.
	DownloadUrl string `json:"downloadUrl,omitempty"`
	// MapsPublishStatus: Output only. Status in Google Maps, whether this photo
	// was published or rejected.
	//
	// Possible values:
	...
	// PhotoId: Required. Output only. Required when updating a photo. Output only
	// when creating a photo. Identifier for the photo, which is unique among all
	// photos in Google.
	...
	// ThumbnailUrl: Output only. The thumbnail URL for showing a preview of the
	// given photo.
	...
	// UploadReference: Input only. Required when creating a photo. Input only. The
...
// including BatchGetPhotos and BatchUpdatePhotos.
type PhotoResponse struct {
	// Photo: The Photo resource, if the request was successful.
	Photo *Photo `json:"photo,omitempty"`
	// Status: The status for the operation to get or update a single photo in the
	// batch request.
	Status *Status `json:"status,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Photo") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type PhotoSequence struct {
	// CaptureTimeOverride: Optional. Absolute time when the photo sequence starts
	// to be captured. If the photo sequence is a video, this is the start time of
	// the video. If this field is populated in input, it overrides the capture
	// time in the video or XDM file.
	CaptureTimeOverride string `json:"captureTimeOverride,omitempty"`
	// DistanceMeters: Output only. The computed distance of the photo sequence in
	// meters.
	DistanceMeters float64 `json:"distanceMeters,omitempty"`
	// FailureDetails: Output only. If this sequence has `failure_reason` set, this
	// may contain additional details about the failure.
	FailureDetails *ProcessingFailureDetails `json:"failureDetails,omitempty"`
	// FailureReason: Output only. If this sequence has processing_state = FAILED,
	// this will contain the reason why it failed. If the processing_state is any
	// other value, this field will be unset.
	//
	// Possible values:
	...
	//   "NO_OVERLAP_GPS" - No overlap between the time frame of GPS track and the
	// time frame of video.
	...
	// They may be missing required fields (x, y, z or time), may not be formatted
	// correctly, or any other issue that prevents our systems from parsing it.
	...
	// Filename: Output only. The filename of the upload. Does not include the
	...
	// Id: Output only. Unique identifier for the photo sequence. This also acts as
	// a long running operation ID if uploading is performed asynchronously.
	Id string `json:"id,omitempty"`
	// Imu: Input only. Three axis IMU data for the collection. If this data is too
	...
	// RawGpsTimeline: Input only. Raw GPS measurements with increasing timestamps
	// from the device that aren't time synced with each photo. These raw
	// measurements will be used to infer the pose of each frame. Required in input
	// when InputType is VIDEO and raw GPS measurements are not in Camera Motion
	// Metadata Track (CAMM). User can indicate which takes precedence using
	// gps_source if raw GPS measurements are provided in both raw_gps_timeline and
	// Camera Motion Metadata Track (CAMM).
	RawGpsTimeline []*Pose `json:"rawGpsTimeline,omitempty"`
	// SequenceBounds: Output only. A rectangular box that encapsulates every image
	// in this photo sequence.
	SequenceBounds *LatLngBounds `json:"sequenceBounds,omitempty"`
	// UploadReference: Input only. Required when creating photo sequence. The
	// resource name where the bytes of the photo sequence (in the form of video)
	// are uploaded.
	UploadReference *UploadRef `json:"uploadReference,omitempty"`
	// UploadTime: Output only. The time this photo sequence was created in uSV
	// Store service.
	UploadTime string `json:"uploadTime,omitempty"`
	// ViewCount: Output only. The total number of views that all the published
	// images in this PhotoSequence have received.
	ViewCount int64 `json:"viewCount,omitempty,string"`
	// ForceSendFields is a list of field names (e.g. "CaptureTimeOverride") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CaptureTimeOverride") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Place struct {
	// LanguageCode: Output only. The language_code that the name is localized
	// with. This should be the language_code specified in the request, but may be
	// a fallback.
	LanguageCode string `json:"languageCode,omitempty"`
	// Name: Output only. The name of the place, localized to the language_code.
	Name string `json:"name,omitempty"`
...
type Pose struct {
	// AccuracyMeters: The estimated horizontal accuracy of this pose in meters
	// with 68% confidence (one standard deviation). For example, on Android, this
	// value is available from this method:
	...
	// Heading: The following pose parameters pertain to the center of the photo.
	// They match https://developers.google.com/streetview/spherical-metadata.
	// Compass heading, measured at the center of the photo in degrees clockwise
	// from North. Value must be >=0 and <360. NaN indicates an unmeasured
	// quantity.
	Heading float64 `json:"heading,omitempty"`
	// LatLngPair: Latitude and longitude pair of the pose, as explained here:
	...
	// Pitch: Pitch, measured at the center of the photo in degrees. Value must be
	// >=-90 and <= 90. A value of -90 means looking directly down, and a value of
	// 90 means looking directly up. NaN indicates an unmeasured quantity.
	Pitch float64 `json:"pitch,omitempty"`
	// Roll: Roll, measured in degrees. Value must be >= 0 and <360. A value of 0
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AccuracyMeters") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// ProcessingFailureReason enum. This message is always expected to be used in
// conjunction with ProcessingFailureReason, and the oneof value set in this
// message should match the FailureReason.
type ProcessingFailureDetails struct {
	...
	// ForceSendFields is a list of field names (e.g. "GpsDataGapDetails") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GpsDataGapDetails") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type UpdatePhotoRequest struct {
	...
	Photo *Photo `json:"photo,omitempty"`
	// UpdateMask: Required. Mask that identifies fields on the photo metadata to
	// update. If not present, the old Photo metadata is entirely replaced with the
	...
	// * `places` > Note: When updateMask contains repeated fields, the entire set
	// of repeated values get replaced with the new contents. For example, if
	// updateMask contains `connections` and `UpdatePhotoRequest.photo.connections`
...
type UploadRef struct {
	// UploadUrl: An upload reference should be unique for each user. It follows
	// the form:
	// "https://streetviewpublish.googleapis.com/media/user/{account_id}/photo/{uplo
	// ad_reference}"
...
// Create: After the client finishes uploading the photo with the returned
...
// is through the Photo Sphere XMP metadata
// (https://developers.google.com/streetview/spherical-metadata) in the photo
// bytes. CreatePhoto ignores the `pose.heading`, `pose.pitch`, `pose.roll`,
// `pose.altitude`, and `pose.level` fields in Pose. This method returns the
// following error codes: * google.rpc.Code.INVALID_ARGUMENT if the request is
...
// *Photo.ServerResponse.Header or (if a response was returned at all) in
...
// Delete: Deletes a Photo and its metadata. This method returns the following
...
// Get: Gets the metadata of the specified Photo. This method returns the
// following error codes: * google.rpc.Code.PERMISSION_DENIED if the requesting
// user did not create the requested Photo. * google.rpc.Code.NOT_FOUND if the
// requested Photo does not exist. * google.rpc.Code.UNAVAILABLE if the
...
// View sets the optional parameter "view": Required. Specifies if a download
// URL for the photo bytes should be returned in the Photo response.
//
// Possible values:
//
...
//
//	"INCLUDE_DOWNLOAD_URL" - Server responses include the download URL for the
//
// photo bytes.
...
// StartUpload: Creates an upload session to start uploading photo bytes. The
...
// Any non-2xx status code is an error. Response headers are in either
// *UploadRef.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// Update: Updates the metadata of a Photo, such as pose, place association,
...
// identifies fields on the photo metadata to update. If not present, the old
// Photo metadata is entirely replaced with the new Photo metadata in this
// request. The update fails if invalid fields are specified. Multiple fields
// can be specified in a comma-delimited list. The following fields are valid:
// * `pose.heading` * `pose.lat_lng_pair` * `pose.pitch` * `pose.roll` *
// `pose.level` * `pose.altitude` * `connections` * `places` > Note: When
...
// Create: After the client finishes uploading the PhotoSequence with the
// returned UploadRef, CreatePhotoSequence extracts a sequence of 360 photos
// from a video or Extensible Device Metadata (XDM, http://www.xdm.org/) to be
...
// InputType sets the optional parameter "inputType": Required. The input form
// of PhotoSequence.
//
// Possible values:
//
...
// Delete: Deletes a PhotoSequence and its metadata. This method returns the
// following error codes: * google.rpc.Code.PERMISSION_DENIED if the requesting
// user did not create the requested photo sequence. *
...
// Get: Gets the metadata of the specified PhotoSequence via the Operation
...
// example: `published_status=PUBLISHED`. The filters supported are:
...
// View sets the optional parameter "view": Specifies if a download URL for the
// photo sequence should be returned in `download_url` of individual photos in
// the PhotoSequence response. > Note: Currently not implemented.
//
// Possible values:
//
//	"BASIC" - Server responses do not include the download URL for the photo
...
// StartUpload: Creates an upload session to start uploading photo sequence
// data. The upload URL of the returned UploadRef is used to upload the data
// for the `photoSequence`. After the upload is complete, the UploadRef is used
...
// List: Lists all the PhotoSequences that belong to the user, in descending
...
// Filter sets the optional parameter "filter": The filter expression. For
// example: `imagery_type=SPHERICAL`. The filters supported are:
...
// PageSize sets the optional parameter "pageSize": The maximum number of photo
// sequences to return. `pageSize` must be non-negative. If `pageSize` is zero
// or is not provided, the default page size of 100 is used. The number of
// photo sequences returned in the response may be less than `pageSize` if the
// number of matches is less than `pageSize`. This is currently unimplemented
// but is in process.
...
// returned from a previous ListPhotoSequences request, if any.
...
// Any non-2xx status code is an error. Response headers are in either
// *ListPhotoSequencesResponse.ServerResponse.Header or (if a response was
...
// BatchDelete: Deletes a list of Photos and their metadata. Note that if
...
// Any non-2xx status code is an error. Response headers are in either
// *BatchDeletePhotosResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// BatchGet: Gets the metadata of the specified Photo batch. Note that if
...
// Any non-2xx status code is an error. Response headers are in either
// *BatchGetPhotosResponse.ServerResponse.Header or (if a response was returned
...
// supported. Note that if BatchUpdatePhotos fails, either critical fields are
// missing or there is an authentication error. Even if BatchUpdatePhotos
// succeeds, individual photos in the batch may have failures. These failures
// are specified in each PhotoResponse.status in
...
// Any non-2xx status code is an error. Response headers are in either
// *BatchUpdatePhotosResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// List: Lists all the Photos that belong to the user. > Note: Recently created
...
// Filter sets the optional parameter "filter": The filter expression. For
// example: `placeId=ChIJj61dQgK6j4AR4GeTYWZsKWw`. The filters supported are:
// `placeId`, `min_latitude`, `max_latitude`, `min_longitude`, `max_longitude`.
...
// photos to return. `pageSize` must be non-negative. If `pageSize` is zero or
// is not provided, the default page size of 100 is used. The number of photos
// returned in the response may be less than `pageSize` if the number of photos
// that belong to the user is less than `pageSize`.
...
// PageToken sets the optional parameter "pageToken": The nextPageToken value
// returned from a previous ListPhotos request, if any.
...
// View sets the optional parameter "view": Required. Specifies if a download
// URL for the photos bytes should be returned in the Photos response.
//
// Possible values:
//
//	"BASIC" - Server responses do not include the download URL for the photo
...
// Any non-2xx status code is an error. Response headers are in either
// *ListPhotosResponse.ServerResponse.Header or (if a response was returned at
