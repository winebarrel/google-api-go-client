...
type DestinationConfig struct {
	...
	// "DestinationConnectionProfileName") to include in API requests with the JSON
...
type DiscoverConnectionProfileRequest struct {
	...
	// RecursionDepth: The number of hierarchy levels below the current level to be
	// retrieved.
	RecursionDepth int64 `json:"recursionDepth,omitempty"`
	// Recursive: Whether to retrieve the full hierarchy of data objects (TRUE) or
...
type GcsDestinationConfig struct {
	...
	// GcsFileFormat: File format that data should be written in. Deprecated field
...
type MysqlDatabase struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DatabaseName") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type PrivateConnectivity struct {
	...
	// ForceSendFields is a list of field names (e.g. "PrivateConnectionName") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
// Route: The Route resource is the child of the PrivateConnection resource. It
...
type SourceConfig struct {
	...
	// SourceConnectionProfileName: Required. Source connection profile identifier.
...
type VpcPeeringConfig struct {
	...
	// VpcName: Required. fully qualified name of the VPC Datastream will peer to.
...
//
//   - parent: The parent resource of the ConnectionProfile type. Must be in the
...
// connection profile, but do not update any resources. The default is false.
...
// Create: Use this method to create a route for a private connectivity in a
// project and location.
//
...
// List: Use this method to list routes created for a private connectivity in a
// project and location.
//
...
// ValidateOnly sets the optional parameter "validateOnly": Only validate the
// stream, but do not create any resources. The default is false.
...
func (c *ProjectsLocationsStreamsFetchErrorsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.fetcherrorsrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datastream.projects.locations.streams.fetchErrors", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsStreamsFetchErrorsCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "datastream.projects.locations.streams.fetchErrors", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsStreamsObjectsStartBackfillJobCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datastream.projects.locations.streams.objects.startBackfillJob", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsStreamsObjectsStopBackfillJobCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datastream.projects.locations.streams.objects.stopBackfillJob", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
