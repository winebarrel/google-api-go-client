...
// GoogleIamV2betaPolicyOperationMetadata: Metadata for long-running `Policy`
// operations.
...
func (c *PoliciesCreatePolicyCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleiamv2betapolicy)
	if err != nil {
		return nil, err
	}
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleIamV2betaPolicy.ServerResponse.Header or (if a response was returned
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleIamV2betaListPoliciesResponse.ServerResponse.Header or (if a response
