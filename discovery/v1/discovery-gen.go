...
// to determine how to interpret the entire entity. Its value must exist in a
...
// *RestDescription.ServerResponse.Header or (if a response was returned at
...
// Name sets the optional parameter "name": Only include APIs with the given
// name.
...
// Preferred sets the optional parameter "preferred": Return only the preferred
// version of an API.
...
// Any non-2xx status code is an error. Response headers are in either
// *DirectoryList.ServerResponse.Header or (if a response was returned at all)
