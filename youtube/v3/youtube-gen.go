...
func NewService(ctx context.Context, opts ...option.ClientOption) (*Service, error) {
	...
	s.VideoTrainability = NewVideoTrainabilityService(s)
...
type Service struct {
	...
	VideoTrainability *VideoTrainabilityService
...
func NewVideoTrainabilityService(s *Service) *VideoTrainabilityService {
	rs := &VideoTrainabilityService{s: s}
	return rs
}

type VideoTrainabilityService struct {
	s *Service
}
...
type AbuseReport struct {
	...
	// NullFields is a list of field names (e.g. "AbuseTypes") to include in API
...
type AccessPolicy struct {
	// Allowed: The value of allowed indicates whether the access to the policy is
	// allowed or denied by default.
	Allowed bool `json:"allowed,omitempty"`
	// Exception: A list of region codes that identify countries where the default
	// policy do not apply.
...
type ActivityContentDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Bulletin") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ActivityContentDetailsPlaylistItem struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PlaylistId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ActivityContentDetailsPromotedItem struct {
	...
	// ClickTrackingUrl: The URL the client should ping to indicate that the user
	// clicked through on this promoted item.
	ClickTrackingUrl string `json:"clickTrackingUrl,omitempty"`
	// CreativeViewUrl: The URL the client should ping to indicate that the user
	// was shown this promoted item.
	CreativeViewUrl string `json:"creativeViewUrl,omitempty"`
	// CtaType: The type of call-to-action, a message to the user indicating action
	// that can be taken.
	//
	// Possible values:
	//   "ctaTypeUnspecified"
	...
	// CustomCtaButtonText: The custom call-to-action button text. If specified, it
	...
	// DestinationUrl: The URL the client should direct the user to, if the user
	// chooses to visit the advertiser's website.
	DestinationUrl string `json:"destinationUrl,omitempty"`
	// ForecastingUrl: The list of forecasting URLs. The client should ping all of
	// these URLs when a promoted item is not available, to indicate that a
	// promoted item could have been shown.
	ForecastingUrl []string `json:"forecastingUrl,omitempty"`
	// ImpressionUrl: The list of impression URLs. The client should ping all of
	// these URLs to indicate that the user was shown this promoted item.
	...
	// ForceSendFields is a list of field names (e.g. "AdTag") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type ActivityContentDetailsUpload struct {
	...
	VideoId string `json:"videoId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "VideoId") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "VideoId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ActivityListResponse struct {
	...
	// PrevPageToken: The token that can be used as the value of the pageToken
...
type ActivitySnippet struct {
	...
	// Description: The description of the resource primarily associated with the
	...
	// Thumbnails: A map of thumbnail images associated with the resource that is
	// primarily associated with the activity. For each object in the map, the key
	// is the name of the thumbnail image, and the value is an object that contains
...
type CaptionSnippet struct {
	...
	// FailureReason: The reason that YouTube failed to process the caption track.
	...
	// IsAutoSynced: Indicates whether YouTube synchronized the caption track to
	// the audio track in the video. The value will be true if a sync was
	// explicitly requested when the caption track was uploaded. For example, when
	// calling the captions.insert or captions.update methods, you can set the sync
	...
	// IsCC: Indicates whether the track contains closed captions for the deaf and
	// hard of hearing. The default value is false.
	IsCC bool `json:"isCC,omitempty"`
	// IsDraft: Indicates whether the caption track is a draft. If the value is
	// true, then the track is not publicly visible. The default value is false.
	...
	// reader," meaning it is at a third-grade level for language learners. The
	...
	// Language: The language of the caption track. The property value is a BCP-47
	// language tag.
	Language string `json:"language,omitempty"`
	// LastUpdated: The date and time when the caption track was last updated.
	LastUpdated string `json:"lastUpdated,omitempty"`
	// Name: The name of the caption track. The name is intended to be visible to
	...
	// VideoId: The ID that YouTube uses to uniquely identify the video associated
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AudioTrackType") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CdnSettings struct {
	...
	// IngestionInfo: The ingestionInfo object contains information that YouTube
...
type Channel struct {
	// AuditDetails: The auditionDetails object encapsulates channel data that is
	// relevant for YouTube Partners during the audition process.
	AuditDetails *ChannelAuditDetails `json:"auditDetails,omitempty"`
	// BrandingSettings: The brandingSettings object encapsulates information about
	// the branding of the channel.
	BrandingSettings *ChannelBrandingSettings `json:"brandingSettings,omitempty"`
	// ContentDetails: The contentDetails object encapsulates information about the
	// channel's content.
	ContentDetails *ChannelContentDetails `json:"contentDetails,omitempty"`
	// ContentOwnerDetails: The contentOwnerDetails object encapsulates channel
	...
	// ConversionPings: The conversionPings object encapsulates information about
	...
	// Snippet: The snippet object contains basic details about the channel, such
	// as its title, description, and thumbnail images.
	...
	// Status: The status object encapsulates information about the privacy status
	// of the channel.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AuditDetails") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// is relevant for YouTube Partners during the audit process.
type ChannelAuditDetails struct {
	// CommunityGuidelinesGoodStanding: Whether or not the channel respects the
	// community guidelines.
	CommunityGuidelinesGoodStanding bool `json:"communityGuidelinesGoodStanding,omitempty"`
	// ContentIdClaimsGoodStanding: Whether or not the channel has any unresolved
	// claims.
	ContentIdClaimsGoodStanding bool `json:"contentIdClaimsGoodStanding,omitempty"`
	// CopyrightStrikesGoodStanding: Whether or not the channel has any copyright
	// strikes.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CommunityGuidelinesGoodStanding")
...
type ChannelContentDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "RelatedPlaylists") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ChannelContentDetailsRelatedPlaylists struct {
	// Favorites: The ID of the playlist that contains the channel"s favorite
	// videos. Use the playlistItems.insert and playlistItems.delete to add or
	// remove items from that list.
	Favorites string `json:"favorites,omitempty"`
	// Likes: The ID of the playlist that contains the channel"s liked videos. Use
	// the playlistItems.insert and playlistItems.delete to add or remove items
	// from that list.
	Likes string `json:"likes,omitempty"`
	// Uploads: The ID of the playlist that contains the channel"s uploaded videos.
	...
	// WatchHistory: The ID of the playlist that contains the channel"s watch
	// history. Use the playlistItems.insert and playlistItems.delete to add or
	// remove items from that list.
	WatchHistory string `json:"watchHistory,omitempty"`
	// WatchLater: The ID of the playlist that contains the channel"s watch later
	// playlist. Use the playlistItems.insert and playlistItems.delete to add or
	// remove items from that list.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Favorites") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ChannelContentOwnerDetails struct {
	...
	// TimeLinked: The date and time when the channel was linked to the content
	// owner.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ContentOwner") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// biscotti cookie). Each ping has a context, in which the app must fire the
...
type ChannelConversionPing struct {
	...
	// ConversionUrl: The url (without the schema) that the player shall send the
	// ping to. It's at caller's descretion to decide which schema to use (http vs
...
type ChannelConversionPings struct {
	// Pings: Pings that the app shall fire (authenticated by biscotti cookie).
	...
	// ForceSendFields is a list of field names (e.g. "Pings") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type ChannelSection struct {
	// ContentDetails: The contentDetails object contains details about the channel
	...
	// Targeting: The targeting object contains basic targeting settings about the
	// channel section.
...
type ChannelSectionContentDetails struct {
	...
	// Playlists: The playlist ids for type single_playlist and multiple_playlists.
...
type ChannelSectionSnippet struct {
	// ChannelId: The ID that YouTube uses to uniquely identify the channel that
	// published the channel section.
	ChannelId string `json:"channelId,omitempty"`
	// DefaultLanguage: The language of the channel section's default title and
	// description.
...
type ChannelSettings struct {
	...
	// ModerateComments: Whether user-submitted comments left on the channel page
	...
	Title string `json:"title,omitempty"`
	// TrackingAnalyticsAccountId: The ID for a Google Analytics account to track
	// and measure traffic to the channels.
	TrackingAnalyticsAccountId string `json:"trackingAnalyticsAccountId,omitempty"`
	// UnsubscribedTrailer: The trailer of the channel, for users that are not
	// subscribers.
...
type ChannelSnippet struct {
	...
	PublishedAt string `json:"publishedAt,omitempty"`
	// Thumbnails: A map of thumbnail images associated with the channel. For each
	// object in the map, the key is the name of the thumbnail image, and the value
	// is an object that contains other information about the thumbnail. When
	// displaying thumbnails in your application, make sure that your code uses the
	// image URLs exactly as they are returned in API responses. For example, your
	...
	// Thumbnail images might be empty for newly created channels and might take up
	// to one day to populate.
	Thumbnails *ThumbnailDetails `json:"thumbnails,omitempty"`
...
type ChannelStatistics struct {
	...
	// HiddenSubscriberCount: Whether or not the number of subscribers is shown for
	// this user.
...
type ChannelToStoreLinkDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BillingDetails") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ChannelToStoreLinkDetailsBillingDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BillingStatus") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ChannelTopicDetails struct {
	...
	// TopicIds: A list of Freebase topic IDs associated with the channel. You can
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TopicCategories") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CommentSnippet struct {
	...
	// AuthorProfileImageUrl: The URL for the avatar of the user who posted the
	// comment.
	...
	// dependent on what has been requested. Even the plain text representation may
	// differ from the text originally posted in that it may replace video links
	// with video titles etc.
	TextDisplay string `json:"textDisplay,omitempty"`
	// TextOriginal: The comment's original raw text as initially posted or last
	// updated. The original text will only be returned if it is accessible to the
	...
	VideoId string `json:"videoId,omitempty"`
	// ViewerRating: The rating the viewer has given to this comment. For the time
	// being this will never return RATE_TYPE_DISLIKE and instead return
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AuthorChannelId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// top level comment and all its replies. It can also include the top level
// comment itself and some of the replies.
type CommentThread struct {
	...
	Kind string `json:"kind,omitempty"`
	// Replies: The replies object contains a limited number of replies (if any) to
	// the top level comment found in the snippet.
	Replies *CommentThreadReplies `json:"replies,omitempty"`
	// Snippet: The snippet object contains basic details about the comment thread
...
type CommentThreadReplies struct {
	// Comments: A limited number of replies. Unless the number of replies returned
...
type CommentThreadSnippet struct {
	// CanReply: Whether the current viewer of the thread can reply to it. This is
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CanReply") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// movies and shows. LINT.IfChange
type ContentRating struct {
	// AcbRating: The video's Australian Classification Board (ACB) or Australian
	...
	// AgcomRating: The video's rating from Italy's Autorità per le Garanzie nelle
	// Comunicazioni (AGCOM).
	//
	// Possible values:
	//   "agcomUnspecified"
	...
	// AnatelRating: The video's Anatel (Asociación Nacional de Televisión)
	...
	// BfvcRating: The video's rating from Thailand's Board of Film and Video
	// Censors.
	//
	// Possible values:
	//   "bfvcUnspecified"
	...
	// CatvRating: Rating system for Canadian TV - Canadian TV Classification
	// System The video's rating from the Canadian Radio-Television and
	...
	// CatvfrRating: The video's rating from the Canadian Radio-Television and
	...
	// CbfcRating: The video's Central Board of Film Certification (CBFC - India)
	// rating.
	//
	// Possible values:
	//   "cbfcUnspecified"
	...
	// CccRating: The video's Consejo de Calificación Cinematográfica (Chile)
	// rating.
	//
	// Possible values:
	//   "cccUnspecified"
	...
	// CceRating: The video's rating from Portugal's Comissão de Classificação
	// de Espect´culos.
	//
	// Possible values:
	//   "cceUnspecified"
	...
	// CicfRating: The video's rating from the Commission de Contrôle des Films
	// (Belgium).
	//
	// Possible values:
	//   "cicfUnspecified"
	...
	// CscfRating: The video's rating from Luxembourg's Commission de surveillance
	...
	// DjctqRatingReasons: Reasons that explain why the video received its DJCQT
	// (Brazil) rating.
	//
	// Possible values:
	...
	// EirinRating: The video's Eirin (映倫) rating. Eirin is the Japanese rating
	// system.
	//
	// Possible values:
	//   "eirinUnspecified"
	...
	// FcoRating: The video's rating from Hong Kong's Office for Film, Newspaper
	...
	// FpbRating: The video's rating from South Africa's Film and Publication
	// Board.
	//
	// Possible values:
	//   "fpbUnspecified"
	...
	// FpbRatingReasons: Reasons that explain why the video received its FPB (South
	// Africa) rating.
	//
	// Possible values:
	...
	// FskRating: The video's Freiwillige Selbstkontrolle der Filmwirtschaft (FSK -
	// Germany) rating.
	//
	// Possible values:
	//   "fskUnspecified"
	...
	// IcaaRating: The video's Instituto de la Cinematografía y de las Artes
	...
	// IfcoRating: The video's Irish Film Classification Office (IFCO - Ireland)
	...
	// KijkwijzerRating: The video's NICAM/Kijkwijzer rating from the Nederlands
	// Instituut voor de Classificatie van Audiovisuele Media (Netherlands).
	//
	// Possible values:
	...
	// KmrbRating: The video's Korea Media Rating Board (영상물등급위원회)
	...
	// MccypRating: The video's rating from the Danish Film Institute's (Det Danske
	...
	// MdaRating: The video's rating from Singapore's Media Development Authority
	...
	// MedietilsynetRating: The video's rating from Medietilsynet, the Norwegian
	// Media Authority.
	//
	// Possible values:
	...
	// MekuRating: The video's rating from Finland's Kansallinen Audiovisuaalinen
	...
	// MenaMpaaRating: The rating system for MENA countries, a clone of MPAA. It is
	// needed to prevent titles go live w/o additional QC check, since some of them
	// can be inappropriate for the countries at all. See b/33408548 for more
	// details.
	//
	// Possible values:
	//   "menaMpaaUnspecified"
	...
	// MpaatRating: The rating system for trailer, DVD, and Ad in the US. See
	...
	// MtrcbRating: The video's rating from the Movie and Television Review and
	...
	// NfvcbRating: The video's rating from Nigeria's National Film and Video
	// Censors Board.
	//
	// Possible values:
	//   "nfvcbUnspecified"
	...
	// NkclvRating: The video's rating from the Nacionãlais Kino centrs (National
	...
	// OflcRating: The video's Office of Film and Literature Classification (OFLC -
	// New Zealand) rating.
	//
	// Possible values:
	//   "oflcUnspecified"
	...
	// RcnofRating: The video's rating from the Hungarian Nemzeti Filmiroda, the
	// Rating Committee of the National Office of Film.
	//
	// Possible values:
	//   "rcnofUnspecified"
	//   "rcnofI"
	...
	// RussiaRating: The video's National Film Registry of the Russian Federation
	// (MKRF - Russia) rating.
	//
	// Possible values:
	//   "russiaUnspecified"
	...
	// SmsaRating: The video's rating from Statens medieråd (Sweden's National
	// Media Council).
	//
	// Possible values:
	//   "smsaUnspecified"
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AcbRating") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Cuepoint struct {
	...
	Id string `json:"id,omitempty"`
	// InsertionOffsetTimeMs: The time when the cuepoint should be inserted by
	// offset to the broadcast actual start time.
	InsertionOffsetTimeMs int64 `json:"insertionOffsetTimeMs,omitempty,string"`
	// WalltimeMs: The wall clock time at which the cuepoint should be inserted.
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "CueType") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CueType") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CuepointSchedule struct {
	// Enabled: This field is semantically required. If it is set false or not set,
	// other fields in this message will be ignored.
	Enabled bool `json:"enabled,omitempty"`
	// PauseAdsUntil: If set, automatic cuepoint insertion is paused until this
	// timestamp ("No Ad Zone"). The value is specified in ISO 8601 format.
	PauseAdsUntil string `json:"pauseAdsUntil,omitempty"`
	// RepeatIntervalSecs: Interval frequency in seconds that api uses to insert
...
// I18nLanguage: An *i18nLanguage* resource identifies a UI language currently
...
type I18nLanguage struct {
	...
	Kind string `json:"kind,omitempty"`
	// Snippet: The snippet object contains basic details about the i18n language,
...
type I18nLanguageListResponse struct {
	...
	// EventId: Serialized EventId of the request which produced this response.
	EventId string `json:"eventId,omitempty"`
	// Items: A list of supported i18n languages. In this map, the i18n language ID
	// is the map key, and its value is the corresponding i18nLanguage resource.
...
type I18nLanguageSnippet struct {
	...
	Name string `json:"name,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Hl") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Hl") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type I18nRegion struct {
	...
	// "youtube#i18nRegion".
	Kind string `json:"kind,omitempty"`
	// Snippet: The snippet object contains basic details about the i18n region,
...
type I18nRegionListResponse struct {
	...
	// EventId: Serialized EventId of the request which produced this response.
	EventId string `json:"eventId,omitempty"`
	// Items: A list of regions where YouTube is available. In this map, the i18n
...
type I18nRegionSnippet struct {
	...
	Name string `json:"name,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Gl") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Gl") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ImageSettings struct {
	// BackgroundImageUrl: The URL for the background image shown on the video
	// watch page. The image should be 1200px by 615px, with a maximum file size of
	// 128k.
	BackgroundImageUrl *LocalizedProperty `json:"backgroundImageUrl,omitempty"`
	// BannerExternalUrl: This is generated when a ChannelBanner.Insert request has
	// succeeded for the given channel.
	...
	// BannerMobileExtraHdImageUrl: Banner image. Mobile size high resolution
	// (1440x395).
	...
	// BannerTabletExtraHdImageUrl: Banner image. Tablet size extra high resolution
	// (2560x424).
	...
	// LargeBrandedBannerImageImapScript: The image map script for the large banner
	// image.
	LargeBrandedBannerImageImapScript *LocalizedProperty `json:"largeBrandedBannerImageImapScript,omitempty"`
	// LargeBrandedBannerImageUrl: The URL for the 854px by 70px image that appears
	// below the video player in the expanded video view of the video watch page.
	LargeBrandedBannerImageUrl *LocalizedProperty `json:"largeBrandedBannerImageUrl,omitempty"`
	// SmallBrandedBannerImageImapScript: The image map script for the small banner
	// image.
	SmallBrandedBannerImageImapScript *LocalizedProperty `json:"smallBrandedBannerImageImapScript,omitempty"`
	// SmallBrandedBannerImageUrl: The URL for the 640px by 70px banner image that
	// appears below the video player in the default view of the video watch page.
	...
	// TrackingImageUrl: The URL for a 1px by 1px tracking pixel that can be used
	...
	// ForceSendFields is a list of field names (e.g. "BackgroundImageUrl") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BackgroundImageUrl") to include
...
type IngestionInfo struct {
	// BackupIngestionAddress: The backup ingestion URL that you should use to
	// stream video to YouTube. You have the option of simultaneously streaming the
	...
	// IngestionAddress: The primary ingestion URL that you should use to stream
	// video to YouTube. You must stream video to this URL. Depending on which
	...
	// RtmpsBackupIngestionAddress: This ingestion url may be used instead of
	// backupIngestionAddress in order to stream via RTMPS. Not applicable to
	// non-RTMP streams.
	...
	// ingestionAddress in order to stream via RTMPS. Not applicable to non-RTMP
	// streams.
	...
	// ForceSendFields is a list of field names (e.g. "BackupIngestionAddress") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BackupIngestionAddress") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type InvideoBranding struct {
	...
	// communication.
	ImageUrl string `json:"imageUrl,omitempty"`
	// Position: The spatial position within the video where the branding watermark
	// will be displayed.
	Position *InvideoPosition `json:"position,omitempty"`
	// TargetChannelId: The channel to which this branding links. If not present it
	// defaults to the current channel.
	TargetChannelId string `json:"targetChannelId,omitempty"`
	// Timing: The temporal position within the video where watermark will be
	// displayed.
...
// video. It is a union of various position types, out of which only will be
// set one.
type InvideoPosition struct {
	// CornerPosition: Describes in which corner of the video the visual widget
	// will appear.
	//
	// Possible values:
	//   "topLeft"
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CornerPosition") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type InvideoTiming struct {
	// DurationMs: Defines the duration in milliseconds for which the promotion
	// should be displayed. If missing, the client should use the default.
	DurationMs uint64 `json:"durationMs,omitempty,string"`
	// OffsetMs: Defines the time at which the promotion will appear. Depending on
	// the value of type the value of the offsetMs field will represent a time
	// offset from the start or from the end of the video, expressed in
	// milliseconds.
	OffsetMs uint64 `json:"offsetMs,omitempty,string"`
	// Type: Describes a timing type. If the value is offsetFromStart, then the
...
type LiveBroadcast struct {
	...
	// embedded video player or if it will be archived and therefore available for
	...
	Kind string `json:"kind,omitempty"`
	// MonetizationDetails: The monetizationDetails object contains information
	// about the event's monetization details.
	...
	// Statistics: The statistics object contains info about the event's current
	// stats. These include concurrent viewers and total chat count. Statistics can
	// change (in either direction) during the lifetime of an event. Statistics are
	// only returned while the event is live.
...
type LiveBroadcastContentDetails struct {
	...
	// EnableAutoStart: This setting indicates whether auto start is enabled for
	// this broadcast. The default value for this property is false. This setting
	// can only be used by Events.
	EnableAutoStart bool `json:"enableAutoStart,omitempty"`
	// EnableAutoStop: This setting indicates whether auto stop is enabled for this
	// broadcast. The default value for this property is false. This setting can
	// only be used by Events.
	EnableAutoStop bool `json:"enableAutoStop,omitempty"`
	// EnableClosedCaptions: This setting indicates whether HTTP POST closed
	// captioning is enabled for this broadcast. The ingestion URL of the closed
	// captions is returned through the liveStreams API. This is mutually exclusive
	// with using the closed_captions_type property, and is equivalent to setting
	// closed_captions_type to CLOSED_CAPTIONS_HTTP_POST.
	EnableClosedCaptions bool `json:"enableClosedCaptions,omitempty"`
	// EnableContentEncryption: This setting indicates whether YouTube should
	// enable content encryption for the broadcast.
	EnableContentEncryption bool `json:"enableContentEncryption,omitempty"`
	// EnableDvr: This setting determines whether viewers can access DVR controls
	// while watching the video. DVR controls enable the viewer to control the
	// video playback experience by pausing, rewinding, or fast forwarding content.
	// The default value for this property is true. *Important:* You must set the
	// value to true and also set the enableArchive property's value to true if you
	// want to make playback available immediately after the broadcast ends.
	EnableDvr bool `json:"enableDvr,omitempty"`
	// EnableEmbed: This setting indicates whether the broadcast video can be
	// played in an embedded player. If you choose to archive the video (using the
	// enableArchive property), this setting will also apply to the archived video.
	...
	// LatencyPreference: If both this and enable_low_latency are set, they must
	// match. LATENCY_NORMAL should match enable_low_latency=false LATENCY_LOW
	...
	// Mesh: The mesh for projecting the video if projection is mesh. The mesh
	// value must be a UTF-8 string containing the base-64 encoding of 3D mesh data
	...
	// MonitorStream: The monitorStream object contains information about the
	// monitor stream, which the broadcaster can use to review the event content
	...
	// RecordFromStart: Automatically start recording after the event goes live.
	// The default value for this property is true. *Important:* You must also set
	// the enableDvr property's value to true if you want the playback to be
	// available immediately after the broadcast ends. If you set this property's
	// value to true but do not also set the enableDvr property to true, there may
	// be a delay of around one day before the archived video will be available for
	// playback.
	RecordFromStart bool `json:"recordFromStart,omitempty"`
	// StartWithSlate: This setting indicates whether the broadcast should
	// automatically begin with an in-stream slate when you update the broadcast's
	// status to live. After updating the status, you then need to send a
	// liveCuepoints.insert request that sets the cuepoint's eventState to end to
	// remove the in-stream slate and make your broadcast stream visible to
	// viewers.
...
type LiveBroadcastMonetizationDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CuepointSchedule") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveBroadcastSnippet struct {
	// ActualEndTime: The date and time that the broadcast actually ended. This
	...
	ChannelId string `json:"channelId,omitempty"`
	// Description: The broadcast's description. As with the title, you can set
	// this field by modifying the broadcast resource or by setting the description
	...
	// PublishedAt: The date and time that the broadcast was added to YouTube's
	...
	// ScheduledStartTime: The date and time that the broadcast is scheduled to
	// start.
	ScheduledStartTime string `json:"scheduledStartTime,omitempty"`
	// Thumbnails: A map of thumbnail images associated with the broadcast. For
	// each nested object in this object, the key is the name of the thumbnail
	// image, and the value is an object that contains other information about the
	// thumbnail.
	Thumbnails *ThumbnailDetails `json:"thumbnails,omitempty"`
	// Title: The broadcast's title. Note that the broadcast represents exactly one
...
// represent a snapshot of the values at the time of the request. Statistics
// are only returned for live broadcasts.
type LiveBroadcastStatistics struct {
	...
	// viewers and the broadcast owner has not hidden the viewcount for the video.
	// Note that YouTube stops tracking the number of concurrent viewers for a
	// broadcast when the broadcast ends. So, this property would not identify the
	// number of viewers watching an archived video of a live broadcast that
	// already ended.
	ConcurrentViewers uint64 `json:"concurrentViewers,omitempty,string"`
	// ForceSendFields is a list of field names (e.g. "ConcurrentViewers") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConcurrentViewers") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveBroadcastStatus struct {
	// LifeCycleStatus: The broadcast's status. The status can be updated using the
	...
	// MadeForKids: Whether the broadcast is made for kids or not, decided by
	// YouTube instead of the creator. This field is read only.
	MadeForKids bool `json:"madeForKids,omitempty"`
	// PrivacyStatus: The broadcast's privacy status. Note that the broadcast
	// represents exactly one YouTube video, so the privacy settings are identical
	// to those supported for videos. In addition, you can set this field by
	// modifying the broadcast resource or by setting the privacyStatus field of
	...
	// SelfDeclaredMadeForKids: This field will be set to True if the creator
	// declares the broadcast to be kids only: go/live-cw-work.
	SelfDeclaredMadeForKids bool `json:"selfDeclaredMadeForKids,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LifeCycleStatus") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatBanSnippet struct {
	// BanDurationSeconds: The duration of a ban, only filled if the ban has type
	// TEMPORARY.
	...
	Type string `json:"type,omitempty"`
	// ForceSendFields is a list of field names (e.g. "BanDurationSeconds") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BanDurationSeconds") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatFanFundingEventDetails struct {
	// AmountDisplayString: A rendered string that displays the fund amount and
	...
	// ForceSendFields is a list of field names (e.g. "AmountDisplayString") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AmountDisplayString") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatGiftMembershipReceivedDetails struct {
	...
	// purchase. This matches the `snippet.authorChannelId` of the associated
	// membership gifting message.
	GifterChannelId string `json:"gifterChannelId,omitempty"`
	// MemberLevelName: The name of the Level at which the viewer is a member. This
	// matches the `snippet.membershipGiftingDetails.giftMembershipsLevelName` of
	// the associated membership gifting message. The Level names are defined by
	// the YouTube channel offering the Membership. In some situations this field
	// isn't filled.
	MemberLevelName string `json:"memberLevelName,omitempty"`
	// ForceSendFields is a list of field names (e.g.
	// "AssociatedMembershipGiftingMessageId") to unconditionally include in API
	// requests. By default, fields with empty or default values are omitted from
	// API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	...
	// "AssociatedMembershipGiftingMessageId") to include in API requests with the
...
type LiveChatMemberMilestoneChatDetails struct {
	// MemberLevelName: The name of the Level at which the viever is a member. The
	// Level names are defined by the YouTube channel offering the Membership. In
	// some situations this field isn't filled.
	MemberLevelName string `json:"memberLevelName,omitempty"`
	// MemberMonth: The total amount of months (rounded up) the viewer has been a
	// member that granted them this Member Milestone Chat. This is the same number
	// of months as is being displayed to YouTube users.
	MemberMonth int64 `json:"memberMonth,omitempty"`
	// UserComment: The comment added by the member to this Member Milestone Chat.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MemberLevelName") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatMembershipGiftingDetails struct {
	...
	// GiftMembershipsLevelName: The name of the level of the gift memberships
	// purchased by the user. The Level names are defined by the YouTube channel
	...
	// ForceSendFields is a list of field names (e.g. "GiftMembershipsCount") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GiftMembershipsCount") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatMessage struct {
	// AuthorDetails: The authorDetails object contains basic details about the
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AuthorDetails") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatMessageDeletedDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DeletedMessageId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatMessageListResponse struct {
	...
	// PageInfo: General pagination information.
	PageInfo *PageInfo `json:"pageInfo,omitempty"`
	// PollingIntervalMillis: The amount of time the client should wait before
	// polling again.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ActivePollItem") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatMessageRetractedDetails struct {
	...
	// ForceSendFields is a list of field names (e.g. "RetractedMessageId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "RetractedMessageId") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatMessageSnippet struct {
	...
	// fanFundingEvent - the user that funded the broadcast newSponsorEvent - the
	...
	// DisplayMessage: Contains a string that can be displayed to the user. If this
	// field is not present the message is silent, at the moment only messages of
	...
	// HasDisplayContent: Whether the message has display content that should be
	// displayed to users.
	HasDisplayContent bool   `json:"hasDisplayContent,omitempty"`
	LiveChatId        string `json:"liveChatId,omitempty"`
	// MemberMilestoneChatDetails: Details about the Member Milestone Chat event,
	// this is only set if the type is 'memberMilestoneChatEvent'.
	MemberMilestoneChatDetails *LiveChatMemberMilestoneChatDetails `json:"memberMilestoneChatDetails,omitempty"`
	// MembershipGiftingDetails: Details about the Membership Gifting event, this
	// is only set if the type is 'membershipGiftingEvent'.
	...
	// NewSponsorDetails: Details about the New Member Announcement event, this is
	// only set if the type is 'newSponsorEvent'. Please note that "member" is the
	// new term for "sponsor".
	NewSponsorDetails *LiveChatNewSponsorDetails `json:"newSponsorDetails,omitempty"`
	// PollDetails: Details about the poll event, this is only set if the type is
	// 'pollEvent'.
	...
	PublishedAt string `json:"publishedAt,omitempty"`
	// SuperChatDetails: Details about the Super Chat event, this is only set if
	// the type is 'superChatEvent'.
	SuperChatDetails *LiveChatSuperChatDetails `json:"superChatDetails,omitempty"`
	// SuperStickerDetails: Details about the Super Sticker event, this is only set
	// if the type is 'superStickerEvent'.
	SuperStickerDetails *LiveChatSuperStickerDetails `json:"superStickerDetails,omitempty"`
	// TextMessageDetails: Details about the text message, this is only set if the
	// type is 'textMessageEvent'.
	TextMessageDetails *LiveChatTextMessageDetails `json:"textMessageDetails,omitempty"`
	// Type: The type of message, this will always be present, it determines the
...
// a YouTube live chat. A chat moderator has the ability to ban/unban users
// from a chat, remove message, etc.
...
type LiveChatModeratorSnippet struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LiveChatId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatNewSponsorDetails struct {
	// IsUpgrade: If the viewer just had upgraded from a lower level. For viewers
	// that were not members at the time of purchase, this field is false.
	IsUpgrade bool `json:"isUpgrade,omitempty"`
	// MemberLevelName: The name of the Level that the viewer just had joined. The
	// Level names are defined by the YouTube channel offering the Membership. In
	// some situations this field isn't filled.
	MemberLevelName string `json:"memberLevelName,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IsUpgrade") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatPollDetailsPollMetadataPollOption struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "OptionText") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveChatSuperChatDetails struct {
	...
	// currency to the user.
	AmountDisplayString string `json:"amountDisplayString,omitempty"`
	// AmountMicros: The amount purchased by the user, in micros (1,750,000 micros
	// = 1.75).
	AmountMicros uint64 `json:"amountMicros,omitempty,string"`
	// Currency: The currency in which the purchase was made.
	Currency string `json:"currency,omitempty"`
	// Tier: The tier in which the amount belongs. Lower amounts belong to lower
...
type LiveChatUserBannedMessageDetails struct {
	// BanDurationSeconds: The duration of the ban. This property is only present
	// if the banType is temporary.
	BanDurationSeconds uint64 `json:"banDurationSeconds,omitempty,string"`
...
type LiveStream struct {
	// Cdn: The cdn object defines the live stream's content delivery network (CDN)
	...
	// ContentDetails: The content_details object contains information about the
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "Cdn") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Cdn") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveStreamContentDetails struct {
	// ClosedCaptionsIngestionUrl: The ingestion URL where the closed captions of
	// this stream are sent.
	ClosedCaptionsIngestionUrl string `json:"closedCaptionsIngestionUrl,omitempty"`
	// IsReusable: Indicates whether the stream is reusable, which means that it
	// can be bound to multiple broadcasts. It is common for broadcasters to reuse
	// the same stream for many different broadcasts if those broadcasts occur at
	// different times. If you set this value to false, then the stream will not be
	// reusable, which means that it can only be bound to one broadcast.
	// Non-reusable streams differ from reusable streams in the following ways: - A
	...
	// ForceSendFields is a list of field names (e.g. "ClosedCaptionsIngestionUrl")
	// to unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ClosedCaptionsIngestionUrl") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveStreamHealthStatus struct {
	...
	//   "revoked"
	Status string `json:"status,omitempty"`
	// ForceSendFields is a list of field names (e.g. "ConfigurationIssues") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConfigurationIssues") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LiveStreamSnippet struct {
	...
	PublishedAt string `json:"publishedAt,omitempty"`
	// Title: The stream's title. The value must be between 1 and 128 characters
	// long.
	Title string `json:"title,omitempty"`
	// ForceSendFields is a list of field names (e.g. "ChannelId") to
	// unconditionally include in API requests. By default, fields with empty or
...
// member provides recurring monetary support to a creator and receives special
// benefits.
type Member struct {
	// Etag: Etag of this resource.
	Etag string `json:"etag,omitempty"`
...
type MemberSnippet struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CreatorChannelId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type MembershipsDetails struct {
	...
	// includes the currently active level and all other levels that are included
	// because of a higher purchase.
	AccessibleLevels []string `json:"accessibleLevels,omitempty"`
	// HighestAccessibleLevel: Id of the highest level that the user has access to
	// at the moment.
	HighestAccessibleLevel string `json:"highestAccessibleLevel,omitempty"`
	// HighestAccessibleLevelDisplayName: Display name for the highest level that
	// the user has access to at the moment.
	HighestAccessibleLevelDisplayName string `json:"highestAccessibleLevelDisplayName,omitempty"`
	// MembershipsDuration: Data about memberships duration without taking into
	// consideration pricing levels.
	MembershipsDuration *MembershipsDuration `json:"membershipsDuration,omitempty"`
	// MembershipsDurationAtLevels: Data about memberships duration on particular
	// pricing levels.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AccessibleLevels") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type MembershipsDuration struct {
	// MemberSince: The date and time when the user became a continuous member
	// across all levels.
	MemberSince string `json:"memberSince,omitempty"`
	// MemberTotalDurationMonths: The cumulative time the user has been a member
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MemberSince") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type MembershipsDurationAtLevel struct {
	...
	// MemberSince: The date and time when the user became a continuous member for
	// the given level.
	MemberSince string `json:"memberSince,omitempty"`
	// MemberTotalDurationMonths: The cumulative time the user has been a member
	// for the given level in complete months (the time is rounded down to the
	// nearest integer).
	MemberTotalDurationMonths int64 `json:"memberTotalDurationMonths,omitempty"`
...
// YouTube creators for their fans. Users can become members of the channel by
// joining one of the available levels. They will provide recurring monetary
// support and receives special benefits.
...
type MonitorStreamInfo struct {
	// BroadcastStreamDelayMs: If you have set the enableMonitorStream property to
	// true, then this property determines the length of the live broadcast delay.
	...
	// EnableMonitorStream: This value determines whether the monitor stream is
	// enabled for the broadcast. If the monitor stream is enabled, then YouTube
	// will broadcast the event content on a special stream intended only for the
	// broadcaster's consumption. The broadcaster can use the stream to review the
	// event content and also to identify the optimal times to insert cuepoints.
	// You need to set this value to true if you intend to have a broadcast delay
	// for your event. *Note:* This property cannot be updated once the broadcast
	// is in the testing or live state.
	EnableMonitorStream *bool `json:"enableMonitorStream,omitempty"`
	// ForceSendFields is a list of field names (e.g. "BroadcastStreamDelayMs") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BroadcastStreamDelayMs") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// items available and number of resources returned in a single page.
type PageInfo struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ResultsPerPage") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Playlist struct {
	// ContentDetails: The contentDetails object contains information like video
	// count.
	...
	// Snippet: The snippet object contains basic details about the playlist, such
...
// resource, such as a image, that is associated with a playlist. In addition,
// the playlistImage resource contains details about the included resource that
// pertain specifically to how that resource is used in that playlist. YouTube
...
// watch history To be more specific, these lists are associated with a
...
// for each of these lists from the channel resource for a given channel. You
// can then use the playlistImages.list method to retrieve image data for any
// of those playlists. You can also add or remove images from those lists by
// calling the playlistImages.insert and playlistImages.delete methods.
...
// a video, that is included in a playlist. In addition, the playlistItem
// resource contains details about the included resource that pertain
// specifically to how that resource is used in that playlist. YouTube uses
// playlists to identify special collections of videos for a channel, such as:
...
// with a channel, which is a collection of a person, group, or company's
// videos, playlists, and other YouTube information. You can retrieve the
// playlist IDs for each of these lists from the channel resource for a given
// channel. You can then use the playlistItems.list method to retrieve any of
// those lists. You can also add or remove items from those lists by calling
// the playlistItems.insert and playlistItems.delete methods. For example, if a
// user gives a positive rating to a video, you would insert that video into
// the liked videos playlist for that user's channel.
type PlaylistItem struct {
	// ContentDetails: The contentDetails object is included in the resource if the
	// included item is a YouTube video. The object contains additional information
	// about the video.
	...
	Kind string `json:"kind,omitempty"`
	// Snippet: The snippet object contains basic details about the playlist item,
	// such as its title and position in the playlist.
	Snippet *PlaylistItemSnippet `json:"snippet,omitempty"`
	// Status: The status object contains information about the playlist item's
	// privacy status.
...
type PlaylistItemContentDetails struct {
	// EndAt: The time, measured in seconds from the start of the video, when the
	// video should stop playing. (The playlist owner can specify the times when
	// the video should start and stop playing when the video is played in the
	...
	// StartAt: The time, measured in seconds from the start of the video, when the
	// video should start playing. (The playlist owner can specify the times when
	// the video should start and stop playing when the video is played in the
	// context of the playlist.) The default value is 0.
	StartAt string `json:"startAt,omitempty"`
	// VideoId: The ID that YouTube uses to uniquely identify a video. To retrieve
	// the video resource, set the id query parameter to this value in your API
	// request.
	VideoId string `json:"videoId,omitempty"`
...
type PlaylistItemSnippet struct {
	// ChannelId: The ID that YouTube uses to uniquely identify the user that added
	// the item to the playlist.
	ChannelId string `json:"channelId,omitempty"`
	// ChannelTitle: Channel title for the channel that the playlist item belongs
	// to.
	ChannelTitle string `json:"channelTitle,omitempty"`
	// Description: The item's description.
	Description string `json:"description,omitempty"`
	// PlaylistId: The ID that YouTube uses to uniquely identify thGe playlist that
	// the playlist item is in.
	PlaylistId string `json:"playlistId,omitempty"`
	// Position: The order in which the item appears in the playlist. The value
	// uses a zero-based index, so the first item has a position of 0, the second
	// item has a position of 1, and so forth.
	Position int64 `json:"position,omitempty"`
	// PublishedAt: The date and time that the item was added to the playlist.
	PublishedAt string `json:"publishedAt,omitempty"`
	// ResourceId: The id object contains information that can be used to uniquely
	// identify the resource that is included in the playlist as the playlist item.
	ResourceId *ResourceId `json:"resourceId,omitempty"`
	// Thumbnails: A map of thumbnail images associated with the playlist item. For
...
type PlaylistPlayer struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EmbedHtml") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type PlaylistSnippet struct {
	...
	// ThumbnailVideoId: Note: if the playlist has a custom thumbnail, this field
	// will not be populated. The video id selected by the user that will be used
	// as the thumbnail of this playlist. This field defaults to the first publicly
	...
	// Thumbnails: A map of thumbnail images associated with the playlist. For each
	// object in the map, the key is the name of the thumbnail image, and the value
...
// user subscription. A subscription notifies a user when new videos are added
// to a channel or when another user takes one of several actions on YouTube,
// such as uploading a video, rating a video, or commenting on a video.
type Subscription struct {
	// ContentDetails: The contentDetails object contains basic statistics about
	// the subscription.
	...
	Kind string `json:"kind,omitempty"`
	// Snippet: The snippet object contains basic details about the subscription,
	// including its title and the channel that the user subscribed to.
	Snippet *SubscriptionSnippet `json:"snippet,omitempty"`
	// SubscriberSnippet: The subscriberSnippet object contains basic details about
	// the subscriber.
...
type SubscriptionContentDetails struct {
	// ActivityType: The type of activity this subscription is for (only uploads,
	// everything).
	//
	// Possible values:
	...
	// NewItemCount: The number of new items in the subscription since its content
	// was last read.
	NewItemCount int64 `json:"newItemCount,omitempty"`
	// TotalItemCount: The approximate number of items that the subscription points
	// to.
...
type SubscriptionSnippet struct {
	...
	PublishedAt string `json:"publishedAt,omitempty"`
	// ResourceId: The id object contains information about the channel that the
	// user subscribed to.
	ResourceId *ResourceId `json:"resourceId,omitempty"`
	// Thumbnails: A map of thumbnail images associated with the video. For each
	// object in the map, the key is the name of the thumbnail image, and the value
	// is an object that contains other information about the thumbnail.
	Thumbnails *ThumbnailDetails `json:"thumbnails,omitempty"`
...
type SuperChatEvent struct {
	...
	Kind string `json:"kind,omitempty"`
	// Snippet: The `snippet` object contains basic details about the Super Chat
	// event.
...
type SuperChatEventSnippet struct {
	// AmountMicros: The purchase amount, in micros of the purchase currency. e.g.,
	...
	Currency string `json:"currency,omitempty"`
	// DisplayString: A rendered string that displays the purchase amount and
	// currency (e.g., "$1.00"). The string is rendered for the given language.
	...
	// MessageType: The tier for the paid message, which is based on the amount of
	// money spent to purchase the message.
	MessageType int64 `json:"messageType,omitempty"`
	// SuperStickerMetadata: If this event is a Super Sticker event, this field
	// will contain metadata about the Super Sticker.
	SuperStickerMetadata *SuperStickerMetadata `json:"superStickerMetadata,omitempty"`
...
type SuperStickerMetadata struct {
	// AltText: Internationalized alt text that describes the sticker image and any
	// animation associated with it.
	AltText string `json:"altText,omitempty"`
	// AltTextLanguage: Specifies the localization language in which the alt text
	// is returned.
	AltTextLanguage string `json:"altTextLanguage,omitempty"`
	// StickerId: Unique identifier of the Super Sticker. This is a shorter form of
	// the alt_text that includes pack name and a recognizable characteristic of
	// the sticker.
...
// between a YouTube account or a channel and an account on a third-party
// service.
type ThirdPartyLink struct {
	...
	Kind string `json:"kind,omitempty"`
	// LinkingToken: The linking_token identifies a YouTube account and channel
	// with which the third party account is linked.
	LinkingToken string `json:"linkingToken,omitempty"`
	// Snippet: The snippet object contains basic details about the third- party
	// account link.
	Snippet *ThirdPartyLinkSnippet `json:"snippet,omitempty"`
	// Status: The status object contains information about the status of the link.
...
type ThirdPartyLinkSnippet struct {
	...
	// Type: Type of the link named after the entities that are being linked.
	//
	// Possible values:
	//   "linkUnspecified"
...
type Video struct {
	...
	// Etag: Etag of this resource.
	Etag string `json:"etag,omitempty"`
	// FileDetails: The fileDetails object encapsulates information about the video
	// file that was uploaded to YouTube, including the file's resolution,
	...
	// "youtube#video".
	Kind string `json:"kind,omitempty"`
	// LiveStreamingDetails: The liveStreamingDetails object contains metadata
	// about a live video broadcast. The object will only be present in a video
	...
	// Localizations: The localizations object contains localized versions of the
	...
	// about YouTube's progress in processing the uploaded video file. The
	// properties in the object identify the current processing status and an
	// estimate of the time remaining until YouTube finishes processing the video.
	// This part also indicates whether different types of data or content, such as
	...
	// ProjectDetails: The projectDetails object contains information about the
	// project specific video metadata. b/157517979: This part was never populated
	// after it was added. However, it sees non-zero traffic because there is
	// generated client code in the wild that refers to it [1]. We keep this field
	// and do NOT remove it because otherwise V3 would return an error when this
	...
	// RecordingDetails: The recordingDetails object encapsulates information about
	...
	// Snippet: The snippet object contains basic details about the video, such as
	...
	// Status: The status object contains information about the video's uploading,
	// processing, and privacy statuses.
	Status *VideoStatus `json:"status,omitempty"`
	// Suggestions: The suggestions object encapsulates suggestions that identify
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AgeGating") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoAbuseReport struct {
	...
	Language string `json:"language,omitempty"`
	// ReasonId: The high-level, or primary, reason that the content is abusive.
	// The value is an abuse report reason ID.
	ReasonId string `json:"reasonId,omitempty"`
	// SecondaryReasonId: The specific, or secondary, reason that this content is
	// abusive (if available). The value is an abuse report reason ID that is a
	// valid secondary reason for the primary reason.
...
// reason that a video could be reported as abusive. Video abuse report reasons
...
type VideoAbuseReportReason struct {
	...
	Kind string `json:"kind,omitempty"`
	// Snippet: The `snippet` object contains basic details about the abuse report
	// reason.
...
type VideoAbuseReportReasonSnippet struct {
	...
	// SecondaryReasons: The secondary reasons associated with this reason, if any
...
type VideoAgeGating struct {
	// AlcoholContent: Indicates whether or not the video has alcoholic beverage
	// content. Only users of legal purchasing age in a particular country, as
	// identified by ICAP, can view the content.
	AlcoholContent bool `json:"alcoholContent,omitempty"`
	// Restricted: Age-restricted trailers. For redband trailers and adult-rated
	// video-games. Only users aged 18+ can view the content. The the field is true
	// the content is restricted to viewers aged 18+. Otherwise The field won't be
	// present.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AlcoholContent") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoCategory struct {
	...
	Kind string `json:"kind,omitempty"`
	// Snippet: The snippet object contains basic details about the video category,
	// including its title.
...
type VideoCategoryListResponse struct {
	...
	// videos. In this map, the video category ID is the map key, and its value is
...
type VideoCategorySnippet struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Assignable") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoContentDetails struct {
	// Caption: The value of captions indicates whether the video has captions or
	// not.
	//
	// Possible values:
	//   "true"
	...
	// ContentRating: Specifies the ratings that the video received under various
	// rating schemes.
	ContentRating *ContentRating `json:"contentRating,omitempty"`
	// CountryRestriction: The countryRestriction object contains information about
	// the countries where a video is (or is not) viewable.
	CountryRestriction *AccessPolicy `json:"countryRestriction,omitempty"`
	// Definition: The value of definition indicates whether the video is available
	// in high definition or only in standard definition.
	//
	// Possible values:
	//   "sd" - sd
	//   "hd" - hd
	Definition string `json:"definition,omitempty"`
	// Dimension: The value of dimension indicates whether the video is available
	// in 3D or in 2D.
	Dimension string `json:"dimension,omitempty"`
	// Duration: The length of the video. The tag value is an ISO 8601 duration in
	// the format PT#M#S, in which the letters PT indicate that the value specifies
	...
	// HasCustomThumbnail: Indicates whether the video uploader has provided a
	// custom thumbnail image for the video. This property is only visible to the
	// video uploader.
	HasCustomThumbnail bool `json:"hasCustomThumbnail,omitempty"`
	// LicensedContent: The value of is_license_content indicates whether the video
	// is licensed content.
	...
	//   "360"
	Projection string `json:"projection,omitempty"`
	// RegionRestriction: The regionRestriction object contains information about
	// the countries where a video is (or is not) viewable. The object will contain
	// either the contentDetails.regionRestriction.allowed property or the
...
type VideoContentDetailsRegionRestriction struct {
	...
	// present and contains an empty list, the video is viewable in all countries.
...
type VideoFileDetails struct {
	// AudioStreams: A list of audio streams contained in the uploaded video file.
	...
	// BitrateBps: The uploaded video file's combined (video and audio) bitrate in
	// bits per second.
	BitrateBps uint64 `json:"bitrateBps,omitempty,string"`
	// Container: The uploaded video file's container format.
	Container string `json:"container,omitempty"`
	// CreationTime: The date and time when the uploaded video file was created.
	// The value is specified in ISO 8601 format. Currently, the following ISO 8601
	...
	DurationMs uint64 `json:"durationMs,omitempty,string"`
	// FileName: The uploaded file's name. This field is present whether a video
	// file or another type of file was uploaded.
	FileName string `json:"fileName,omitempty"`
	// FileSize: The uploaded file's size in bytes. This field is present whether a
	// video file or another type of file was uploaded.
	FileSize uint64 `json:"fileSize,omitempty,string"`
	// FileType: The uploaded file's type as detected by YouTube's video processing
	...
	// VideoStreams: A list of video streams contained in the uploaded video file.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AudioStreams") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoFileDetailsVideoStream struct {
	// AspectRatio: The video content's display aspect ratio, which specifies the
	// aspect ratio in which the video should be displayed.
	...
	// value is a four-letter vendor code.
	Vendor string `json:"vendor,omitempty"`
	// WidthPixels: The encoded video content's width in pixels. You can calculate
	// the video's encoding aspect ratio as width_pixels / height_pixels.
...
type VideoLiveStreamingDetails struct {
	// ActiveLiveChatId: The ID of the currently active live chat attached to this
	// video. This field is filled only if the video is a currently live broadcast
	// that has live chat. Once the broadcast transitions to complete this field
	// will be removed and the live chat closed down. For persistent broadcasts
	// that live chat id will no longer be tied to this video but rather to the new
	// video being displayed at the persistent page.
	ActiveLiveChatId string `json:"activeLiveChatId,omitempty"`
	// ActualEndTime: The time that the broadcast actually ended. This value will
	// not be available until the broadcast is over.
	ActualEndTime string `json:"actualEndTime,omitempty"`
	// ActualStartTime: The time that the broadcast actually started. This value
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ActiveLiveChatId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoMonetizationDetails struct {
	// Access: The value of access indicates whether the video can be monetized or
	// not.
...
type VideoPlayer struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EmbedHeight") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoProcessingDetails struct {
	// EditorSuggestionsAvailability: This value indicates whether video editing
	// suggestions, which might improve video quality or the playback experience,
	// are available for the video. You can retrieve these suggestions by
	...
	// FileDetailsAvailability: This value indicates whether file details are
	// available for the uploaded video. You can retrieve a video's file details by
	...
	// ProcessingFailureReason: The reason that YouTube failed to process the
	// video. This property will only have a value if the processingStatus
	...
	// processing engine has generated suggestions that might improve YouTube's
	// ability to process the the video, warnings that explain video processing
	// problems, or errors that cause video processing problems. You can retrieve
	// these suggestions by requesting the suggestions part in your videos.list()
	// request.
	ProcessingIssuesAvailability string `json:"processingIssuesAvailability,omitempty"`
	// ProcessingProgress: The processingProgress object contains information about
	// the progress YouTube has made in processing the video. The values are really
	// only relevant if the video's processing status is processing.
	...
	// whether YouTube was able to process the video or if the video is still being
	// processed.
	//
	// Possible values:
	//   "processing"
	...
	// TagSuggestionsAvailability: This value indicates whether keyword (tag)
	// suggestions are available for the video. Tags can be added to a video's
	// metadata to make it easier for other users to find the video. You can
	...
	// ThumbnailsAvailability: This value indicates whether thumbnail images have
	// been generated for the video.
	ThumbnailsAvailability string `json:"thumbnailsAvailability,omitempty"`
	// ForceSendFields is a list of field names (e.g.
	// "EditorSuggestionsAvailability") to unconditionally include in API requests.
	// By default, fields with empty or default values are omitted from API
	// requests. See https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields
	// for more details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EditorSuggestionsAvailability")
	// to include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoProcessingDetailsProcessingProgress struct {
	// PartsProcessed: The number of parts of the video that YouTube has already
	// processed. You can estimate the percentage of the video that YouTube has
	// already processed by calculating: 100 * parts_processed / parts_total Note
	...
	// TimeLeftMs: An estimate of the amount of time, in millseconds, that YouTube
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PartsProcessed") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoRecordingDetails struct {
	...
	// LocationDescription: The text description of the location where the video
	// was recorded.
...
type VideoSnippet struct {
	...
	ChannelTitle string `json:"channelTitle,omitempty"`
	// DefaultAudioLanguage: The default_audio_language property specifies the
	// language spoken in the video's default audio track.
	...
	Description string `json:"description,omitempty"`
	// LiveBroadcastContent: Indicates if the video is an upcoming/active live
	// broadcast. Or it's "none" if the video is not an upcoming/active live
	// broadcast.
	//
	// Possible values:
	//   "none"
	...
	//   "completed" - The live broadcast has been completed.
	LiveBroadcastContent string `json:"liveBroadcastContent,omitempty"`
	// Localized: Localized snippet selected with the hl parameter. If no such
...
type VideoStatistics struct {
	...
	CommentCount uint64 `json:"commentCount,omitempty,string"`
	// DislikeCount: The number of users who have indicated that they disliked the
	// video by giving it a negative rating.
	DislikeCount uint64 `json:"dislikeCount,omitempty,string"`
	// FavoriteCount: The number of users who currently have the video marked as a
	// favorite video.
...
type VideoStatus struct {
	...
	//   "private"
	PrivacyStatus string `json:"privacyStatus,omitempty"`
	// PublicStatsViewable: This value indicates if the extended video statistics
	// on the watch page can be viewed by everyone. Note that the view count,
	// likes, etc will still be visible if this is disabled. @mutable
	// youtube.videos.insert youtube.videos.update
	PublicStatsViewable bool `json:"publicStatsViewable,omitempty"`
	// PublishAt: The date and time when the video is scheduled to publish. It can
	// be set only if the privacy status of the video is private..
	PublishAt string `json:"publishAt,omitempty"`
	// RejectionReason: This value explains why YouTube rejected an uploaded video.
...
type VideoSuggestions struct {
	// EditorSuggestions: A list of video editing operations that might improve the
	...
	// successfully processing the uploaded video video. These errors indicate
	// that, regardless of the video's current processing status, eventually, that
	...
	//   "projectFile" - Movie project file (e.g., Microsoft Windows Movie Maker
	// project).
	...
	//   "unsupportedSpatialAudioLayout" - Unsupported spatial audio layout type.
	ProcessingErrors []string `json:"processingErrors,omitempty"`
	// ProcessingHints: A list of suggestions that may improve YouTube's ability to
	// process the video.
	//
	// Possible values:
	//   "nonStreamableMov" - The MP4 file is not streamable, this will slow down
	// the processing. MOOV atom was not found at the beginning of the file.
	//   "sendBestQualityVideo" - Probably a better quality version of the video
	// exists. The video has wide screen aspect ratio, but is not an HD video.
	...
	// transcoding. These warnings are generated before YouTube actually processes
	// the uploaded video file. In addition, they identify issues that are unlikely
	// to cause the video processing to fail but that might cause problems such as
	// sync issues, video artifacts, or a missing audio track.
	//
	// Possible values:
	//   "unknownContainer" - Unrecognized file format, transcoding is likely to
	// fail.
	//   "unknownVideoCodec" - Unrecognized video codec, transcoding is likely to
	// fail.
	//   "unknownAudioCodec" - Unrecognized audio codec, transcoding is likely to
	// fail.
	//   "inconsistentResolution" - Conflicting container and stream resolutions.
	//   "hasEditlist" - Edit lists are not currently supported.
	//   "problematicVideoCodec" - Video codec that is known to cause problems was
	// used.
	//   "problematicAudioCodec" - Audio codec that is known to cause problems was
	// used.
	...
	//   "problematicHdrLookupTable" - Problematic HDR lookup table attached.
	ProcessingWarnings []string `json:"processingWarnings,omitempty"`
	// TagSuggestions: A list of keyword tags that could be added to the video's
	// metadata to increase the likelihood that users will locate your video when
	// searching or browsing on YouTube.
	TagSuggestions []*VideoSuggestionsTagSuggestion `json:"tagSuggestions,omitempty"`
	// ForceSendFields is a list of field names (e.g. "EditorSuggestions") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EditorSuggestions") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoSuggestionsTagSuggestion struct {
	...
	// You can use this information to display appropriate tag suggestions based on
	// the video category that the video uploader associates with the video. By
	...
	// ForceSendFields is a list of field names (e.g. "CategoryRestricts") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CategoryRestricts") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoTopicDetails struct {
	// RelevantTopicIds: Similar to topic_id, except that these topics are merely
	// relevant to the video. These are topics that may be mentioned in, or appear
	// in the video. You can retrieve information about each topic using Freebase
	// Topic API.
	...
	TopicCategories []string `json:"topicCategories,omitempty"`
	// TopicIds: A list of Freebase topic IDs that are centrally associated with
	// the video. These are topics that are centrally featured in the video, and it
	// can be said that the video is mainly about each of these. You can retrieve
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "RelevantTopicIds") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type VideoTrainability struct {
	// Etag: Etag of this resource.
	Etag string `json:"etag,omitempty"`
	// Kind: Identifies what kind of resource this is. Value: the fixed string
	// "youtube#videoTrainability".
	Kind string `json:"kind,omitempty"`
	// Permitted: Specifies who is allowed to train on the video. Valid values are:
	// - a single string "all" - a single string "none" - a list of allowed parties
...
func (s VideoTrainability) MarshalJSON() ([]byte, error) {
	type NoMethod VideoTrainability
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
type WatchSettings struct {
	...
	// FeaturedPlaylistId: An ID that uniquely identifies a playlist that displays
...
func (c *AbuseReportsInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.abusereport)
	if err != nil {
		return nil, err
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.abuseReports.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.abuseReports.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *AbuseReport.ServerResponse.Header or (if a response was returned at all) in
...
func (c *AbuseReportsInsertCall) Do(opts ...googleapi.CallOption) (*AbuseReport, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.abuseReports.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// API response, the nextPageToken and prevPageToken properties identify other
...
func (c *ActivitiesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.activities.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.activities.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ActivityListResponse.ServerResponse.Header or (if a response was returned
...
func (c *ActivitiesListCall) Do(opts ...googleapi.CallOption) (*ActivityListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.activities.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *CaptionsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.captions.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CaptionsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.captions.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
// Tfmt sets the optional parameter "tfmt": Convert the captions into this
// format. Supported options are sbv, srt, and vtt.
func (c *CaptionsDownloadCall) Tfmt(tfmt string) *CaptionsDownloadCall {
	c.urlParams_.Set("tfmt", tfmt)
	return c
}

// Tlang sets the optional parameter "tlang": tlang is the language code;
// machine translate the captions into this language.
...
func (c *CaptionsDownloadCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.captions.download", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CaptionsDownloadCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.captions.download", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
// Id sets the optional parameter "id": Returns the captions with the given IDs
...
// OnBehalfOf sets the optional parameter "onBehalfOf": ID of the Google+ Page
// for the channel that the request is on behalf of.
...
func (c *CaptionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.captions.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.captions.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *CaptionListResponse.ServerResponse.Header or (if a response was returned at
...
func (c *CaptionsListCall) Do(opts ...googleapi.CallOption) (*CaptionListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.captions.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *CaptionsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	req.GetBody = getBody
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.captions.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CaptionsUpdateCall) Do(opts ...googleapi.CallOption) (*Caption, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.captions.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// ChannelId sets the optional parameter "channelId": Unused, channel_id is
// currently derived from the security context of the requestor.
...
// for YouTube content partners. The *onBehalfOfContentOwnerChannel* parameter
...
// onBehalfOfContentOwnerChannel parameter value specifies must be linked to
// the content owner that the onBehalfOfContentOwner parameter specifies. This
...
func (c *ChannelBannersInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.channelbannerresource)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	req.GetBody = getBody
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.channelBanners.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.channelBanners.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *ChannelBannerResource.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *ChannelBannersInsertCall) Do(opts ...googleapi.CallOption) (*ChannelBannerResource, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.channelBanners.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ChannelSectionsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.channelSections.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ChannelSectionsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.channelSections.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *ChannelSectionsInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.channelsection)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.channelSections.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.channelSections.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *ChannelSection.ServerResponse.Header or (if a response was returned at all)
...
func (c *ChannelSectionsInsertCall) Do(opts ...googleapi.CallOption) (*ChannelSection, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.channelSections.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Id sets the optional parameter "id": Return the ChannelSections with the
...
// Mine sets the optional parameter "mine": Return the ChannelSections owned by
...
func (c *ChannelSectionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.channelSections.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.channelSections.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ChannelSectionListResponse.ServerResponse.Header or (if a response was
...
func (c *ChannelSectionsListCall) Do(opts ...googleapi.CallOption) (*ChannelSectionListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.channelSections.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ChannelSectionsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.channelSections.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ChannelSectionsUpdateCall) Do(opts ...googleapi.CallOption) (*ChannelSection, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.channelSections.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// CategoryId sets the optional parameter "categoryId": Return the channels
// within the specified guide category ID.
...
// ForUsername sets the optional parameter "forUsername": Return the channel
// associated with a YouTube username.
func (c *ChannelsListCall) ForUsername(forUsername string) *ChannelsListCall {
	c.urlParams_.Set("forUsername", forUsername)
	return c
}

// Hl sets the optional parameter "hl": Stands for "host language". Specifies
// the localization language of the metadata to be filled into
// snippet.localized. The field is filled with the default metadata if there is
// no localization in the specified language. The parameter value must be a
...
// Id sets the optional parameter "id": Return the channels with the specified
// IDs.
...
// ManagedByMe sets the optional parameter "managedByMe": Return the channels
...
// Mine sets the optional parameter "mine": Return the ids of channels owned by
// the authenticated user.
...
func (c *ChannelsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.channels.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.channels.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ChannelListResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *ChannelsListCall) Do(opts ...googleapi.CallOption) (*ChannelListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.channels.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ChannelsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.channels.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ChannelsUpdateCall) Do(opts ...googleapi.CallOption) (*Channel, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.channels.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *CommentThreadsInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.commentThreads.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CommentThreadsInsertCall) Do(opts ...googleapi.CallOption) (*CommentThread, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.commentThreads.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// "allThreadsRelatedToChannelId": Returns the comment threads of all videos of
// the channel and the channel comments as well.
...
// ChannelId sets the optional parameter "channelId": Returns the comment
// threads for all the channel comments (ie does not include comments left on
// videos).
...
// Id sets the optional parameter "id": Returns the comment threads with the
// given IDs for Stubby or Apiary.
...
// ModerationStatus sets the optional parameter "moderationStatus": Limits the
// returned comment threads to those with the specified moderation status. Not
// compatible with the 'id' filter. Valid values: published, heldForReview,
// likelySpam.
//
// Possible values:
//
//	"published" (default) - The comment is available for public display.
//	"heldForReview" - The comment is awaiting review by a moderator.
//	"likelySpam"
//	"rejected" - The comment is unfit for display.
...
// SearchTerms sets the optional parameter "searchTerms": Limits the returned
// comment threads to those matching the specified key words. Not compatible
// with the 'id' filter.
...
// TextFormat sets the optional parameter "textFormat": The requested text
// format for the returned comments.
//
// Possible values:
//
...
// VideoId sets the optional parameter "videoId": Returns the comment threads
// of the specified video.
...
func (c *CommentThreadsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.commentThreads.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.commentThreads.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *CommentThreadListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *CommentThreadsListCall) Do(opts ...googleapi.CallOption) (*CommentThreadListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.commentThreads.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *CommentsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.comments.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CommentsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.comments.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *CommentsInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.comments.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CommentsInsertCall) Do(opts ...googleapi.CallOption) (*Comment, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.comments.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Id sets the optional parameter "id": Returns the comments with the given IDs
// for One Platform.
...
// ParentId sets the optional parameter "parentId": Returns replies to the
// specified comment. Note, currently YouTube features only one level of
// replies (ie replies to top level comments). However replies to replies may
...
func (c *CommentsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.comments.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.comments.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *CommentListResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *CommentsListCall) Do(opts ...googleapi.CallOption) (*CommentListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.comments.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// MarkAsSpam: Expresses the caller's opinion that one or more comments should
// be flagged as spam.
//
...
func (c *CommentsMarkAsSpamCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.comments.markAsSpam", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CommentsMarkAsSpamCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.comments.markAsSpam", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
// BanAuthor sets the optional parameter "banAuthor": If set to true the author
// of the comment gets added to the ban list. This means all future comments of
// the author will autmomatically be rejected. Only valid in combination with
// STATUS_REJECTED.
...
func (c *CommentsSetModerationStatusCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.comments.setModerationStatus", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CommentsSetModerationStatusCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.comments.setModerationStatus", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *CommentsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.comments.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CommentsUpdateCall) Do(opts ...googleapi.CallOption) (*Comment, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.comments.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *I18nLanguagesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.i18nLanguages.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *I18nLanguagesListCall) Do(opts ...googleapi.CallOption) (*I18nLanguageListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.i18nLanguages.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *I18nRegionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.i18nRegions.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.i18nRegions.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *I18nRegionListResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *I18nRegionsListCall) Do(opts ...googleapi.CallOption) (*I18nRegionListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.i18nRegions.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// StreamId sets the optional parameter "streamId": Stream to bind, if not set
...
func (c *LiveBroadcastsBindCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.bind", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveBroadcasts.bind" call.
// Any non-2xx status code is an error. Response headers are in either
// *LiveBroadcast.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *LiveBroadcastsBindCall) Do(opts ...googleapi.CallOption) (*LiveBroadcast, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.bind", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveBroadcastsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveBroadcastsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *LiveBroadcastsInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.livebroadcast)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveBroadcastsInsertCall) Do(opts ...googleapi.CallOption) (*LiveBroadcast, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// comma-separated list of one or more liveBroadcast resource properties that
...
func (c *LiveBroadcastsInsertCuepointCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.cuepoint)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.insertCuepoint", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveBroadcasts.insertCuepoint" call.
// Any non-2xx status code is an error. Response headers are in either
// *Cuepoint.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *LiveBroadcastsInsertCuepointCall) Do(opts ...googleapi.CallOption) (*Cuepoint, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.insertCuepoint", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// BroadcastType sets the optional parameter "broadcastType": Return only
// broadcasts with the selected type.
//
// Possible values:
//
...
// Id sets the optional parameter "id": Return broadcasts with the given ids
// from Stubby or Apiary.
...
func (c *LiveBroadcastsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveBroadcasts.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *LiveBroadcastListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *LiveBroadcastsListCall) Do(opts ...googleapi.CallOption) (*LiveBroadcastListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveBroadcastsTransitionCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.transition", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveBroadcastsTransitionCall) Do(opts ...googleapi.CallOption) (*LiveBroadcast, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.transition", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveBroadcastsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveBroadcastsUpdateCall) Do(opts ...googleapi.CallOption) (*LiveBroadcast, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveBroadcasts.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveChatBansDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatBans.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveChatBansDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatBans.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *LiveChatBansInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.livechatban)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatBans.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveChatBans.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *LiveChatBan.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *LiveChatBansInsertCall) Do(opts ...googleapi.CallOption) (*LiveChatBan, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatBans.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveChatMessagesDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveChatMessagesDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *LiveChatMessagesInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.livechatmessage)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveChatMessagesInsertCall) Do(opts ...googleapi.CallOption) (*LiveChatMessage, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveChatMessagesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveChatMessagesListCall) Do(opts ...googleapi.CallOption) (*LiveChatMessageListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveChatMessagesTransitionCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.transition", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveChatMessagesTransitionCall) Do(opts ...googleapi.CallOption) (*LiveChatMessage, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatMessages.transition", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveChatModeratorsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatModerators.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveChatModeratorsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatModerators.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *LiveChatModeratorsInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.livechatmoderator)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatModerators.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveChatModerators.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *LiveChatModerator.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *LiveChatModeratorsInsertCall) Do(opts ...googleapi.CallOption) (*LiveChatModerator, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatModerators.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveChatModeratorsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveChatModerators.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveChatModerators.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *LiveChatModeratorListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *LiveChatModeratorsListCall) Do(opts ...googleapi.CallOption) (*LiveChatModeratorListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveChatModerators.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveStreamsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveStreams.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveStreamsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveStreams.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *LiveStreamsInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.livestream)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveStreams.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveStreams.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *LiveStream.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *LiveStreamsInsertCall) Do(opts ...googleapi.CallOption) (*LiveStream, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveStreams.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Id sets the optional parameter "id": Return LiveStreams with the given ids
// from Stubby or Apiary.
...
func (c *LiveStreamsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveStreams.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.liveStreams.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *LiveStreamListResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *LiveStreamsListCall) Do(opts ...googleapi.CallOption) (*LiveStreamListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveStreams.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *LiveStreamsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.liveStreams.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *LiveStreamsUpdateCall) Do(opts ...googleapi.CallOption) (*LiveStream, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.liveStreams.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// List: Retrieves a list of members that match the request criteria for a
// channel.
//
...
// HasAccessToLevel sets the optional parameter "hasAccessToLevel": Filter
// members in the results set to the ones that have access to a level.
...
// Mode sets the optional parameter "mode": Parameter that specifies which
// channel members to return.
//
// Possible values:
//
//	"listMembersModeUnknown"
//	"updates" - Return only members that joined after the first call with this
//
// mode was made.
//
...
func (c *MembersListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.members.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.members.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *MemberListResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *MembersListCall) Do(opts ...googleapi.CallOption) (*MemberListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.members.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// List: Retrieves a list of all pricing levels offered by a creator to the
// fans.
//
...
func (c *MembershipsLevelsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.membershipsLevels.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.membershipsLevels.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *MembershipsLevelListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *MembershipsLevelsListCall) Do(opts ...googleapi.CallOption) (*MembershipsLevelListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.membershipsLevels.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Id sets the optional parameter "id": Id to identify this image. This is
// returned from by the List method.
...
func (c *PlaylistImagesDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistImages.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PlaylistImagesDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistImages.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *PlaylistImagesInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.playlistimage)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	req.GetBody = getBody
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistImages.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.playlistImages.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *PlaylistImage.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *PlaylistImagesInsertCall) Do(opts ...googleapi.CallOption) (*PlaylistImage, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistImages.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Parent sets the optional parameter "parent": Return PlaylistImages for this
// playlist id.
...
// Part sets the optional parameter "part": The *part* parameter specifies a
// comma-separated list of one or more playlistImage resource properties that
// the API response will include. If the parameter identifies a property that
...
func (c *PlaylistImagesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistImages.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.playlistImages.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *PlaylistImageListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *PlaylistImagesListCall) Do(opts ...googleapi.CallOption) (*PlaylistImageListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistImages.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *PlaylistImagesUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	req.GetBody = getBody
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistImages.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PlaylistImagesUpdateCall) Do(opts ...googleapi.CallOption) (*PlaylistImage, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistImages.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *PlaylistItemsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistItems.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PlaylistItemsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistItems.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *PlaylistItemsInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.playlistitem)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistItems.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.playlistItems.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *PlaylistItem.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *PlaylistItemsInsertCall) Do(opts ...googleapi.CallOption) (*PlaylistItem, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistItems.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// PlaylistId sets the optional parameter "playlistId": Return the playlist
// items within the given playlist.
func (c *PlaylistItemsListCall) PlaylistId(playlistId string) *PlaylistItemsListCall {
	c.urlParams_.Set("playlistId", playlistId)
	return c
}

// VideoId sets the optional parameter "videoId": Return the playlist items
...
func (c *PlaylistItemsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistItems.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PlaylistItemsListCall) Do(opts ...googleapi.CallOption) (*PlaylistItemListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistItems.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *PlaylistItemsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlistItems.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PlaylistItemsUpdateCall) Do(opts ...googleapi.CallOption) (*PlaylistItem, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlistItems.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *PlaylistsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlists.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PlaylistsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlists.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *PlaylistsInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.playlist)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlists.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.playlists.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *Playlist.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *PlaylistsInsertCall) Do(opts ...googleapi.CallOption) (*Playlist, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlists.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// ChannelId sets the optional parameter "channelId": Return the playlists
// owned by the specified channel ID.
...
// Id sets the optional parameter "id": Return the playlists with the given IDs
// for Stubby or Apiary.
...
// Mine sets the optional parameter "mine": Return the playlists owned by the
// authenticated user.
...
func (c *PlaylistsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlists.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.playlists.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *PlaylistListResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *PlaylistsListCall) Do(opts ...googleapi.CallOption) (*PlaylistListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlists.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *PlaylistsUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.playlists.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PlaylistsUpdateCall) Do(opts ...googleapi.CallOption) (*Playlist, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.playlists.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// ChannelType sets the optional parameter "channelType": Add a filter on the
// channel search.
//
// Possible values:
//
...
// EventType sets the optional parameter "eventType": Filter on the livestream
// status of the videos.
//
// Possible values:
//
//	"none"
...
// ForContentOwner sets the optional parameter "forContentOwner": Search owned
// by a content owner.
...
// ForDeveloper sets the optional parameter "forDeveloper": Restrict the search
// to only retrieve videos uploaded using the project id of the authenticated
// user.
...
// ForMine sets the optional parameter "forMine": Search for the private videos
...
// Location sets the optional parameter "location": Filter on location of the
// video
...
// LocationRadius sets the optional parameter "locationRadius": Filter on
// distance from the location (specified above).
...
//	"relevance" (default) - Resources are sorted based on their relevance to
//
...
// PublishedAfter sets the optional parameter "publishedAfter": Filter on
// resources published after this date.
func (c *SearchListCall) PublishedAfter(publishedAfter string) *SearchListCall {
	c.urlParams_.Set("publishedAfter", publishedAfter)
	return c
}

// PublishedBefore sets the optional parameter "publishedBefore": Filter on
// resources published before this date.
...
// RegionCode sets the optional parameter "regionCode": Display the content as
// seen by viewers in this country.
func (c *SearchListCall) RegionCode(regionCode string) *SearchListCall {
	c.urlParams_.Set("regionCode", regionCode)
	return c
}

// RelevanceLanguage sets the optional parameter "relevanceLanguage": Return
// results relevant to this language.
...
// SafeSearch sets the optional parameter "safeSearch": Indicates whether the
...
// Type sets the optional parameter "type": Restrict results to a particular
// set of resource types from One Platform.
func (c *SearchListCall) Type(type_ ...string) *SearchListCall {
	c.urlParams_.SetMulti("type", append([]string{}, type_...))
	return c
}

// VideoCaption sets the optional parameter "videoCaption": Filter on the
// presence of captions on the videos.
//
// Possible values:
//
...
// VideoCategoryId sets the optional parameter "videoCategoryId": Filter on
...
// VideoDefinition sets the optional parameter "videoDefinition": Filter on the
// definition of the videos.
//
// Possible values:
//
...
// VideoDimension sets the optional parameter "videoDimension": Filter on 3d
// videos.
//
// Possible values:
//
...
// VideoDuration sets the optional parameter "videoDuration": Filter on the
...
// VideoEmbeddable sets the optional parameter "videoEmbeddable": Filter on
// embeddable videos.
//
// Possible values:
//
...
// VideoLicense sets the optional parameter "videoLicense": Filter on the
// license of the videos.
//
// Possible values:
//
...
// VideoSyndicated sets the optional parameter "videoSyndicated": Filter on
// syndicated videos.
//
// Possible values:
//
...
// VideoType sets the optional parameter "videoType": Filter on videos of a
// specific type.
//
// Possible values:
//
...
func (c *SearchListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.search.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.search.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *SearchListResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *SearchListCall) Do(opts ...googleapi.CallOption) (*SearchListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.search.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *SubscriptionsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.subscriptions.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *SubscriptionsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.subscriptions.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *SubscriptionsInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.subscriptions.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *SubscriptionsInsertCall) Do(opts ...googleapi.CallOption) (*Subscription, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.subscriptions.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// ChannelId sets the optional parameter "channelId": Return the subscriptions
// of the given channel owner.
...
// subscriptions to the subset of these channels that the authenticated user is
// subscribed to.
...
// Id sets the optional parameter "id": Return the subscriptions with the given
// IDs for Stubby or Apiary.
...
func (c *SubscriptionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.subscriptions.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *SubscriptionsListCall) Do(opts ...googleapi.CallOption) (*SubscriptionListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.subscriptions.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Hl sets the optional parameter "hl": Return rendered funding amounts in
// specified language.
...
func (c *SuperChatEventsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.superChatEvents.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.superChatEvents.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *SuperChatEventListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *SuperChatEventsListCall) Do(opts ...googleapi.CallOption) (*SuperChatEventListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.superChatEvents.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *TestsInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.testitem)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.tests.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.tests.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *TestItem.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *TestsInsertCall) Do(opts ...googleapi.CallOption) (*TestItem, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.tests.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// ExternalChannelId sets the optional parameter "externalChannelId": Channel
// ID to which changes should be applied, for delegation.
...
func (c *ThirdPartyLinksDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ThirdPartyLinksDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *ThirdPartyLinksInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.thirdpartylink)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.thirdPartyLinks.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *ThirdPartyLink.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ThirdPartyLinksInsertCall) Do(opts ...googleapi.CallOption) (*ThirdPartyLink, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// LinkingToken sets the optional parameter "linkingToken": Get a third party
// link with the given linking token.
func (c *ThirdPartyLinksListCall) LinkingToken(linkingToken string) *ThirdPartyLinksListCall {
	c.urlParams_.Set("linkingToken", linkingToken)
	return c
}

// Type sets the optional parameter "type": Get a third party link of the given
// type.
//
// Possible values:
//
...
func (c *ThirdPartyLinksListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.thirdPartyLinks.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ThirdPartyLinkListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ThirdPartyLinksListCall) Do(opts ...googleapi.CallOption) (*ThirdPartyLinkListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ThirdPartyLinksUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ThirdPartyLinksUpdateCall) Do(opts ...googleapi.CallOption) (*ThirdPartyLink, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.thirdPartyLinks.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ThumbnailsSetCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	req.GetBody = getBody
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.thumbnails.set", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.thumbnails.set" call.
// Any non-2xx status code is an error. Response headers are in either
// *ThumbnailSetResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *ThumbnailsSetCall) Do(opts ...googleapi.CallOption) (*ThumbnailSetResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.thumbnails.set", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *VideoAbuseReportReasonsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videoAbuseReportReasons.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.videoAbuseReportReasons.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *VideoAbuseReportReasonListResponse.ServerResponse.Header or (if a response
...
func (c *VideoAbuseReportReasonsListCall) Do(opts ...googleapi.CallOption) (*VideoAbuseReportReasonListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videoAbuseReportReasons.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Id sets the optional parameter "id": Returns the video categories with the
// given IDs for Stubby or Apiary.
...
func (c *VideoCategoriesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videoCategories.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.videoCategories.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *VideoCategoryListResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *VideoCategoriesListCall) Do(opts ...googleapi.CallOption) (*VideoCategoryListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videoCategories.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}

type VideoTrainabilityGetCall struct {
	s            *Service
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
	ctx_         context.Context
...
func (r *VideoTrainabilityService) Get() *VideoTrainabilityGetCall {
	c := &VideoTrainabilityGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	return c
}
...
func (c *VideoTrainabilityGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "youtube/v3/videoTrainability")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, nil)
	if err != nil {
		return nil, err
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videoTrainability.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.videoTrainability.get" call.
// Any non-2xx status code is an error. Response headers are in either
// *VideoTrainability.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
func (c *VideosDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videos.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *VideosDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videos.delete", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
// GetRating: Retrieves the ratings that the authorized user gave to a list of
// specified videos.
//
// - id: .
...
func (c *VideosGetRatingCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videos.getRating", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.videos.getRating" call.
// Any non-2xx status code is an error. Response headers are in either
// *VideoGetRatingResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *VideosGetRatingCall) Do(opts ...googleapi.CallOption) (*VideoGetRatingResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videos.getRating", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// AutoLevels sets the optional parameter "autoLevels": Should auto-levels be
...
// NotifySubscribers sets the optional parameter "notifySubscribers": Notify
// the channel subscribers about the new video. As default, the notification is
// enabled.
...
// Stabilize sets the optional parameter "stabilize": Should stabilize be
// applied to the upload.
...
func (c *VideosInsertCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.video)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	req.GetBody = getBody
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videos.insert", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.videos.insert" call.
// Any non-2xx status code is an error. Response headers are in either
// *Video.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *VideosInsertCall) Do(opts ...googleapi.CallOption) (*Video, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videos.insert", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Chart sets the optional parameter "chart": Return the videos that are in the
// specified chart.
//
// Possible values:
//
...
// MaxResults sets the optional parameter "maxResults": The *maxResults*
// parameter specifies the maximum number of items that should be returned in
// the result set. *Note:* This parameter is supported for use in conjunction
// with the myRating and chart parameters, but it is not supported for use in
...
// MaxWidth sets the optional parameter "maxWidth": Return the player with
...
// identifies a specific page in the result set that should be returned. In an
// API response, the nextPageToken and prevPageToken properties identify other
// pages that could be retrieved. *Note:* This parameter is supported for use
...
// RegionCode sets the optional parameter "regionCode": Use a chart that is
// specific to the specified region
func (c *VideosListCall) RegionCode(regionCode string) *VideosListCall {
	c.urlParams_.Set("regionCode", regionCode)
	return c
}

// VideoCategoryId sets the optional parameter "videoCategoryId": Use chart
// that is specific to the specified video category
...
func (c *VideosListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videos.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "youtube.videos.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *VideoListResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *VideosListCall) Do(opts ...googleapi.CallOption) (*VideoListResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videos.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Rate: Adds a like or dislike rating to a video or removes a rating from a
// video.
//
// - id: .
// - rating: .
...
func (c *VideosRateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videos.rate", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *VideosRateCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videos.rate", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *VideosReportAbuseCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.videoabusereport)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videos.reportAbuse", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *VideosUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.videos.update", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *VideosUpdateCall) Do(opts ...googleapi.CallOption) (*Video, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.videos.update", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *WatermarksSetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.invideobranding)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	req.GetBody = getBody
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.watermarks.set", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *WatermarksSetCall) Do(opts ...googleapi.CallOption) error {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "youtube.watermarks.set", "response", internallog.HTTPResponse(res, nil))
	return nil
}
...
func (c *WatermarksUnsetCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "youtube.watermarks.unset", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
