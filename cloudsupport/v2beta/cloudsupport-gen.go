...
type Product struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ProductLine") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// ProductProductLine sets the optional parameter "product.productLine": The
// product line of the Product.
//
// Possible values:
//
//	"PRODUCT_LINE_UNSPECIFIED" - Unknown product type.
...
// ProductLine sets the optional parameter "productLine": The product line to
// request cases for. If unspecified, only Google Cloud cases will be returned.
//
// Possible values:
//
//	"PRODUCT_LINE_UNSPECIFIED" - Unknown product type.
...
// Parent sets the optional parameter "parent": The name of the parent resource
// to search for cases under.
...
func (c *CasesShowFeedCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudsupport.cases.showFeed", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *CasesShowFeedCall) Do(opts ...googleapi.CallOption) (*ShowFeedResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudsupport.cases.showFeed", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
