...
const basePathTemplate = "https://slides.UNIVERSE_DOMAIN/"
...
// ] After transformation, x' = scale_x * x + shear_x * y + translate_x; y' =
// scale_y * y + shear_y * x + translate_y; This message is therefore composed
// of these six matrix elements.
type AffineTransform struct {
	...
	// ForceSendFields is a list of field names (e.g. "ScaleX") to unconditionally
...
type Autofit struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AutofitType") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Bullet struct {
	// BulletStyle: The paragraph specific text style applied to this bullet.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BulletStyle") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ColorStop struct {
	...
	// Position: The relative position of the color stop in the gradient band
	// measured in percentage. The value should be in the interval [0.0, 1.0].
...
type CreateImageRequest struct {
	// ElementProperties: The element properties for the image. When the aspect
	// ratio of the provided size does not match the image aspect ratio, the image
	// is scaled and centered with respect to the size in order to maintain the
	// aspect ratio. The provided transform is applied after this operation. The
	// PageElementProperties.size property is optional. If you don't specify the
	// size, the default size of the image is used. The
	// PageElementProperties.transform property is optional. If you don't specify a
	...
	// ObjectId: A user-supplied object ID. If you specify an ID, it must be unique
	// among all pages and page elements in the presentation. The ID must start
	// with an alphanumeric character or an underscore (matches regex
	...
	// Url: The image URL. The image is fetched once at insertion time and a copy
	// is stored for display inside the presentation. Images must be less than 50
	// MB in size, can't exceed 25 megapixels, and must be in one of PNG, JPEG, or
	...
	// ForceSendFields is a list of field names (e.g. "ElementProperties") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ElementProperties") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CreateLineRequest struct {
	...
	// created is determined based on the category and how it's routed to connect
	// to other page elements. If you specify both a `category` and a
	// `line_category`, the `category` takes precedence. If you do not specify a
	// value for `category`, but specify a value for `line_category`, then the
	// specified `line_category` value is used. If you do not specify either, then
	// STRAIGHT is used.
	//
	// Possible values:
	...
	ElementProperties *PageElementProperties `json:"elementProperties,omitempty"`
	// LineCategory: The category of the line to be created. *Deprecated*: use
	// `category` instead. The exact line type created is determined based on the
	// category and how it's routed to connect to other page elements. If you
	// specify both a `category` and a `line_category`, the `category` takes
	// precedence.
	//
	// Possible values:
...
// that overlap with the given text index range. The nesting level of each
// paragraph will be determined by counting leading tabs in front of each
// paragraph. To avoid excess space between the bullet and the corresponding
// paragraph, these leading tabs are removed by this request. This may change
// the indices of parts of the text. If the paragraph immediately before
// paragraphs being updated is in a list with a matching preset, the paragraphs
...
type CreateParagraphBulletsRequest struct {
	...
	// CellLocation: The optional table cell location if the text to be modified is
	// in a table cell. If present, the object_id must refer to a table.
	CellLocation *TableCellLocation `json:"cellLocation,omitempty"`
	// ObjectId: The object ID of the shape or table containing the text to add
	// bullets to.
	ObjectId string `json:"objectId,omitempty"`
...
type CreateShapeRequest struct {
	...
	//   "LEFT_RIGHT_UP_ARROW" - Left right up arrow shape. Corresponds to ECMA-376
	// ST_ShapeType 'leftRightUpArrow'
	...
	// 'noSmoking'
	//   "NOTCHED_RIGHT_ARROW" - Notched right arrow shape. Corresponds to ECMA-376
	// ST_ShapeType 'notchedRightArrow'
	...
	// 'rightArrow'
	//   "RIGHT_ARROW_CALLOUT" - Callout right arrow shape. Corresponds to ECMA-376
	// ST_ShapeType 'rightArrowCallout'
	...
	// Corresponds to ECMA-376 ST_ShapeType 'round2DiagRect'
	...
	// 'star8'
	//   "STRIPED_RIGHT_ARROW" - Striped right arrow shape. Corresponds to ECMA-376
	// ST_ShapeType 'stripedRightArrow'
	...
	// ECMA-376 ST_ShapeType 'wedgeRectCallout'
	...
	//   "FLOW_CHART_ALTERNATE_PROCESS" - Alternate process flow shape. Corresponds
	// to ECMA-376 ST_ShapeType 'flowChartAlternateProcess'
	...
	// ECMA-376 ST_ShapeType 'flowChartOfflineStorage'
	...
	//   "FLOW_CHART_PREPARATION" - Preparation flow shape. Corresponds to ECMA-376
	// ST_ShapeType 'flowChartPreparation'
...
// Chart creation requires at least one of the spreadsheets.readonly,
...
type CreateSheetsChartRequest struct {
	...
	// ElementProperties: The element properties for the chart. When the aspect
	// ratio of the provided size does not match the chart aspect ratio, the chart
	// is scaled and centered with respect to the size in order to maintain aspect
	// ratio. The provided transform is applied after this operation.
	ElementProperties *PageElementProperties `json:"elementProperties,omitempty"`
	// LinkingMode: The mode with which the chart is linked to the source
	// spreadsheet. When not specified, the chart will be an image that is not
	// linked.
	//
	// Possible values:
	...
	// ObjectId: A user-supplied object ID. If specified, the ID must be unique
	// among all pages and page elements in the presentation. The ID should start
	// with a word character [a-zA-Z0-9_] and then followed by any number of the
	// following characters [a-zA-Z0-9_-:]. The length of the ID should not be less
	...
	// chart. You might need to add a resource key to the HTTP header for a subset
	// of old files. For more information, see Access link-shared files using
...
type CreateSlideRequest struct {
	// InsertionIndex: The optional zero-based index indicating where to insert the
	// slides. If you don't specify an index, the slide is created at the end.
	InsertionIndex int64 `json:"insertionIndex,omitempty"`
	// ObjectId: A user-supplied object ID. If you specify an ID, it must be unique
	// among all pages and page elements in the presentation. The ID must start
	// with an alphanumeric character or an underscore (matches regex
	// `[a-zA-Z0-9_]`); remaining characters may include those as well as a hyphen
	// or colon (matches regex `[a-zA-Z0-9_-:]`). The ID length must be between 5
	// and 50 characters, inclusive. If you don't specify an ID, a unique one is
	// generated.
	ObjectId string `json:"objectId,omitempty"`
	// PlaceholderIdMappings: An optional list of object ID mappings from the
	// placeholder(s) on the layout to the placeholders that are created on the
	// slide from the specified layout. Can only be used when
	// `slide_layout_reference` is specified.
	PlaceholderIdMappings []*LayoutPlaceholderIdMapping `json:"placeholderIdMappings,omitempty"`
	// SlideLayoutReference: Layout reference of the slide to be inserted, based on
	// the *current master*, which is one of the following: - The master of the
	// previous slide index. - The master of the first slide, if the
	// insertion_index is zero. - The first master in the presentation, if there
	// are no slides. If the LayoutReference is not found in the current master, a
	// 400 bad request error is returned. If you don't specify a layout reference,
	// the slide uses the predefined `BLANK` layout.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "InsertionIndex") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CreateTableRequest struct {
	...
	// ElementProperties: The element properties for the table. The table will be
	// created at the provided size, subject to a minimum size. If no size is
	// provided, the table will be automatically sized. Table transforms must have
	// a scale of 1 and no shear components. If no transform is provided, the table
...
// Drive requires that the requesting app have at least one of the drive,
// drive.readonly, or drive.file OAuth scopes.
type CreateVideoRequest struct {
	// ElementProperties: The element properties for the video. The
	// PageElementProperties.size property is optional. If you don't specify a
	// size, a default size is chosen by the server. The
	// PageElementProperties.transform property is optional. The transform must not
	// have shear components. If you don't specify a transform, the video will be
	// placed at the top left corner of the page.
	ElementProperties *PageElementProperties `json:"elementProperties,omitempty"`
	// Id: The video source's unique identifier for this video. e.g. For YouTube
...
type CropProperties struct {
	...
	// BottomOffset: The offset specifies the bottom edge of the crop rectangle
	// that is located above the original bounding rectangle bottom edge, relative
	// to the object's original height.
	BottomOffset float64 `json:"bottomOffset,omitempty"`
	// LeftOffset: The offset specifies the left edge of the crop rectangle that is
	// located to the right of the original bounding rectangle left edge, relative
	// to the object's original width.
	LeftOffset float64 `json:"leftOffset,omitempty"`
	// RightOffset: The offset specifies the right edge of the crop rectangle that
	// is located to the left of the original bounding rectangle right edge,
	// relative to the object's original width.
	RightOffset float64 `json:"rightOffset,omitempty"`
	// TopOffset: The offset specifies the top edge of the crop rectangle that is
	// located below the original bounding rectangle top edge, relative to the
...
type DeleteObjectRequest struct {
	// ObjectId: The object ID of the page or page element to delete. If after a
	// delete operation a group contains only 1 or no page elements, the group is
	// also deleted. If a placeholder is deleted on a layout, any empty inheriting
...
// that overlap with the given text index range. The nesting level of each
// paragraph will be visually preserved by adding indent to the start of the
// corresponding paragraph.
type DeleteParagraphBulletsRequest struct {
	// CellLocation: The optional table cell location if the text to be modified is
	// in a table cell. If present, the object_id must refer to a table.
	CellLocation *TableCellLocation `json:"cellLocation,omitempty"`
	// ObjectId: The object ID of the shape or table containing the text to delete
	// bullets from.
	ObjectId string `json:"objectId,omitempty"`
	// TextRange: The range of text to delete bullets from, based on TextElement
	// indexes.
	TextRange *Range `json:"textRange,omitempty"`
...
type DeleteTableColumnRequest struct {
	// CellLocation: The reference table cell location from which a column will be
	// deleted. The column this cell spans will be deleted. If this is a merged
	// cell, multiple columns will be deleted. If no columns remain in the table
...
type DeleteTableRowRequest struct {
	// CellLocation: The reference table cell location from which a row will be
	// deleted. The row this cell spans will be deleted. If this is a merged cell,
...
type DeleteTextRequest struct {
	// CellLocation: The optional table cell location if the text is to be deleted
	// from a table cell. If present, the object_id must refer to a table.
	CellLocation *TableCellLocation `json:"cellLocation,omitempty"`
	// ObjectId: The object ID of the shape or table from which the text will be
	// deleted.
	ObjectId string `json:"objectId,omitempty"`
	// TextRange: The range of text to delete, based on TextElement indexes. There
	// is always an implicit newline character at the end of a shape's or table
	// cell's text that cannot be deleted. `Range.Type.ALL` will use the correct
	// bounds, but care must be taken when specifying explicit bounds for range
	// types `FROM_START_INDEX` and `FIXED_RANGE`. For example, if the text is
...
// DuplicateObjectRequest: Duplicates a slide or page element. When duplicating
// a slide, the duplicate slide will be created immediately following the
// specified slide. When duplicating a page element, the duplicate will be
...
type DuplicateObjectRequest struct {
	...
	// example when duplicating a slide or a group page element. This map defines
	// how the IDs of duplicated objects are generated: the keys are the IDs of the
...
type Group struct {
	// Children: The collection of elements in the group. The minimum size of a
	// group is 2.
...
// groups PageElements to create a Group on the same page as all the children.
type GroupObjectsRequest struct {
	// ChildrenObjectIds: The object IDs of the objects to group. Only page
	// elements can be grouped. There should be at least two page elements on the
	// same page that are not already in another group. Some page elements, such as
	// videos, tables and placeholders cannot be grouped.
	ChildrenObjectIds []string `json:"childrenObjectIds,omitempty"`
	// GroupObjectId: A user-supplied object ID for the group to be created. If you
	// specify an ID, it must be unique among all pages and page elements in the
	...
	// ForceSendFields is a list of field names (e.g. "ChildrenObjectIds") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ChildrenObjectIds") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Image struct {
	// ContentUrl: An URL to an image with a default lifetime of 30 minutes. This
	// URL is tagged with the account of the requester. Anyone with the URL
	...
	// SourceUrl: The source URL is the URL used to insert the image. The source
	// URL can be empty.
...
type ImageProperties struct {
	...
	// interval [-1.0, 1.0], where 0 means no effect. This property is read-only.
	Brightness float64 `json:"brightness,omitempty"`
	// Contrast: The contrast effect of the image. The value should be in the
	// interval [-1.0, 1.0], where 0 means no effect. This property is read-only.
	Contrast float64 `json:"contrast,omitempty"`
	// CropProperties: The crop properties of the image. If not set, the image is
	// not cropped. This property is read-only.
	...
	// Recolor: The recolor effect of the image. If not set, the image is not
	// recolored. This property is read-only.
	Recolor *Recolor `json:"recolor,omitempty"`
	// Shadow: The shadow of the image. If not set, the image has no shadow. This
...
// the table will be resized to fit the new column.
type InsertTableColumnsRequest struct {
	// CellLocation: The reference table cell location from which columns will be
	// inserted. A new column will be inserted to the left (or right) of the column
	// where the reference cell is. If the reference cell is a merged cell, a new
	// column will be inserted to the left (or right) of the merged cell.
	CellLocation *TableCellLocation `json:"cellLocation,omitempty"`
	// InsertRight: Whether to insert new columns to the right of the reference
	// cell location. - `True`: insert to the right. - `False`: insert to the left.
...
type InsertTableRowsRequest struct {
	// CellLocation: The reference table cell location from which rows will be
...
type InsertTextRequest struct {
	// CellLocation: The optional table cell location if the text is to be inserted
	// into a table cell. If present, the object_id must refer to a table.
	CellLocation *TableCellLocation `json:"cellLocation,omitempty"`
	// InsertionIndex: The index where the text will be inserted, in Unicode code
	// units, based on TextElement indexes. The index is zero-based and is computed
	// from the start of the string. The index may be adjusted to prevent
	// insertions inside Unicode grapheme clusters. In these cases, the text will
	// be inserted immediately after the grapheme cluster.
	InsertionIndex int64 `json:"insertionIndex,omitempty"`
...
// that will be created on a slide from a specified layout.
type LayoutPlaceholderIdMapping struct {
	// LayoutPlaceholder: The placeholder on a layout that will be applied to a
	// slide. Only type and index are needed. For example, a predefined
	// `TITLE_AND_BODY` layout may usually have a TITLE placeholder with index 0
	// and a BODY placeholder with index 0.
	LayoutPlaceholder *Placeholder `json:"layoutPlaceholder,omitempty"`
	// LayoutPlaceholderObjectId: The object ID of the placeholder on a layout that
	// will be applied to a slide.
	LayoutPlaceholderObjectId string `json:"layoutPlaceholderObjectId,omitempty"`
	// ObjectId: A user-supplied object ID for the placeholder identified above
	// that to be created onto a slide. If you specify an ID, it must be unique
	// among all pages and page elements in the presentation. The ID must start
	// with an alphanumeric character or an underscore (matches regex
	// `[a-zA-Z0-9_]`); remaining characters may include those as well as a hyphen
	// or colon (matches regex `[a-zA-Z0-9_-:]`). The length of the ID must not be
	...
	// generated.
	ObjectId string `json:"objectId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "LayoutPlaceholder") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LayoutPlaceholder") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// predefined layout - One of the layouts in the presentation.
type LayoutReference struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LayoutId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Line struct {
	// LineCategory: The category of the line. It matches the `category` specified
	// in CreateLineRequest, and can be updated with UpdateLineCategoryRequest.
	//
	// Possible values:
	//   "LINE_CATEGORY_UNSPECIFIED" - Unspecified line category.
	//   "STRAIGHT" - Straight connectors, including straight connector 1.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LineCategory") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LineConnection struct {
	// ConnectedObjectId: The object ID of the connected page element. Some page
	// elements, such as groups, tables, and lines do not have connection sites and
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConnectedObjectId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LineFill struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "SolidFill") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// to values that match the appearance of new lines created in the Slides
// editor.
type LineProperties struct {
	...
	// EndConnection: The connection at the end of the line. If unset, there is no
	...
	// LineFill: The fill of the line. The default line fill matches the defaults
	// for new lines created in the Slides editor.
	...
	// StartConnection: The connection at the beginning of the line. If unset,
	// there is no connection. Only lines with a Type indicating it is a
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DashStyle") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Link struct {
	...
	// SlideIndex: If set, indicates this is a link to the slide at this zero-based
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PageObjectId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type List struct {
	...
	ListId string `json:"listId,omitempty"`
	// NestingLevel: A map of nesting levels to the properties of bullets at the
	// associated level. A list has at most nine levels of nesting, so the possible
	// values for the keys of this map are 0 through 8, inclusive.
...
type MergeTableCellsRequest struct {
	...
	// (which can occur in some cases where the range covers cells that are already
...
// with page_type NOTES.
type NotesProperties struct {
	// SpeakerNotesObjectId: The object ID of the shape on this notes page that
	// contains the speaker notes for the corresponding slide. The actual shape may
	// not always exist on the notes page. Inserting text using this object ID will
	// automatically create the shape. In this case, the actual shape may have
	// different object ID. The `GetPresentation` or `GetPage` action will always
	// return the latest object ID.
	SpeakerNotesObjectId string `json:"speakerNotesObjectId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "SpeakerNotesObjectId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "SpeakerNotesObjectId") to include
...
type OptionalColor struct {
	// OpaqueColor: If set, this will be used as an opaque color. If unset, this
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "OpaqueColor") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Outline struct {
	...
	// PropertyState: The outline property state. Updating the outline on a page
	// element will implicitly update this field to `RENDERED`, unless another
	// value is specified in the same request. To have no outline on a page
	// element, set this field to `NOT_RENDERED`. In this case, any other outline
	...
	// from a placeholder shape, the corresponding field may be unset, meaning that
	// the property value is inherited from a parent placeholder. If the element
	// does not inherit, then the field will contain the rendered value. This is
	// the default value.
	...
	// the field may still be set so it can be inherited by child shapes. To remove
	// a property from a rendered element, set its property_state to NOT_RENDERED.
	//   "INHERIT" - If a property's state is INHERIT, then the property state uses
	// the value of corresponding `property_state` field on the parent shape.
...
type Page struct {
	...
	// RevisionId: Output only. The revision ID of the presentation. Can be used in
	// update requests to assert the presentation revision hasn't changed since the
	// last read operation. Only populated if the user has edit access to the
...
type PageBackgroundFill struct {
	...
	// page will implicitly update this field to `RENDERED`, unless another value
	// is specified in the same request. To have no fill on a page, set this field
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PropertyState") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type PageElement struct {
	// Description: The description of the page element. Combined with title to
	...
	// SheetsChart: A linked chart embedded from Google Sheets. Unlinked charts are
	...
	// Title: The title of the page element. Combined with description to display
	// alt text. The field is not supported for Group elements.
	Title string `json:"title,omitempty"`
	// Transform: The transform of the page element. The visual appearance of the
	// page element is determined by its absolute transform. To compute the
	// absolute transform, preconcatenate a page element's transform with the
...
// initially create a PageElement, the API may modify the values of both `size`
// and `transform`, but the visual size will be unchanged.
...
// from the parent page. Depending on the page type the hierarchy is defined in
// either SlideProperties or LayoutProperties.
type PageProperties struct {
	// ColorScheme: The color scheme of the page. If unset, the color scheme is
	// inherited from a parent page. If the page has no parent, the color scheme
	// uses a default Slides color scheme, matching the defaults in the Slides
	// editor. Only the concrete colors of the first 12 ThemeColorTypes are
	// editable. In addition, only the color scheme on `Master` pages can be
	// updated. To update the field, a color scheme containing mappings from all
	// the first 12 ThemeColorTypes to their concrete colors must be provided.
	...
	// background fill is inherited from a parent page if it exists. If the page
	// has no parent, then the background fill defaults to the corresponding fill
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ColorScheme") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// contained in a shape with a parent placeholder, then these paragraph styles
// may be inherited from the parent. Which paragraph styles are inherited
// depend on the nesting level of lists: * A paragraph not in a list will
// inherit its paragraph style from the paragraph at the 0 nesting level of the
// list inside the parent placeholder. * A paragraph in a list will inherit its
// paragraph style from the paragraph at its corresponding nesting level of the
// list inside the parent placeholder. Inherited paragraph styles are
...
type ParagraphStyle struct {
	...
	// corresponds to the end of the text, based on the current text direction. If
	// unset, the value is inherited from the parent.
	IndentEnd *Dimension `json:"indentEnd,omitempty"`
	// IndentFirstLine: The amount of indentation for the start of the first line
	// of the paragraph. If unset, the value is inherited from the parent.
	IndentFirstLine *Dimension `json:"indentFirstLine,omitempty"`
	// IndentStart: The amount indentation for the paragraph on the side that
	// corresponds to the start of the text, based on the current text direction.
...
type Placeholder struct {
	// Index: The index of the placeholder. If the same placeholder types are
	// present in the same page, they would have different index values.
	Index int64 `json:"index,omitempty"`
	// ParentObjectId: The object ID of this shape's parent placeholder. If unset,
	// the parent placeholder shape does not exist, so the shape does not inherit
...
type Presentation struct {
	...
	// Masters: The slide masters in the presentation. A slide master contains all
	// common page elements and the common properties for a set of layouts. They
	// serve three purposes: - Placeholder shapes on a master contain the default
	// text styles and shape properties of all placeholder shapes on pages that use
	...
	// NotesMaster: The notes master in the presentation. It serves three purposes:
	...
	RevisionId string `json:"revisionId,omitempty"`
	// Slides: The slides in the presentation. A slide inherits properties from a
	// slide layout.
...
type Range struct {
	...
	// used.
	//   "FIXED_RANGE" - A fixed range. Both the `start_index` and `end_index` must
	// be specified.
	//   "FROM_START_INDEX" - Starts the range at `start_index` and continues until
	// the end of the collection. The `end_index` must not be specified.
...
type Recolor struct {
	...
	//   "LIGHT1" - A recolor effect that lightens the image using the page's first
	...
	//   "LIGHT9" - A recolor effect that lightens the image using the page's ninth
	// available color from its color scheme.
	...
	// available color from its color scheme.
	//   "DARK7" - A recolor effect that darkens the image using the page's seventh
	// available color from its color scheme.
	...
	// concrete gradient.
	Name string `json:"name,omitempty"`
	// RecolorStops: The recolor effect is represented by a gradient, which is a
	// list of color stops. The colors in the gradient will replace the
	// corresponding colors at the same position in the color palette and apply to
	// the image. This property is read-only.
...
// replacing it with the latest version of the chart from Google Sheets. NOTE:
// Refreshing charts requires at least one of the spreadsheets.readonly,
...
// criteria with the provided image. The images replacing the shapes are
// rectangular after being inserted into the presentation and do not take on
// the forms of the shapes.
type ReplaceAllShapesWithImageRequest struct {
	// ContainsText: If set, this request will replace all of the shapes that
	...
	//   "CENTER_INSIDE" - Scales and centers the image to fit within the bounds of
	// the original shape and maintains the image's aspect ratio. The rendered size
	// of the image may be smaller than the size of the shape. This is the default
	...
	// ImageUrl: The image URL. The image is fetched once at insertion time and a
	// copy is stored for display inside the presentation. Images must be less than
	// 50MB in size, cannot exceed 25 megapixels, and must be in one of PNG, JPEG,
	// or GIF format. The provided URL can be at most 2 kB in length. The URL
	// itself is saved with the image, and exposed via the Image.source_url field.
	ImageUrl string `json:"imageUrl,omitempty"`
	// PageObjectIds: If non-empty, limits the matches to page elements only on the
	// given pages. Returns a 400 bad request error if given the page object ID of
	// a notes page or a notes master, or if a page with that object ID doesn't
	// exist in the presentation.
	PageObjectIds []string `json:"pageObjectIds,omitempty"`
	// ReplaceMethod: The replace method. *Deprecated*: use `image_replace_method`
...
// given criteria with the provided Google Sheets chart. The chart will be
// scaled and centered to fit within the bounds of the original shape. NOTE:
// Replacing shapes with a chart requires at least one of the
...
type ReplaceAllShapesWithSheetsChartRequest struct {
	...
	// replaced. The request will replace all of the shapes that contain the given
	// text.
	ContainsText *SubstringMatchCriteria `json:"containsText,omitempty"`
	// LinkingMode: The mode with which the chart is linked to the source
	// spreadsheet. When not specified, the chart will be an image that is not
...
// an image removes some image effects from the existing image.
type ReplaceImageRequest struct {
	...
	ImageReplaceMethod string `json:"imageReplaceMethod,omitempty"`
	// Url: The image URL. The image is fetched once at insertion time and a copy
	// is stored for display inside the presentation. Images must be less than
	// 50MB, cannot exceed 25 megapixels, and must be in PNG, JPEG, or GIF format.
	// The provided URL can't surpass 2 KB in length. The URL is saved with the
...
type Request struct {
	...
	// ReplaceAllShapesWithImage: Replaces all shapes matching some criteria with
	// an image.
	ReplaceAllShapesWithImage *ReplaceAllShapesWithImageRequest `json:"replaceAllShapesWithImage,omitempty"`
	// ReplaceAllShapesWithSheetsChart: Replaces all shapes matching some criteria
	// with a Google Sheets chart.
	...
	// RerouteLine: Reroutes a line such that it's connected at the two closest
	...
	// UpdatePageElementAltText: Updates the alt text title and/or description of a
	// page element.
	...
	// UpdateParagraphStyle: Updates the styling of paragraphs within a Shape or
	// Table.
	...
	// UpdateTableBorderProperties: Updates the properties of the table borders in
	// a Table.
...
type RerouteLineRequest struct {
	// ObjectId: The object ID of the line to reroute. Only a line with a category
...
type Response struct {
	...
	// ReplaceAllShapesWithSheetsChart: The result of replacing all shapes matching
	// some criteria with a Google Sheets chart.
...
// Shadow: The shadow properties of a page element. If these fields are unset,
// they may be inherited from a parent placeholder if it exists. If there is no
...
type Shadow struct {
	// Alignment: The alignment point of the shadow, that sets the origin for
	...
	Alpha float64 `json:"alpha,omitempty"`
	// BlurRadius: The radius of the shadow blur. The larger the radius, the more
	// diffuse the shadow becomes.
	BlurRadius *Dimension `json:"blurRadius,omitempty"`
	// Color: The shadow color value.
	Color *OpaqueColor `json:"color,omitempty"`
	// PropertyState: The shadow property state. Updating the shadow on a page
	// element will implicitly update this field to `RENDERED`, unless another
	// value is specified in the same request. To have no shadow on a page element,
	// set this field to `NOT_RENDERED`. In this case, any other shadow fields set
	...
	// Elements that do not inherit will never have an INHERIT property state.
	PropertyState string `json:"propertyState,omitempty"`
	// RotateWithShape: Whether the shadow should rotate with the shape. This
	// property is read-only.
	RotateWithShape bool `json:"rotateWithShape,omitempty"`
	// Transform: Transform that encodes the translate, scale, and skew of the
	// shadow, relative to the alignment position.
	Transform *AffineTransform `json:"transform,omitempty"`
...
type ShapeBackgroundFill struct {
	// PropertyState: The background fill property state. Updating the fill on a
	// shape will implicitly update this field to `RENDERED`, unless another value
	// is specified in the same request. To have no fill on a shape, set this field
	// to `NOT_RENDERED`. In this case, any other fill fields set in the same
	// request will be ignored.
	//
	// Possible values:
...
// shape as determined by the placeholder field, then these properties may be
// inherited from a parent placeholder shape. Determining the rendered value of
// the property depends on the corresponding property_state field value. Any
// text autofit settings on the shape are automatically deactivated by requests
// that can impact how text fits in the shape.
type ShapeProperties struct {
	// Autofit: The autofit properties of the shape. This property is only set for
	// shapes that allow text.
	...
	// Link: The hyperlink destination of the shape. If unset, there is no link.
	// Links are not inherited from parent placeholders.
	Link *Link `json:"link,omitempty"`
	// Outline: The outline of the shape. If unset, the outline is inherited from a
	...
	// parent, then the default shadow matches the defaults for new shapes created
	// in the Slides editor. This property is read-only.
	Shadow *Shadow `json:"shadow,omitempty"`
	// ShapeBackgroundFill: The background fill of the shape. If unset, the
	// background fill is inherited from a parent placeholder if it exists. If the
	// shape has no parent, then the default background fill depends on the shape
	...
	// ForceSendFields is a list of field names (e.g. "Autofit") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Autofit") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type SheetsChart struct {
	// ChartId: The ID of the specific chart in the Google Sheets spreadsheet that
	// is embedded.
	ChartId int64 `json:"chartId,omitempty"`
...
type SheetsChartProperties struct {
	...
	// ForceSendFields is a list of field names (e.g. "ChartImageProperties") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ChartImageProperties") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// with page_type SLIDE.
type SlideProperties struct {
	// IsSkipped: Whether the slide is skipped in the presentation mode. Defaults
	// to false.
	IsSkipped bool `json:"isSkipped,omitempty"`
	// LayoutObjectId: The object ID of the layout that this slide is based on.
	// This property is read-only.
	LayoutObjectId string `json:"layoutObjectId,omitempty"`
	// MasterObjectId: The object ID of the master that this slide is based on.
	// This property is read-only.
	MasterObjectId string `json:"masterObjectId,omitempty"`
	// NotesPage: The notes page that this slide is associated with. It defines the
	// visual appearance of a notes page when printing or exporting slides with
	// speaker notes. A notes page inherits properties from the notes master. The
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IsSkipped") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// with the specified color value. If any field is unset, its value may be
// inherited from a parent placeholder if it exists.
type SolidFill struct {
	...
	// alpha * (color) + (1.0 - alpha) * (background color) This means that a value
...
// SpeakerSpotlight: A PageElement kind representing a Speaker Spotlight.
type SpeakerSpotlight struct {
	...
	// ForceSendFields is a list of field names (e.g. "SpeakerSpotlightProperties")
	// to unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "SpeakerSpotlightProperties") to
...
type SpeakerSpotlightProperties struct {
	...
	Shadow *Shadow `json:"shadow,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Outline") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Outline") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// is filled entirely with the specified picture. The picture is stretched to
// fit its container.
type StretchedPictureFill struct {
	// ContentUrl: Reading the content_url: An URL to a picture with a default
	// lifetime of 30 minutes. This URL is tagged with the account of the
	// requester. Anyone with the URL effectively accesses the picture as the
	// original requester. Access to the picture may be lost if the presentation's
	// sharing settings change. Writing the content_url: The picture is fetched
	// once at insertion time and a copy is stored for display inside the
	// presentation. Pictures must be less than 50MB in size, cannot exceed 25
	// megapixels, and must be in one of PNG, JPEG, or GIF format. The provided URL
...
type Table struct {
	// Columns: Number of columns in the table.
	Columns int64 `json:"columns,omitempty"`
	// HorizontalBorderRows: Properties of horizontal cell borders. A table's
	// horizontal cell borders are represented as a grid. The grid has one more row
	// than the number of rows in the table and the same number of columns as the
	// table. For example, if the table is 3 x 3, its horizontal borders will be
	...
	// TableRows: Properties and contents of each row. Cells that span multiple
	// rows are contained in only one of these rows and have a row_span greater
	// than 1.
	TableRows []*TableRow `json:"tableRows,omitempty"`
	// VerticalBorderRows: Properties of vertical cell borders. A table's vertical
	// cell borders are represented as a grid. The grid has the same number of rows
	// as the table and one more column than the number of columns in the table.
	// For example, if the table is 3 x 3, its vertical borders will be represented
...
type TableBorderRow struct {
	// TableBorderCells: Properties of each border cell. When a border's adjacent
	// table cells are merged, it is not included in the response.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TableBorderCells") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type TableCellBackgroundFill struct {
	// PropertyState: The background fill property state. Updating the fill on a
	// table cell will implicitly update this field to `RENDERED`, unless another
	// value is specified in the same request. To have no fill on a table cell, set
	// this field to `NOT_RENDERED`. In this case, any other fill fields set in the
...
type TableCellProperties struct {
	...
	// content holder. Corresponds to ECMA-376 ST_TextAnchoringType 'b'.
	ContentAlignment string `json:"contentAlignment,omitempty"`
	// TableCellBackgroundFill: The background fill of the table cell. The default
	// fill matches the fill for newly created table cells in the Slides editor.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ContentAlignment") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type TableColumnProperties struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ColumnWidth") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type TableRow struct {
	...
	// TableCells: Properties and contents of each cell. Cells that span multiple
	// columns are represented only once with a column_span greater than 1. As a
	// result, the length of this collection does not always match the number of
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "RowHeight") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type TableRowProperties struct {
	// MinRowHeight: Minimum height of the row. The row will be rendered in the
	// Slides editor at a height equal to or greater than this value in order to
...
// shape (e.g. text box or rectangle) or a table cell in a page.
type TextContent struct {
	...
	// ForceSendFields is a list of field names (e.g. "Lists") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
// the text content of a Shape or TableCell.
type TextElement struct {
	// AutoText: A TextElement representing a spot in the text that is dynamically
	// replaced with content that can change over time.
	AutoText *AutoText `json:"autoText,omitempty"`
	// EndIndex: The zero-based end index of this text element, exclusive, in
	// Unicode code units.
	EndIndex int64 `json:"endIndex,omitempty"`
	// ParagraphMarker: A marker representing the beginning of a new paragraph. The
	// `start_index` and `end_index` of this TextElement represent the range of the
	// paragraph. Other TextElements with an index range contained inside this
	// paragraph's range are considered to be part of this paragraph. The range of
	// indices of two separate paragraphs will never overlap.
	ParagraphMarker *ParagraphMarker `json:"paragraphMarker,omitempty"`
	// StartIndex: The zero-based start index of this text element, in Unicode code
	// units.
	StartIndex int64 `json:"startIndex,omitempty"`
	...
	// `end_index` of TextRuns will always be fully contained in the index range of
	// a single `paragraph_marker` TextElement. In other words, a TextRun will
...
// text is contained in a shape with a parent placeholder, then these text
// styles may be inherited from the parent. Which text styles are inherited
// depend on the nesting level of lists: * A text run in a paragraph that is
// not in a list will inherit its text style from the the newline character in
...
// text style from the newline character in the paragraph at its corresponding
// nesting level of the list inside the parent placeholder. Inherited text
// styles are represented as unset fields in this message. If text is contained
// in a shape without a parent placeholder, unsetting these fields will revert
// the style to a value matching the defaults in the Slides editor.
type TextStyle struct {
	// BackgroundColor: The background color of the text. If set, the color is
	// either opaque or transparent, depending on if the `opaque_color` field in it
	// is set.
	...
	// from the Font menu in Slides or from [Google Fonts]
	// (https://fonts.google.com/). If the font name is unrecognized, the text is
	// rendered in `Arial`. Some fonts can affect the weight of the text. If an
	// update request specifies values for both `font_family` and `bold`, the
	// explicitly-set `bold` value is used.
	FontFamily string `json:"fontFamily,omitempty"`
	// FontSize: The size of the text's font. When read, the `font_size` will
	// specified in points.
	FontSize *Dimension `json:"fontSize,omitempty"`
	// ForegroundColor: The color of the text itself. If set, the color is either
	// opaque or transparent, depending on if the `opaque_color` field in it is
	// set.
	ForegroundColor *OptionalColor `json:"foregroundColor,omitempty"`
	// Italic: Whether or not the text is italicized.
	Italic bool `json:"italic,omitempty"`
	// Link: The hyperlink destination of the text. If unset, there is no link.
	...
	// ThemeColorType.HYPERLINK and the text will be underlined. If these fields
	// are modified in the same request, those values will be used instead of the
	...
	// Links are not settable on newline characters. As a result, setting a link on
	// a text range that crosses a paragraph boundary, such as "ABC\n123", will
	// separate the newline character(s) into their own text runs. The link will be
	// applied separately to the runs before and after the newline. * Removing a
	// link will update the text style of the range to match the style of the
	// preceding text (or the default text styles if the preceding text is another
	...
	// WeightedFontFamily: The font family and rendered weight of the text. This
	// field is an extension of `font_family` meant to support explicit font
	// weights without breaking backwards compatibility. As such, when reading the
	// style of a range of text, the value of `weighted_font_family#font_family`
	// will always be equal to that of `font_family`. However, when writing, if
	// both fields are included in the field mask (either explicitly or through the
	// wildcard "*"), their values are reconciled as follows: * If `font_family`
	// is set and `weighted_font_family` is not, the value of `font_family` is
	// applied with weight `400` ("normal"). * If both fields are set, the value of
...
type ThemeColorPair struct {
	// Color: The concrete color corresponding to the theme color type above.
...
type Thumbnail struct {
	// ContentUrl: The content URL of the thumbnail image. The URL to the image has
	// a default lifetime of 30 minutes. This URL is tagged with the account of the
	// requester. Anyone with the URL effectively accesses the image as the
	// original requester. Access to the image may be lost if the presentation's
...
type UngroupObjectsRequest struct {
	// ObjectIds: The object IDs of the objects to ungroup. Only groups that are
	// not inside other groups can be ungrouped. All the groups should be on the
...
type UpdateLineCategoryRequest struct {
	...
	// determined based on the category to update to and how it's routed to connect
	...
	//   "CURVED" - Curved connectors, including curved connector 2 to 5.
	LineCategory string `json:"lineCategory,omitempty"`
	// ObjectId: The object ID of the line the update is applied to. Only a line
	// with a category indicating it is a "connector" can be updated. The line may
...
type UpdateLinePropertiesRequest struct {
	// Fields: The fields that should be updated. At least one field must be
	// specified. The root `lineProperties` is implied and should not be specified.
...
type UpdatePageElementAltTextRequest struct {
	// Description: The updated alt text description of the page element. If unset
	// the existing value will be maintained. The description is exposed to screen
	...
	ObjectId string `json:"objectId,omitempty"`
	// Title: The updated alt text title of the page element. If unset the existing
...
type UpdatePageElementTransformRequest struct {
	...
	ObjectId string `json:"objectId,omitempty"`
	// Transform: The input transform matrix used to update the page element.
	Transform *AffineTransform `json:"transform,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ApplyMode") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type UpdatePageElementsZOrderRequest struct {
	...
	// applying the operation on multiple page elements, the relative Z-orders
	...
	// element relative to the furthest behind one in the specified page elements.
	//   "SEND_TO_BACK" - Sends the page elements to the back of the page.
	Operation string `json:"operation,omitempty"`
	// PageElementObjectIds: The object IDs of the page elements to update. All the
	// page elements must be on the same page and must not be grouped.
...
type UpdatePagePropertiesRequest struct {
	// Fields: The fields that should be updated. At least one field must be
	// specified. The root `pageProperties` is implied and should not be specified.
	// A single "*" can be used as short-hand for listing every field. For
...
// within a Shape or Table that overlap with the given text index range.
type UpdateParagraphStyleRequest struct {
	// CellLocation: The location of the cell in the table containing the
	// paragraph(s) to style. If `object_id` refers to a table, `cell_location`
	// must have a value. Otherwise, it must not.
	CellLocation *TableCellLocation `json:"cellLocation,omitempty"`
	// Fields: The fields that should be updated. At least one field must be
	// specified. The root `style` is implied and should not be specified. A single
	// "*" can be used as short-hand for listing every field. For example, to
	// update the paragraph alignment, set `fields` to "alignment". To reset a
...
type UpdateSlidePropertiesRequest struct {
	...
	// specified. A single "*" can be used as short-hand for listing every field.
	// For example to update whether a slide is skipped, set `fields` to
	// "isSkipped". To reset a property to its default value, include its field
...
type UpdateSlidesPositionRequest struct {
	// InsertionIndex: The index where the slides should be inserted, based on the
	// slide arrangement before the move takes place. Must be between zero and the
	// number of slides in the presentation, inclusive.
	InsertionIndex int64 `json:"insertionIndex,omitempty"`
	// SlideObjectIds: The IDs of the slides in the presentation that should be
	// moved. The slides in this list must be in existing presentation order,
	// without duplicates.
...
type UpdateTableBorderPropertiesRequest struct {
	// BorderPosition: The border position in the table range the updates should
	// apply to. If a border position is not specified, the updates will apply to
	// all borders in the table range.
	//
	// Possible values:
	...
	// Fields: The fields that should be updated. At least one field must be
	// specified. The root `tableBorderProperties` is implied and should not be
	// specified. A single "*" can be used as short-hand for listing every field.
	...
	// the updates are applied. If a table range is not specified, the updates will
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BorderPosition") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type UpdateTableCellPropertiesRequest struct {
	// Fields: The fields that should be updated. At least one field must be
	// specified. The root `tableCellProperties` is implied and should not be
	// specified. A single "*" can be used as short-hand for listing every field.
	// For example to update the table cell background solid fill color, set
	// `fields` to "tableCellBackgroundFill.solidFill.color". To reset a property
...
type UpdateTableColumnPropertiesRequest struct {
	// ColumnIndices: The list of zero-based indices specifying which columns to
	// update. If no indices are provided, all columns in the table will be
	// updated.
	ColumnIndices []int64 `json:"columnIndices,omitempty"`
	// Fields: The fields that should be updated. At least one field must be
	// specified. The root `tableColumnProperties` is implied and should not be
	// specified. A single "*" can be used as short-hand for listing every field.
	// For example to update the column width, set `fields` to "column_width". If
	...
	// of `table_column_properties#column_width` in the request is less than
...
type UpdateTableRowPropertiesRequest struct {
	...
	// "min_row_height". If '"min_row_height"' is included in the field mask but
	// the property is left unset, the minimum row height will default to 0.
	Fields string `json:"fields,omitempty"`
	// ObjectId: The object ID of the table.
	ObjectId string `json:"objectId,omitempty"`
	// RowIndices: The list of zero-based indices specifying which rows to update.
...
type UpdateTextStyleRequest struct {
	// CellLocation: The location of the cell in the table containing the text to
	...
	// specified. The root `style` is implied and should not be specified. A single
	// "*" can be used as short-hand for listing every field. For example, to
	// update the text style to bold, set `fields` to "bold". To reset a property
	// to its default value, include its field name in the field mask but leave the
	// field itself unset.
	Fields string `json:"fields,omitempty"`
	// ObjectId: The object ID of the shape or table with the text to be styled.
	ObjectId string `json:"objectId,omitempty"`
	// Style: The style(s) to set on the text. If the value for a particular style
	...
	Style *TextStyle `json:"style,omitempty"`
	// TextRange: The range of text to style. The range may be extended to include
...
type Video struct {
	...
	//   "DRIVE" - The video source is Google Drive.
	Source string `json:"source,omitempty"`
	// Url: An URL to a video. The URL is valid as long as the source video exists
...
type VideoProperties struct {
	// AutoPlay: Whether to enable video autoplay when the page is displayed in
	// present mode. Defaults to false.
	AutoPlay bool `json:"autoPlay,omitempty"`
	// End: The time at which to end playback, measured in seconds from the
	// beginning of the video. If set, the end time should be after the start time.
	...
	// Outline: The outline of the video. The default outline matches the defaults
	// for new videos created in the Slides editor.
	Outline *Outline `json:"outline,omitempty"`
	// Start: The time at which to start playback, measured in seconds from the
	// beginning of the video. If set, the start time should be before the end
	// time. If you set this to a value that exceeds the video's length in seconds,
	// the video will be played from the last second. If not set, the video will be
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AutoPlay") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type WeightedFontFamily struct {
	...
	// rendered in `Arial`.
	FontFamily string `json:"fontFamily,omitempty"`
	// Weight: The rendered weight of the text. This field can have any value that
...
type WordArt struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "RenderedText") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type WriteControl struct {
	// RequiredRevisionId: The revision ID of the presentation required for the
	// write request. If specified and the required revision ID doesn't match the
	// presentation's current revision ID, the request is not processed and returns
	// a 400 bad request error. When a required revision ID is returned in a
	// response, it indicates the revision ID of the document after the request was
	// applied.
...
// BatchUpdate: Applies one or more updates to the presentation. Each request
// is validated before being applied. If any request is not valid, then the
...
// returns information. The response would have two empty replies: the reply to
// the third request, and another empty reply, in that order. Because other
// users may be editing the presentation, the presentation might not exactly
...
func (c *PresentationsBatchUpdateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.batchupdatepresentationrequest)
	if err != nil {
		return nil, err
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "slides.presentations.batchUpdate", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "slides.presentations.batchUpdate" call.
// Any non-2xx status code is an error. Response headers are in either
// *BatchUpdatePresentationResponse.ServerResponse.Header or (if a response was
...
func (c *PresentationsBatchUpdateCall) Do(opts ...googleapi.CallOption) (*BatchUpdatePresentationResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "slides.presentations.batchUpdate", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// including any provided content, are ignored. Returns the created
// presentation.
...
func (c *PresentationsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.presentation)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "slides.presentations.create", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "slides.presentations.create" call.
// Any non-2xx status code is an error. Response headers are in either
// *Presentation.ServerResponse.Header or (if a response was returned at all)
...
func (c *PresentationsCreateCall) Do(opts ...googleapi.CallOption) (*Presentation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "slides.presentations.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *PresentationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "slides.presentations.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PresentationsGetCall) Do(opts ...googleapi.CallOption) (*Presentation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "slides.presentations.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *PresentationsPagesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "slides.presentations.pages.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *PresentationsPagesGetCall) Do(opts ...googleapi.CallOption) (*Page, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "slides.presentations.pages.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// "thumbnailProperties.mimeType": The optional mime type of the thumbnail
...
// "thumbnailProperties.thumbnailSize": The optional thumbnail image size. If
...
func (c *PresentationsPagesGetThumbnailCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "slides.presentations.pages.getThumbnail", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "slides.presentations.pages.getThumbnail" call.
// Any non-2xx status code is an error. Response headers are in either
// *Thumbnail.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *PresentationsPagesGetThumbnailCall) Do(opts ...googleapi.CallOption) (*Thumbnail, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "slides.presentations.pages.getThumbnail", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
