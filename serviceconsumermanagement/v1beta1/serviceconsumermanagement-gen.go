...
type V1Beta1ConsumerQuotaLimit struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IsPrecise") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type V1Beta1ConsumerQuotaMetric struct {
	...
	// `services/serviceconsumermanagement.googleapis.com/projects/123/consumerQuota
	// Metrics/compute.googleapis.com%2Fcpus` The resource name is intended to be
...
// Any non-2xx status code is an error. Response headers are in either
// *V1Beta1ConsumerQuotaMetric.ServerResponse.Header or (if a response was
...
// List: Retrieves a summary of all quota information about this consumer that
// is visible to the service producer, for each quota metric defined by the
...
// Any non-2xx status code is an error. Response headers are in either
// *V1Beta1ListConsumerQuotaMetricsResponse.ServerResponse.Header or (if a
...
// Any non-2xx status code is an error. Response headers are in either
// *V1Beta1ConsumerQuotaLimit.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Create: Creates a producer override. A producer override is applied by the
// owner or administrator of a service to increase or decrease the amount of
// quota a consumer of the service is allowed to use. To create multiple
// overrides at once, use ImportProducerOverrides instead. If an override with
// the specified dimensions already exists, this call will fail. To overwrite
// an existing override if one is already present ("upsert" semantics), use
...
func (c *ServicesConsumerQuotaMetricsLimitsProducerOverridesCreateCall) ForceJustification(forceJustification string) *ServicesConsumerQuotaMetricsLimitsProducerOverridesCreateCall {
...
// force option is set to true, force_justification is suggested to be set to
// log the reason in audit logs.
func (c *ServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteCall) ForceJustification(forceJustification string) *ServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteCall {
	c.urlParams_.Set("forceJustification", forceJustification)
	return c
}
...
// Any non-2xx status code is an error. Response headers are in either
// *V1Beta1ListProducerOverridesResponse.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// force option is set to true, force_justification is suggested to be set to
// log the reason in audit logs.
func (c *ServicesConsumerQuotaMetricsLimitsProducerOverridesPatchCall) ForceJustification(forceJustification string) *ServicesConsumerQuotaMetricsLimitsProducerOverridesPatchCall {
	c.urlParams_.Set("forceJustification", forceJustification)
	return c
}
