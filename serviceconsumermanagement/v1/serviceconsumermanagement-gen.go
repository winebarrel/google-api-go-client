...
// AddTenantProjectRequest: Request to add a newly created and configured
// tenant project to a tenancy unit.
type AddTenantProjectRequest struct {
	...
	// Tag: Required. Tag of the added project. Must be less than 128 characters.
	// Required.
	...
	// NullFields is a list of field names (e.g. "ProjectConfig") to include in API
...
type ApplyTenantProjectConfigRequest struct {
	// ProjectConfig: Configuration that should be applied to the existing tenant
	// project.
	ProjectConfig *TenantProjectConfig `json:"projectConfig,omitempty"`
...
// AttachTenantProjectRequest: Request to attach an existing project to the
// tenancy unit as a new tenant resource.
type AttachTenantProjectRequest struct {
	// ExternalResource: When attaching an external project, this is in the format
	// of `projects/{project_number}`.
	ExternalResource string `json:"externalResource,omitempty"`
	// ReservedResource: When attaching a reserved project already in tenancy
	// units, this is the tag of a tenant resource under the tenancy unit for the
	// managed service's service producer project. The reserved tenant resource
	// must be in an active state.
	ReservedResource string `json:"reservedResource,omitempty"`
	// Tag: Required. Tag of the tenant resource after attachment. Must be less
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExternalResource") to include in
...
// CreateTenancyUnitRequest: Request to create a tenancy unit for a service
// consumer of a managed service.
type CreateTenancyUnitRequest struct {
	// TenancyUnitId: Optional. Optional service producer-provided identifier of
	// the tenancy unit. Must be no longer than 40 characters and preferably URI
	// friendly. If it isn't provided, a UID for the tenancy unit is automatically
	...
	// pair, calling `CreateTenancyUnit` returns the existing tenancy unit if the
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TenancyUnitId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// PolicyBinding: Translates to IAM Policy bindings (without auditing at this
// level)
...
// RemoveTenantProjectRequest: Request message to remove a tenant project
// resource from the tenancy unit.
...
// ServiceAccountConfig: Describes the service account configuration for the
// tenant project.
type ServiceAccountConfig struct {
	// AccountId: ID of the IAM service account to be created in tenant project.
	// The email format of the service account is "@.iam.gserviceaccount.com". This
	// account ID must be unique within tenant project and service producers have
	// to guarantee it. The ID must be 6-30 characters long, and match the
	// following regular expression: `[a-z]([-a-z0-9]*[a-z0-9])`.
	AccountId string `json:"accountId,omitempty"`
	// TenantProjectRoles: Roles for the associated service account for the tenant
	// project.
...
type TenancyUnit struct {
	// Consumer: Output only. @OutputOnly Cloud resource name of the consumer of
	// this service. For example 'projects/123456'.
	Consumer string `json:"consumer,omitempty"`
	// CreateTime: Output only. @OutputOnly The time this tenancy unit was created.
	CreateTime string `json:"createTime,omitempty"`
	// Name: Globally unique identifier of this tenancy unit
	// "services/{service}/{collection id}/{resource id}/tenancyUnits/{unit}"
	Name string `json:"name,omitempty"`
	// Service: Output only. Google Cloud API name of the managed service owning
	// this tenancy unit. For example 'serviceconsumermanagement.googleapis.com'.
	Service string `json:"service,omitempty"`
	// TenantResources: Resources constituting the tenancy unit. There can be at
	// most 512 tenant resources in a tenancy unit.
...
// TenantProjectConfig: This structure defines a tenant project to be added to
// the specified tenancy unit and its initial configuration and properties. A
// project lien is created for the tenant project to prevent the tenant project
// from being deleted accidentally. The lien is deleted as part of tenant
// project removal.
type TenantProjectConfig struct {
	// BillingConfig: Billing account properties. The billing account must be
	// specified.
	BillingConfig *BillingConfig `json:"billingConfig,omitempty"`
	// Folder: Folder where project in this tenancy unit must be located This
	// folder must have been previously created with the required permissions for
	// the caller to create and configure a project in it. Valid folder resource
	// names have the format `folders/{folder_number}` (for example,
	// `folders/123456`).
	Folder string `json:"folder,omitempty"`
	// Labels: Labels that are applied to this project.
	Labels map[string]string `json:"labels,omitempty"`
	// ServiceAccountConfig: Configuration for the IAM service account on the
	// tenant project.
	ServiceAccountConfig *ServiceAccountConfig `json:"serviceAccountConfig,omitempty"`
	// Services: Google Cloud API names of services that are activated on this
	// project during provisioning. If any of these services can't be activated,
	// the request fails. For example:
	// 'compute.googleapis.com','cloudfunctions.googleapis.com'
	Services []string `json:"services,omitempty"`
	// TenantProjectPolicy: Describes ownership and policies for the new tenant
	// project.
...
// TenantProjectPolicy: Describes policy settings that can be applied to a
// newly created tenant project.
type TenantProjectPolicy struct {
	// PolicyBindings: Policy bindings to be applied to the tenant project, in
	// addition to the 'roles/owner' role granted to the Service Consumer
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PolicyBindings") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// UndeleteTenantProjectRequest: Request message to undelete tenant project
// resource previously deleted from the tenancy unit.
...
// `AddVisibilityLabels` method. This response message is assigned to the
...
// V1Beta1EnableConsumerResponse: Response message for the `EnableConsumer`
// method. This response message is assigned to the `response` field of the
// returned Operation when that operation is done.
...
// `GenerateServiceIdentity` method. This response message is assigned to the
// `response` field of the returned Operation when that operation is done.
...
type V1Beta1ProducerQuotaPolicy struct {
	...
	// policy on a limit with the unit 1/{project}/{region} could contain an entry
	// with the key "region" and the value "us-east-1"; the policy is only applied
	...
	// `services/compute.googleapis.com/organizations/123/consumerQuotaMetrics/compu
...
type V1Beta1QuotaOverride struct {
	...
	// the API does not support quota overrides that apply only to a specific user.
	...
	Metric string `json:"metric,omitempty"`
	// Name: The resource name of the producer override. An example name would be:
	// `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.go
	// ogleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/4a3f2c1d`
	Name string `json:"name,omitempty"`
...
// V1DefaultIdentity: A default identity in the Identity and Access Management
// API.
type V1DefaultIdentity struct {
	...
	// ty`
	Name string `json:"name,omitempty"`
	// Tag: The Default Identity tag. If specified when creating the account, the
	// tag must be present in activation_grants. If not specified when creating the
...
// `GenerateDefaultIdentity` method. This response message is assigned to the
// `response` field of the returned Operation when that operation is done.
type V1GenerateDefaultIdentityResponse struct {
	// AttachStatus: Status of the role attachment. Under development
	// (go/si-attach-role), currently always return ATTACH_STATUS_UNSPECIFIED)
	//
	// Possible values:
	...
	// point in time. Tenant manager doesn't make assertion about the current state
	// of the identity with respect to the consumer. Role attachment should happen
	// only once after activation and cannot be reattached after customer removes
	// it. (go/si-attach-role)
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AttachStatus") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// `GenerateServiceAccount` method. This response message is assigned to the
// `response` field of the returned Operation when that operation is done.
...
// `RemoveVisibilityLabels` method. This response message is assigned to the
// `response` field of the returned Operation when that operation is done.
...
// V1ServiceAccount: A service account in the Identity and Access Management
// API.
type V1ServiceAccount struct {
	...
	// `services/serviceconsumermanagement.googleapis.com/projects/123/serviceAccoun
	// ts/default`
	Name string `json:"name,omitempty"`
	// Tag: The P4 SA configuration tag. This must be defined in activation_grants.
...
func (c *OperationsCancelCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.operations.cancel", "request", internallog.HTTPRequest(req, body.Bytes()))
...
func (c *OperationsCancelCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.operations.cancel", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *OperationsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.operations.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *OperationsDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.operations.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *OperationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.operations.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *OperationsListCall) Do(opts ...googleapi.CallOption) (*ListOperationsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.operations.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// results returned by this request. Currently, the default maximum is set to
// 1000. If `page_size` isn't provided or the size provided is a number larger
// than 1000, it's automatically set to 1000.
...
// Query sets the optional parameter "query": Set a query `{expression}` for
// querying tenancy units. Your `{expression}` must be in the format:
...
// query `tenant_resources.resource=projects/123456`. Multiple expressions can
...
func (c *ServicesSearchCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.search", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "serviceconsumermanagement.services.search" call.
// Any non-2xx status code is an error. Response headers are in either
// *SearchTenancyUnitsResponse.ServerResponse.Header or (if a response was
...
func (c *ServicesSearchCall) Do(opts ...googleapi.CallOption) (*SearchTenancyUnitsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.search", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// AddProject: Add a new tenant project to the tenancy unit. There can be a
// maximum of 1024 tenant projects in a tenancy unit. If there are previously
// failed `AddTenantProject` calls, you might need to call
// `RemoveTenantProject` first to resolve them before you can make another call
// to `AddTenantProject` with the same tag. Operation.
//
...
func (c *ServicesTenancyUnitsAddProjectCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.addtenantprojectrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.addProject", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsAddProjectCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.addProject", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// ApplyProjectConfig: Apply a configuration to an existing tenant project.
...
// tenancy unit. The configuration is applied, but any existing settings on the
// project aren't modified. Specified policy bindings are applied. Existing
// bindings aren't modified. Specified services are activated. No service is
...
// project is created if previously non existed. Specified labels will be
// appended to tenant project, note that the value of existing label key will
// be updated if the same label key is requested. The specified folder is
// ignored, as moving a tenant project to a different folder isn't supported.
...
func (c *ServicesTenancyUnitsApplyProjectConfigCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.applytenantprojectconfigrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.applyProjectConfig", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsApplyProjectConfigCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.applyProjectConfig", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// AttachProject: Attach an existing project to the tenancy unit as a new
// tenant resource. The project could either be the tenant project reserved by
...
// checked against a set of permissions as if calling `AddTenantProject` on the
// same service consumer. To trigger the attachment, the targeted tenant
// project must be in a folder. Make sure the ServiceConsumerManagement service
// account is the owner of that project. These two requirements are already met
// if the project is reserved by calling `AddTenantProject`. Operation.
//
//   - name: Name of the tenancy unit that the project will be attached to. Such
...
func (c *ServicesTenancyUnitsAttachProjectCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.attachtenantprojectrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.attachProject", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsAttachProjectCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.attachProject", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Create: Creates a tenancy unit with no tenant resources. If tenancy unit
// already exists, it will be returned, however, in this case, returned
// TenancyUnit does not have tenant_resources field set and ListTenancyUnits
// has to be used to get a complete TenancyUnit with all fields populated.
//
//   - parent: services/{service}/{collection id}/{resource id} {collection id}
//     is the cloud resource collection type representing the service consumer,
//     for example 'projects', or 'organizations'. {resource id} is the consumer
...
func (c *ServicesTenancyUnitsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.createtenancyunitrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.create", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "serviceconsumermanagement.services.tenancyUnits.create" call.
// Any non-2xx status code is an error. Response headers are in either
// *TenancyUnit.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ServicesTenancyUnitsCreateCall) Do(opts ...googleapi.CallOption) (*TenancyUnit, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Delete: Delete a tenancy unit. Before you delete the tenancy unit, there
...
func (c *ServicesTenancyUnitsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsDeleteCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// DeleteProject: Deletes the specified project resource identified by a tenant
...
// deleted, the tenant resource state is set to DELETED. To permanently remove
// resource metadata, call the `RemoveTenantProject` method. New resources with
// the same tag can't be added if there are existing resources in a DELETED
// state. Operation.
//
//   - name: Name of the tenancy unit. Such as
//     'services/service.googleapis.com/projects/12345/tenancyUnits/abcd'.
...
func (c *ServicesTenancyUnitsDeleteProjectCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.deletetenantprojectrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.deleteProject", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsDeleteProjectCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.deleteProject", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// List: Find the tenancy unit for a managed service and service consumer. This
...
// Filter sets the optional parameter "filter": Filter expression over tenancy
// resources field. Optional.
...
// PageSize sets the optional parameter "pageSize": The maximum number of
// results returned by this request.
...
func (c *ServicesTenancyUnitsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsListCall) Do(opts ...googleapi.CallOption) (*ListTenancyUnitsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// RemoveProject: Removes the specified project resource identified by a tenant
...
// operation fails, this method also fails. Calls to remove already removed or
// non-existent tenant project succeed. After the project has been deleted, or
// if was already in a DELETED state, resource metadata is permanently removed
// from the tenancy unit. Operation.
//
//   - name: Name of the tenancy unit. Such as
//     'services/service.googleapis.com/projects/12345/tenancyUnits/abcd'.
...
func (c *ServicesTenancyUnitsRemoveProjectCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.removetenantprojectrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.removeProject", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsRemoveProjectCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.removeProject", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// UndeleteProject: Attempts to undelete a previously deleted tenant project.
// The project must be in a DELETED state. There are no guarantees that an
// undeleted project will be in a fully restored and functional state. Call the
...
func (c *ServicesTenancyUnitsUndeleteProjectCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.undeletetenantprojectrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.undeleteProject", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesTenancyUnitsUndeleteProjectCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "serviceconsumermanagement.services.tenancyUnits.undeleteProject", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
