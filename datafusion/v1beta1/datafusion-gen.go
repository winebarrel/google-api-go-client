...
type DnsPeering struct {
	...
	// TargetNetwork: Optional. Optional target network to which dns peering should
	// happen.
	TargetNetwork string `json:"targetNetwork,omitempty"`
	// TargetProject: Optional. Optional target project to which dns peering should
	// happen.
...
// IAMPolicy: IAMPolicy encapsulates the IAM policy name, definition and status
// of policy fetching.
...
type Instance struct {
	...
	// will have all features available but with restrictive capabilities. This is
	// to help enterprises design and develop their data ingestion and integration
...
type ListDnsPeeringsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DnsPeerings") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Namespace struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IamPolicy") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type NetworkConfig struct {
	...
	// corresponding tenant project from a predefined list of available connection
	// modes. If this field is unspecified for a private instance, VPC peering is
	// used.
	//
	// Possible values:
	...
	// IpAllocation: Optional. The IP range in CIDR notation to use for the managed
	// Data Fusion instance nodes. This range must not overlap with any other
	// ranges used in the Data Fusion instance network. This is required only when
	// using connection type VPC_PEERING. Format: a.b.c.d/22 Example:
	// 192.168.0.0/22
...
type OperationMetadata struct {
	...
	// populated with accelerator name as key and status as ENABLING, DISABLING or
	// DELETING
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AdditionalStatus") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// to establish connectivity between the Data Fusion consumer project and the
// corresponding tenant project.
type PrivateServiceConnectConfig struct {
	// EffectiveUnreachableCidrBlock: Output only. The CIDR block to which the CDF
	// instance can't route traffic to in the consumer project VPC. The size of
	// this block is /25. The format of this field is governed by RFC 4632.
	// Example: 240.0.0.0/25
	EffectiveUnreachableCidrBlock string `json:"effectiveUnreachableCidrBlock,omitempty"`
	// NetworkAttachment: Required. The reference to the network attachment used to
	// establish private connectivity. It will be of the form
	// projects/{project-id}/regions/{region}/networkAttachments/{network-attachment
	// -id}.
	NetworkAttachment string `json:"networkAttachment,omitempty"`
	// UnreachableCidrBlock: Optional. Input only. The CIDR block to which the CDF
	// instance can't route traffic to in the consumer project VPC. The size of
	// this block should be at least /25. This range should not overlap with the
	// primary address range of any subnetwork used by the network attachment. This
	// range can be used for other purposes in the consumer VPC as long as there is
	// no requirement for CDF to reach destinations using these addresses. If this
	// value is not provided, the server chooses a non RFC 1918 address range. The
	// format of this field is governed by RFC 4632. Example: 192.168.0.0/25
	UnreachableCidrBlock string `json:"unreachableCidrBlock,omitempty"`
	// ForceSendFields is a list of field names (e.g.
	// "EffectiveUnreachableCidrBlock") to unconditionally include in API requests.
	// By default, fields with empty or default values are omitted from API
	// requests. See https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields
	// for more details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EffectiveUnreachableCidrBlock")
...
// instance. To change the instance properties, instance update should be used.
type UpgradeInstanceRequest struct {
}

// Version: The Data Fusion version.
type Version struct {
	// AvailableFeatures: Represents a list of available feature names for a given
	// version.
	AvailableFeatures []string `json:"availableFeatures,omitempty"`
	// DefaultVersion: Whether this is currently the default version for Cloud Data
	// Fusion
	...
	// ForceSendFields is a list of field names (e.g. "AvailableFeatures") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AvailableFeatures") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (c *ProjectsLocationsRemoveIamPolicyCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datafusion.projects.locations.removeIamPolicy", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsRemoveIamPolicyCall) Do(opts ...googleapi.CallOption) (*RemoveIamPolicyResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "datafusion.projects.locations.removeIamPolicy", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Create: Creates a new Data Fusion instance in the specified project and
// location.
//
...
// the instance to create. Instance name can only contain lowercase
// alphanumeric characters and hyphens. It must start with a letter and must
// not end with a hyphen. It can have a maximum of 30 characters.
...
// Force sets the optional parameter "force": If set to true, any nested
// resources from this instance will also be deleted.
...
// specify the fields that the update will overwrite in an instance resource.
// The fields specified in the update_mask are relative to the resource, not
// the full request. A field will be overwritten if it is in the mask. If the
// user does not provide a mask, all the supported fields (labels and options
...
// Restart: Restart a single Data Fusion instance. At the end of an operation
...
// Upgrade: Upgrade a single Data Fusion instance. At the end of an operation
...
func (c *ProjectsLocationsInstancesUpgradeCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.upgrade", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsInstancesUpgradeCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.upgrade", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// DnsPeeringId sets the optional parameter "dnsPeeringId": Required. The name
// of the peering to create.
...
// Any non-2xx status code is an error. Response headers are in either
// *DnsPeering.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
//     projects/{project}/locations/{location}/instances/{instance}/dnsPeerings/{d
//     ns_peering}.
...
//
//   - parent: The parent, which owns this collection of dns peerings. Format:
//     projects/{project}/locations/{location}/instances/{instance}.
...
// PageSize sets the optional parameter "pageSize": The maximum number of dns
// peerings to return. The service may return fewer than this value. If
// unspecified, at most 50 dns peerings will be returned. The maximum value is
...
// PageToken sets the optional parameter "pageToken": A page token, received
// from a previous `ListDnsPeerings` call. Provide this to retrieve the
...
func (c *ProjectsLocationsInstancesNamespacesGetIamPolicyCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.getIamPolicy", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsInstancesNamespacesGetIamPolicyCall) Do(opts ...googleapi.CallOption) (*Policy, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.getIamPolicy", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// View sets the optional parameter "view": By default, only basic information
// about a namespace is returned (e.g. name). When `NAMESPACE_VIEW_FULL` is
// specified, additional information associated with a namespace gets returned
...
func (c *ProjectsLocationsInstancesNamespacesListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsInstancesNamespacesListCall) Do(opts ...googleapi.CallOption) (*ListNamespacesResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsInstancesNamespacesSetIamPolicyCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.setIamPolicy", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsInstancesNamespacesSetIamPolicyCall) Do(opts ...googleapi.CallOption) (*Policy, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.setIamPolicy", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsInstancesNamespacesTestIamPermissionsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.testIamPermissions", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ProjectsLocationsInstancesNamespacesTestIamPermissionsCall) Do(opts ...googleapi.CallOption) (*TestIamPermissionsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "datafusion.projects.locations.instances.namespaces.testIamPermissions", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// List: Lists possible versions for Data Fusion instances in the specified
...
// LatestPatchOnly sets the optional parameter "latestPatchOnly": Whether or
// not to return the latest patch of every available minor version. If true,
// only the latest patch will be returned. Ex. if allowed versions is [6.1.1,
// 6.1.2, 6.2.0] then response will be [6.1.2, 6.2.0]
...
// Any non-2xx status code is an error. Response headers are in either
// *ListAvailableVersionsResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
