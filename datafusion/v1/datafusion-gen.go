...
type Instance struct {
	...
	//   "ACTIVE" - Instance is active and ready for requests. This corresponds to
...
// about certain Data Fusion version, which is used for Data Fusion version
// upgrade.
type Version struct {
...
// user does not provide a mask, the label field will be overwritten.
