...
package sourcerepo // import "github.com/winebarrel/google-api-go-client/sourcerepo/v1"
...
const basePathTemplate = "https://sourcerepo.UNIVERSE_DOMAIN/"
...
type MirrorConfig struct {
	// DeployKeyId: ID of the SSH deploy key at the other hosting service. Removing
	// this key from the other service would deauthorize Google Cloud Source
	...
	// Removing this webhook from the other hosting service will stop Google Cloud
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DeployKeyId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ProjectConfig struct {
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "EnablePrivateKeyCheck") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type PubsubConfig struct {
	...
	// publishing Cloud Pub/Sub messages. This service account needs to be in the
	// same project as the PubsubConfig. When added, the caller needs to have
	// iam.serviceAccounts.actAs permission on this service account. If
	// unspecified, it defaults to the compute engine default service account.
	ServiceAccountEmail string `json:"serviceAccountEmail,omitempty"`
	// Topic: A topic of Cloud Pub/Sub. Values are of the form `projects//topics/`.
...
// Repo: A repository (or repo) is a Git repository storing versioned source
// content.
type Repo struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MirrorConfig") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// SyncRepoMetadata: Metadata of SyncRepo. This message is in the metadata
// field of Operation.
...
type UpdateRepoRequest struct {
	...
	// UpdateMask: A FieldMask specifying which fields of the repo to modify. Only
	// the fields in the mask will be modified. If no mask is provided, this
	// request is no-op.
	UpdateMask string `json:"updateMask,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Repo") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Repo") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// *ProjectConfig.ServerResponse.Header or (if a response was returned at all)
...
// UpdateConfig: Updates the Cloud Source Repositories configuration of the
// project.
//
//   - name: The name of the requested project. Values are of the form
//     `projects/`.
...
// Create: Creates a repo in the given project with the given name. If the
...
// GetIamPolicy: Gets the IAM policy policy for a resource. Returns an empty
...
// List: Returns all repos belonging to a project. The sizes of the repos are
...
// repositories to return; between 1 and 500. If not set or zero, defaults to
// 100 at the server.
...
// repositories where a prior ListReposResponse left off. This is an opaque
// token that must be obtained from a recent, prior ListReposResponse's
...
// Any non-2xx status code is an error. Response headers are in either
// *ListReposResponse.ServerResponse.Header or (if a response was returned at
...
// SetIamPolicy: Sets the IAM policy on the specified resource. Replaces any
// existing policy.
//
...
// Sync: Synchronize a connected repo. The response contains SyncRepoMetadata
