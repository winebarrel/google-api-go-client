...
// AudioMapping: The mapping for the JobConfig.edit_list atoms with audio
// EditAtom.inputs.
...
// Color: Color preprocessing configuration. **Note:** This configuration is
// not supported.
type Color struct {
...
// H264ColorFormatHLG: Convert the input video to a Hybrid Log Gamma (HLG)
// video.
type H264ColorFormatHLG struct {
}

// H264ColorFormatSDR: Convert the input video to a Standard Dynamic Range
// (SDR) video.
...
// H265ColorFormatHDR10: Convert the input video to a High Dynamic Range 10
// (HDR10) video.
type H265ColorFormatHDR10 struct {
}

// H265ColorFormatHLG: Convert the input video to a Hybrid Log Gamma (HLG)
// video.
type H265ColorFormatHLG struct {
}

// H265ColorFormatSDR: Convert the input video to a Standard Dynamic Range
// (SDR) video.
...
// SecretManagerSource: Configuration for secrets stored in Google Secret
// Manager.
...
// Vp9ColorFormatHLG: Convert the input video to a Hybrid Log Gamma (HLG)
// video.
type Vp9ColorFormatHLG struct {
}

// Vp9ColorFormatSDR: Convert the input video to a Standard Dynamic Range (SDR)
// video.
...
// the job template is not found, the request will succeed but no action will
...
// AllowMissing sets the optional parameter "allowMissing": If set to true, and
// the job is not found, the request will succeed but no action will be taken
// on the server.
